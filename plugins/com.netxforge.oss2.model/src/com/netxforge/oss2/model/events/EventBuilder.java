...
public class EventBuilder {
	...
	public EventBuilder addParam(final String parmName, final String val,
			final String type, final String encoding) {
		if (parmName != null) {
	...
	public void setField(final String name, final String val) {
		if (name.equals("eventparms")) {
			...
			final BeanWrapper w = PropertyAccessorFactory
					.forBeanPropertyAccess(m_event);
			try {
				w.setPropertyValue(name, val);
			} catch (final BeansException e) {
				LogUtils.warnf(this, e, "Could not set field on event: %s",
						name);
			}
		}
	}
