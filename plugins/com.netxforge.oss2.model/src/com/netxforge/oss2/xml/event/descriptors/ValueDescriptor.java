...
@SuppressWarnings("all") public class ValueDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ValueDescriptor() {
        ...
        { //-- local scope
            ...
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
            fieldValidator.setValidator(typeValidator);
            typeValidator.addPattern("(int|string|Int32|OctetString|Null|ObjectIdentifier|Sequence|IpAddress|Counter32|Gauge32|TimeTicks|Opaque|Counter64)");
            typeValidator.setWhiteSpace("preserve");
        }
        desc.setValidator(fieldValidator);
        //-- _encoding
        ...
        { //-- local scope
            ...
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
            fieldValidator.setValidator(typeValidator);
            typeValidator.addPattern("(text|base64)");
            typeValidator.setWhiteSpace("preserve");
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return org.opennms.netmgt.xml.event.Value.class;
    }
