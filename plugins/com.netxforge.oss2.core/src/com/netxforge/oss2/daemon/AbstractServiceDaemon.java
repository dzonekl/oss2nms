...
import com.netxforge.oss2.model.ServiceDaemon;
...
public abstract class AbstractServiceDaemon implements ServiceDaemon,
	 ...
	 *             if any.
	 */
	protected final void waitForStatus(final int status, final long timeout)
	 ...
	 *             if any.
	 */
	protected final void waitForStatus(final int status)
			throws InterruptedException {
		synchronized (m_statusLock) {
	 ...
	 *            a {@link java.lang.Object} object.
	 */
	protected void fatalf(final Throwable t, final String format,
			final Object... args) {
	 ...
	 *            a {@link java.lang.Object} object.
	 */
	protected void errorf(final Throwable t, final String format,
			final Object... args) {
	 ...
	 *            a {@link java.lang.Object} object.
	 */
	protected void warnf(final Throwable t, final String format,
			final Object... args) {
	 ...
	 *            a {@link java.lang.Object} object.
	 */
	protected void infof(final Throwable t, final String format,
			final Object... args) {
		if (log().isInfoEnabled()) {
	 ...
	 *            a {@link java.lang.Object} object.
	 */
	protected void debugf(final Throwable t, final String format,
			final Object... args) {
		if (log().isDebugEnabled()) {
