...
@SuppressWarnings("all") public class Category implements java.io.Serializable {
     ...
     *  category
     */
    private java.util.List<com.netxforge.oss2.xml.rtc.Node> _nodeList;
    ...
    public Category() {
        super();
        this._nodeList = new java.util.ArrayList<com.netxforge.oss2.xml.rtc.Node>();
    }
     ...
     */
    public void addNode(
            final com.netxforge.oss2.xml.rtc.Node vNode)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.xml.rtc.Node> enumerateNode(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the com.netxforge.oss2.xml.rtc.Node at
     * the given index
     */
    public com.netxforge.oss2.xml.rtc.Node getNode(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.xml.rtc.Node) _nodeList.get(index);
    }
    ...
    public com.netxforge.oss2.xml.rtc.Node[] getNode(
        ...
        com.netxforge.oss2.xml.rtc.Node[] array = new com.netxforge.oss2.xml.rtc.Node[0];
        return (com.netxforge.oss2.xml.rtc.Node[]) this._nodeList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.xml.rtc.Node> getNodeCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.xml.rtc.Node> iterateNode(
    ) {
     ...
     */
    public com.netxforge.oss2.xml.rtc.Node removeNodeAt(
            final int index) {
        java.lang.Object obj = this._nodeList.remove(index);
        return (com.netxforge.oss2.xml.rtc.Node) obj;
    }
     ...
     */
    public void setNode(
            final com.netxforge.oss2.xml.rtc.Node[] vNodeArray) {
        //-- copy array
        _nodeList.clear();
     ...
     */
    public void setNode(
            final java.util.List<com.netxforge.oss2.xml.rtc.Node> vNodeList) {
        // copy vector
        this._nodeList.clear();
    ...
    public void setNodeCollection(
            final java.util.List<com.netxforge.oss2.xml.rtc.Node> nodeList) {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.netxforge.oss2.xml.rtc.Category
     */
    public static com.netxforge.oss2.xml.rtc.Category unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.xml.rtc.Category) Unmarshaller.unmarshal(com.netxforge.oss2.xml.rtc.Category.class, reader);
    }
