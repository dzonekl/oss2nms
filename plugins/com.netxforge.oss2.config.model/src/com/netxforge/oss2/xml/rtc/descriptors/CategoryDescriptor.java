...
import com.netxforge.oss2.xml.rtc.Category;
...
@SuppressWarnings("all") public class CategoryDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CategoryDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _nodeList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.xml.rtc.Node.class, "_nodeList", "node", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Category target = (Category) object;
                    target.addNode( (com.netxforge.oss2.xml.rtc.Node) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.xml.rtc.Node();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.xml.rtc.Node");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/rtceui");
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.xml.rtc.Category.class;
    }
