...
package com.netxforge.oss2.config.provisiond;
...
@SuppressWarnings("all") public class ProvisiondConfiguration implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.provisiond.RequisitionDef> _requisitionDefList;
    ...
    public ProvisiondConfiguration() {
        ...
        this._requisitionDefList = new java.util.ArrayList<com.netxforge.oss2.config.provisiond.RequisitionDef>();
    }
    ...
    public void addRequisitionDef(
            final com.netxforge.oss2.config.provisiond.RequisitionDef vRequisitionDef)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.provisiond.RequisitionDef> enumerateRequisitionDef(
    ) {
     ...
     * com.netxforge.oss2.config.provisiond.RequisitionDef at the
     * given index
     */
    public com.netxforge.oss2.config.provisiond.RequisitionDef getRequisitionDef(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.provisiond.RequisitionDef) _requisitionDefList.get(index);
    }
    ...
    public com.netxforge.oss2.config.provisiond.RequisitionDef[] getRequisitionDef(
        ...
        com.netxforge.oss2.config.provisiond.RequisitionDef[] array = new com.netxforge.oss2.config.provisiond.RequisitionDef[0];
        return (com.netxforge.oss2.config.provisiond.RequisitionDef[]) this._requisitionDefList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.provisiond.RequisitionDef> getRequisitionDefCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.provisiond.RequisitionDef> iterateRequisitionDef(
    ) {
     ...
     */
    public com.netxforge.oss2.config.provisiond.RequisitionDef removeRequisitionDefAt(
            final int index) {
        java.lang.Object obj = this._requisitionDefList.remove(index);
        return (com.netxforge.oss2.config.provisiond.RequisitionDef) obj;
    }
     ...
     */
    public void setRequisitionDef(
            final com.netxforge.oss2.config.provisiond.RequisitionDef[] vRequisitionDefArray) {
        //-- copy array
     ...
     */
    public void setRequisitionDef(
            final java.util.List<com.netxforge.oss2.config.provisiond.RequisitionDef> vRequisitionDefList) {
        // copy vector
        this._requisitionDefList.clear();
    ...
    public void setRequisitionDefCollection(
            final java.util.List<com.netxforge.oss2.config.provisiond.RequisitionDef> requisitionDefList) {
     ...
     * com.netxforge.oss2.config.provisiond.ProvisiondConfiguration
     */
    public static com.netxforge.oss2.config.provisiond.ProvisiondConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.provisiond.ProvisiondConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.provisiond.ProvisiondConfiguration.class, reader);
    }
