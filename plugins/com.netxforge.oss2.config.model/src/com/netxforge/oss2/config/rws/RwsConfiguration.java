...
package com.netxforge.oss2.config.rws;
...
@SuppressWarnings("all") public class RwsConfiguration implements java.io.Serializable {
     ...
     */
    private com.netxforge.oss2.config.rws.BaseUrl _baseUrl;

    /**
     * Stand By Url(s) for Rancid Servers.
     */
    private java.util.List<com.netxforge.oss2.config.rws.StandbyUrl> _standbyUrlList;
    ...
    public RwsConfiguration() {
        super();
        this._standbyUrlList = new java.util.ArrayList<com.netxforge.oss2.config.rws.StandbyUrl>();
    }
    ...
    public void addStandbyUrl(
            final com.netxforge.oss2.config.rws.StandbyUrl vStandbyUrl)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.rws.StandbyUrl> enumerateStandbyUrl(
    ) {
     ...
     */
    public com.netxforge.oss2.config.rws.BaseUrl getBaseUrl(
    ) {
     ...
     * com.netxforge.oss2.config.rws.StandbyUrl at the given index
     */
    public com.netxforge.oss2.config.rws.StandbyUrl getStandbyUrl(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.rws.StandbyUrl) _standbyUrlList.get(index);
    }
    ...
    public com.netxforge.oss2.config.rws.StandbyUrl[] getStandbyUrl(
        ...
        com.netxforge.oss2.config.rws.StandbyUrl[] array = new com.netxforge.oss2.config.rws.StandbyUrl[0];
        return (com.netxforge.oss2.config.rws.StandbyUrl[]) this._standbyUrlList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.rws.StandbyUrl> getStandbyUrlCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.rws.StandbyUrl> iterateStandbyUrl(
    ) {
     ...
     */
    public com.netxforge.oss2.config.rws.StandbyUrl removeStandbyUrlAt(
            final int index) {
        java.lang.Object obj = this._standbyUrlList.remove(index);
        return (com.netxforge.oss2.config.rws.StandbyUrl) obj;
    }
    ...
    public void setBaseUrl(
            final com.netxforge.oss2.config.rws.BaseUrl baseUrl) {
     ...
     */
    public void setStandbyUrl(
            final com.netxforge.oss2.config.rws.StandbyUrl[] vStandbyUrlArray) {
        //-- copy array
     ...
     */
    public void setStandbyUrl(
            final java.util.List<com.netxforge.oss2.config.rws.StandbyUrl> vStandbyUrlList) {
        // copy vector
        this._standbyUrlList.clear();
    ...
    public void setStandbyUrlCollection(
            final java.util.List<com.netxforge.oss2.config.rws.StandbyUrl> standbyUrlList) {
     ...
     * com.netxforge.oss2.config.rws.RwsConfiguration
     */
    public static com.netxforge.oss2.config.rws.RwsConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.rws.RwsConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.rws.RwsConfiguration.class, reader);
    }
