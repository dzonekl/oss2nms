...
import com.netxforge.oss2.config.capsd.SmbAuth;

/**
 * Class SmbAuthDescriptor.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("all") public class SmbAuthDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SmbAuthDescriptor() {
        ...
        { //-- local scope
            ...
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
            fieldValidator.setValidator(typeValidator);
            typeValidator.addPattern("(domain|server)");
            typeValidator.setWhiteSpace("preserve");
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.capsd.SmbAuth.class;
    }
