...
@SuppressWarnings("all") public class ProtocolPlugin implements java.io.Serializable {
     ...
     *  configuration
     */
    private java.util.List<com.netxforge.oss2.config.capsd.ProtocolConfiguration> _protocolConfigurationList;

    /**
     * key/value pair passed in to the
     *  plugin
     */
    private java.util.List<com.netxforge.oss2.config.capsd.Property> _propertyList;
    ...
    public ProtocolPlugin() {
        ...
        this._protocolConfigurationList = new java.util.ArrayList<com.netxforge.oss2.config.capsd.ProtocolConfiguration>();
        this._propertyList = new java.util.ArrayList<com.netxforge.oss2.config.capsd.Property>();
    }
    ...
    public void addProperty(
            final com.netxforge.oss2.config.capsd.Property vProperty)
    ...
    public void addProtocolConfiguration(
            final com.netxforge.oss2.config.capsd.ProtocolConfiguration vProtocolConfiguration)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.capsd.Property> enumerateProperty(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.capsd.ProtocolConfiguration> enumerateProtocolConfiguration(
    ) {
     ...
     * com.netxforge.oss2.config.capsd.Property at the given index
     */
    public com.netxforge.oss2.config.capsd.Property getProperty(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.capsd.Property) _propertyList.get(index);
    }
    ...
    public com.netxforge.oss2.config.capsd.Property[] getProperty(
        ...
        com.netxforge.oss2.config.capsd.Property[] array = new com.netxforge.oss2.config.capsd.Property[0];
        return (com.netxforge.oss2.config.capsd.Property[]) this._propertyList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.capsd.Property> getPropertyCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.capsd.ProtocolConfiguration at the
     * given index
     */
    public com.netxforge.oss2.config.capsd.ProtocolConfiguration getProtocolConfiguration(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.capsd.ProtocolConfiguration) _protocolConfigurationList.get(index);
    }
    ...
    public com.netxforge.oss2.config.capsd.ProtocolConfiguration[] getProtocolConfiguration(
        ...
        com.netxforge.oss2.config.capsd.ProtocolConfiguration[] array = new com.netxforge.oss2.config.capsd.ProtocolConfiguration[0];
        return (com.netxforge.oss2.config.capsd.ProtocolConfiguration[]) this._protocolConfigurationList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.capsd.ProtocolConfiguration> getProtocolConfigurationCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.capsd.Property> iterateProperty(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.capsd.ProtocolConfiguration> iterateProtocolConfiguration(
    ) {
     ...
     */
    public com.netxforge.oss2.config.capsd.Property removePropertyAt(
            final int index) {
        java.lang.Object obj = this._propertyList.remove(index);
        return (com.netxforge.oss2.config.capsd.Property) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.capsd.ProtocolConfiguration removeProtocolConfigurationAt(
            final int index) {
        java.lang.Object obj = this._protocolConfigurationList.remove(index);
        return (com.netxforge.oss2.config.capsd.ProtocolConfiguration) obj;
    }
     ...
     */
    public void setProperty(
            final com.netxforge.oss2.config.capsd.Property[] vPropertyArray) {
        //-- copy array
        _propertyList.clear();
     ...
     */
    public void setProperty(
            final java.util.List<com.netxforge.oss2.config.capsd.Property> vPropertyList) {
        // copy vector
        this._propertyList.clear();
    ...
    public void setPropertyCollection(
            final java.util.List<com.netxforge.oss2.config.capsd.Property> propertyList) {
     ...
     */
    public void setProtocolConfiguration(
            final com.netxforge.oss2.config.capsd.ProtocolConfiguration[] vProtocolConfigurationArray) {
        //-- copy array
     ...
     */
    public void setProtocolConfiguration(
            final java.util.List<com.netxforge.oss2.config.capsd.ProtocolConfiguration> vProtocolConfigurationList) {
        // copy vector
        this._protocolConfigurationList.clear();
    ...
    public void setProtocolConfigurationCollection(
            final java.util.List<com.netxforge.oss2.config.capsd.ProtocolConfiguration> protocolConfigurationList) {
     ...
     * com.netxforge.oss2.config.capsd.ProtocolPlugin
     */
    public static com.netxforge.oss2.config.capsd.ProtocolPlugin unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.capsd.ProtocolPlugin) Unmarshaller.unmarshal(com.netxforge.oss2.config.capsd.ProtocolPlugin.class, reader);
    }
