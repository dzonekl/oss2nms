...
@SuppressWarnings("all") public class SmbConfig implements java.io.Serializable {
     ...
     * SMB authentication
     */
    private java.util.List<com.netxforge.oss2.config.capsd.SmbAuth> _smbAuthList;
    ...
    public SmbConfig() {
        super();
        this._smbAuthList = new java.util.ArrayList<com.netxforge.oss2.config.capsd.SmbAuth>();
    }
    ...
    public void addSmbAuth(
            final com.netxforge.oss2.config.capsd.SmbAuth vSmbAuth)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.capsd.SmbAuth> enumerateSmbAuth(
    ) {
     ...
     * com.netxforge.oss2.config.capsd.SmbAuth at the given index
     */
    public com.netxforge.oss2.config.capsd.SmbAuth getSmbAuth(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.capsd.SmbAuth) _smbAuthList.get(index);
    }
    ...
    public com.netxforge.oss2.config.capsd.SmbAuth[] getSmbAuth(
        ...
        com.netxforge.oss2.config.capsd.SmbAuth[] array = new com.netxforge.oss2.config.capsd.SmbAuth[0];
        return (com.netxforge.oss2.config.capsd.SmbAuth[]) this._smbAuthList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.capsd.SmbAuth> getSmbAuthCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.capsd.SmbAuth> iterateSmbAuth(
    ) {
     ...
     */
    public com.netxforge.oss2.config.capsd.SmbAuth removeSmbAuthAt(
            final int index) {
        java.lang.Object obj = this._smbAuthList.remove(index);
        return (com.netxforge.oss2.config.capsd.SmbAuth) obj;
    }
     ...
     */
    public void setSmbAuth(
            final com.netxforge.oss2.config.capsd.SmbAuth[] vSmbAuthArray) {
        //-- copy array
        _smbAuthList.clear();
     ...
     */
    public void setSmbAuth(
            final java.util.List<com.netxforge.oss2.config.capsd.SmbAuth> vSmbAuthList) {
        // copy vector
        this._smbAuthList.clear();
    ...
    public void setSmbAuthCollection(
            final java.util.List<com.netxforge.oss2.config.capsd.SmbAuth> smbAuthList) {
     ...
     * com.netxforge.oss2.config.capsd.SmbConfig
     */
    public static com.netxforge.oss2.config.capsd.SmbConfig unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.capsd.SmbConfig) Unmarshaller.unmarshal(com.netxforge.oss2.config.capsd.SmbConfig.class, reader);
    }
