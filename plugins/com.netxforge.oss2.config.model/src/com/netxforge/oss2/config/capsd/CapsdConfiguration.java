...
package com.netxforge.oss2.config.capsd;
...
@SuppressWarnings("all") public class CapsdConfiguration implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.capsd.ProtocolPlugin> _protocolPluginList;

    /**
     * SMB protocol configuration (primarily for SMB
     *  authentication).
     */
    private com.netxforge.oss2.config.capsd.SmbConfig _smbConfig;

    /**
     * Managed/unmanaged IP addresses and address
     *  ranges.
     */
    private java.util.List<com.netxforge.oss2.config.capsd.IpManagement> _ipManagementList;
    ...
    public CapsdConfiguration() {
        ...
        setXmlrpc("false");
        this._protocolPluginList = new java.util.ArrayList<com.netxforge.oss2.config.capsd.ProtocolPlugin>();
        this._ipManagementList = new java.util.ArrayList<com.netxforge.oss2.config.capsd.IpManagement>();
    }
    ...
    public void addIpManagement(
            final com.netxforge.oss2.config.capsd.IpManagement vIpManagement)
    ...
    public void addProtocolPlugin(
            final com.netxforge.oss2.config.capsd.ProtocolPlugin vProtocolPlugin)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.capsd.IpManagement> enumerateIpManagement(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.capsd.ProtocolPlugin> enumerateProtocolPlugin(
    ) {
     ...
     * com.netxforge.oss2.config.capsd.IpManagement at the given
     * index
     */
    public com.netxforge.oss2.config.capsd.IpManagement getIpManagement(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.capsd.IpManagement) _ipManagementList.get(index);
    }
    ...
    public com.netxforge.oss2.config.capsd.IpManagement[] getIpManagement(
        ...
        com.netxforge.oss2.config.capsd.IpManagement[] array = new com.netxforge.oss2.config.capsd.IpManagement[0];
        return (com.netxforge.oss2.config.capsd.IpManagement[]) this._ipManagementList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.capsd.IpManagement> getIpManagementCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.capsd.ProtocolPlugin at the given
     * index
     */
    public com.netxforge.oss2.config.capsd.ProtocolPlugin getProtocolPlugin(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.capsd.ProtocolPlugin) _protocolPluginList.get(index);
    }
    ...
    public com.netxforge.oss2.config.capsd.ProtocolPlugin[] getProtocolPlugin(
        ...
        com.netxforge.oss2.config.capsd.ProtocolPlugin[] array = new com.netxforge.oss2.config.capsd.ProtocolPlugin[0];
        return (com.netxforge.oss2.config.capsd.ProtocolPlugin[]) this._protocolPluginList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.capsd.ProtocolPlugin> getProtocolPluginCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.capsd.SmbConfig getSmbConfig(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.capsd.IpManagement> iterateIpManagement(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.capsd.ProtocolPlugin> iterateProtocolPlugin(
    ) {
     ...
     */
    public com.netxforge.oss2.config.capsd.IpManagement removeIpManagementAt(
            final int index) {
        java.lang.Object obj = this._ipManagementList.remove(index);
        return (com.netxforge.oss2.config.capsd.IpManagement) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.capsd.ProtocolPlugin removeProtocolPluginAt(
            final int index) {
        java.lang.Object obj = this._protocolPluginList.remove(index);
        return (com.netxforge.oss2.config.capsd.ProtocolPlugin) obj;
    }
     ...
     */
    public void setIpManagement(
            final com.netxforge.oss2.config.capsd.IpManagement[] vIpManagementArray) {
        //-- copy array
     ...
     */
    public void setIpManagement(
            final java.util.List<com.netxforge.oss2.config.capsd.IpManagement> vIpManagementList) {
        // copy vector
        this._ipManagementList.clear();
    ...
    public void setIpManagementCollection(
            final java.util.List<com.netxforge.oss2.config.capsd.IpManagement> ipManagementList) {
     ...
     */
    public void setProtocolPlugin(
            final com.netxforge.oss2.config.capsd.ProtocolPlugin[] vProtocolPluginArray) {
        //-- copy array
     ...
     */
    public void setProtocolPlugin(
            final java.util.List<com.netxforge.oss2.config.capsd.ProtocolPlugin> vProtocolPluginList) {
        // copy vector
        this._protocolPluginList.clear();
    ...
    public void setProtocolPluginCollection(
            final java.util.List<com.netxforge.oss2.config.capsd.ProtocolPlugin> protocolPluginList) {
    ...
    public void setSmbConfig(
            final com.netxforge.oss2.config.capsd.SmbConfig smbConfig) {
     ...
     * com.netxforge.oss2.config.capsd.CapsdConfiguration
     */
    public static com.netxforge.oss2.config.capsd.CapsdConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.capsd.CapsdConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.capsd.CapsdConfiguration.class, reader);
    }
