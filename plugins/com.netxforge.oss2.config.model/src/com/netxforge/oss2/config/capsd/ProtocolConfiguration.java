...
@SuppressWarnings("all") public class ProtocolConfiguration implements java.io.Serializable {
     ...
     * Field _rangeList.
     */
    private java.util.List<com.netxforge.oss2.config.capsd.Range> _rangeList;
    ...
    public ProtocolConfiguration() {
        ...
        this._rangeList = new java.util.ArrayList<com.netxforge.oss2.config.capsd.Range>();
    ...
    public void addRange(
            final com.netxforge.oss2.config.capsd.Range vRange)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.capsd.Range> enumerateRange(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.capsd.Range at the given index
     */
    public com.netxforge.oss2.config.capsd.Range getRange(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.capsd.Range) _rangeList.get(index);
    }
    ...
    public com.netxforge.oss2.config.capsd.Range[] getRange(
        ...
        com.netxforge.oss2.config.capsd.Range[] array = new com.netxforge.oss2.config.capsd.Range[0];
        return (com.netxforge.oss2.config.capsd.Range[]) this._rangeList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.capsd.Range> getRangeCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.capsd.Range> iterateRange(
    ) {
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.capsd.Range removeRangeAt(
            final int index) {
        java.lang.Object obj = this._rangeList.remove(index);
        return (com.netxforge.oss2.config.capsd.Range) obj;
    }
     ...
     */
    public void setRange(
            final com.netxforge.oss2.config.capsd.Range[] vRangeArray) {
        //-- copy array
        _rangeList.clear();
     ...
     */
    public void setRange(
            final java.util.List<com.netxforge.oss2.config.capsd.Range> vRangeList) {
        // copy vector
        this._rangeList.clear();
    ...
    public void setRangeCollection(
            final java.util.List<com.netxforge.oss2.config.capsd.Range> rangeList) {
     ...
     * com.netxforge.oss2.config.capsd.ProtocolConfiguration
     */
    public static com.netxforge.oss2.config.capsd.ProtocolConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.capsd.ProtocolConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.capsd.ProtocolConfiguration.class, reader);
    }
