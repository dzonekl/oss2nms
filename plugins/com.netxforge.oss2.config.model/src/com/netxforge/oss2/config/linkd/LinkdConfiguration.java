...
@SuppressWarnings("all") public class LinkdConfiguration implements java.io.Serializable {
     ...
     *  
     */
    private com.netxforge.oss2.config.linkd.Iproutes _iproutes;
     ...
     *  
     */
    private com.netxforge.oss2.config.linkd.Vlans _vlans;
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.linkd.Package> _packageList;
    ...
    public LinkdConfiguration() {
        super();
        this._packageList = new java.util.ArrayList<com.netxforge.oss2.config.linkd.Package>();
    }
    ...
    public void addPackage(
            final com.netxforge.oss2.config.linkd.Package vPackage)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.linkd.Package> enumeratePackage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.linkd.Iproutes getIproutes(
    ) {
     ...
     * com.netxforge.oss2.config.linkd.Package at the given index
     */
    public com.netxforge.oss2.config.linkd.Package getPackage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.linkd.Package) _packageList.get(index);
    }
    ...
    public com.netxforge.oss2.config.linkd.Package[] getPackage(
        ...
        com.netxforge.oss2.config.linkd.Package[] array = new com.netxforge.oss2.config.linkd.Package[0];
        return (com.netxforge.oss2.config.linkd.Package[]) this._packageList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.linkd.Package> getPackageCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.linkd.Vlans getVlans(
    ) {
        return this._vlans;
    }
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.linkd.Package> iteratePackage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.linkd.Package removePackageAt(
            final int index) {
        java.lang.Object obj = this._packageList.remove(index);
        return (com.netxforge.oss2.config.linkd.Package) obj;
    }
    ...
    public void setIproutes(
            final com.netxforge.oss2.config.linkd.Iproutes iproutes) {
     ...
     */
    public void setPackage(
            final com.netxforge.oss2.config.linkd.Package[] vPackageArray) {
        //-- copy array
        _packageList.clear();
     ...
     */
    public void setPackage(
            final java.util.List<com.netxforge.oss2.config.linkd.Package> vPackageList) {
        // copy vector
        this._packageList.clear();
    ...
    public void setPackageCollection(
            final java.util.List<com.netxforge.oss2.config.linkd.Package> _packageList) {
    ...
    public void setVlans(
            final com.netxforge.oss2.config.linkd.Vlans vlans) {
        this._vlans = vlans;
    }
     ...
     * com.netxforge.oss2.config.linkd.LinkdConfiguration
     */
    public static com.netxforge.oss2.config.linkd.LinkdConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.linkd.LinkdConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.linkd.LinkdConfiguration.class, reader);
    }
