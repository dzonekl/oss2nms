...
@SuppressWarnings("all") public class Command implements java.io.Serializable {
     ...
     * Field _argumentList.
     */
    private java.util.List<com.netxforge.oss2.config.notificationCommands.Argument> _argumentList;
    ...
    public Command() {
        super();
        setBinary("true");
        this._argumentList = new java.util.ArrayList<com.netxforge.oss2.config.notificationCommands.Argument>();
    }
    ...
    public void addArgument(
            final com.netxforge.oss2.config.notificationCommands.Argument vArgument)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.notificationCommands.Argument> enumerateArgument(
    ) {
     ...
     * com.netxforge.oss2.config.notificationCommands.Argument at
     * the given index
     */
    public com.netxforge.oss2.config.notificationCommands.Argument getArgument(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.notificationCommands.Argument) _argumentList.get(index);
    }
    ...
    public com.netxforge.oss2.config.notificationCommands.Argument[] getArgument(
        ...
        com.netxforge.oss2.config.notificationCommands.Argument[] array = new com.netxforge.oss2.config.notificationCommands.Argument[0];
        return (com.netxforge.oss2.config.notificationCommands.Argument[]) this._argumentList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.notificationCommands.Argument> getArgumentCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.notificationCommands.Argument> iterateArgument(
    ) {
     ...
     */
    public com.netxforge.oss2.config.notificationCommands.Argument removeArgumentAt(
            final int index) {
        java.lang.Object obj = this._argumentList.remove(index);
        return (com.netxforge.oss2.config.notificationCommands.Argument) obj;
    }
     ...
     */
    public void setArgument(
            final com.netxforge.oss2.config.notificationCommands.Argument[] vArgumentArray) {
        //-- copy array
        _argumentList.clear();
     ...
     */
    public void setArgument(
            final java.util.List<com.netxforge.oss2.config.notificationCommands.Argument> vArgumentList) {
        // copy vector
        this._argumentList.clear();
    ...
    public void setArgumentCollection(
            final java.util.List<com.netxforge.oss2.config.notificationCommands.Argument> argumentList) {
     ...
     * com.netxforge.oss2.config.notificationCommands.Command
     */
    public static com.netxforge.oss2.config.notificationCommands.Command unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.notificationCommands.Command) Unmarshaller.unmarshal(com.netxforge.oss2.config.notificationCommands.Command.class, reader);
    }
