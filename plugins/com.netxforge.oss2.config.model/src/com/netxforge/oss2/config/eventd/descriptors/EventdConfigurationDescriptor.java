...
package com.netxforge.oss2.config.eventd.descriptors;

  //---------------------------------/
 //- Imported classes and packages -/
//---------------------------------/

import com.netxforge.oss2.config.eventd.EventdConfiguration;
...
@SuppressWarnings("all") public class EventdConfigurationDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public EventdConfigurationDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _queueLength
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Integer.TYPE, "_queueLength", "queueLength", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                EventdConfiguration target = (EventdConfiguration) object;
                if (!target.hasQueueLength()) { return null; }
                return new java.lang.Integer(target.getQueueLength());
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    if (value == null) {
                        target.deleteQueueLength();
                        return;
                    }
                    target.setQueueLength( ((java.lang.Integer) value).intValue());
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _queueLength
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            org.exolab.castor.xml.validators.IntValidator typeValidator;
            typeValidator = new org.exolab.castor.xml.validators.IntValidator();
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.eventd.EventdConfiguration.class;
    }
