...
@SuppressWarnings("all") public class Rows implements java.io.Serializable {
     ...
     * Field _rowDefList.
     */
    private java.util.List<com.netxforge.oss2.config.siteStatusViews.RowDef> _rowDefList;
    ...
    public Rows() {
        super();
        this._rowDefList = new java.util.ArrayList<com.netxforge.oss2.config.siteStatusViews.RowDef>();
    }
    ...
    public void addRowDef(
            final com.netxforge.oss2.config.siteStatusViews.RowDef vRowDef)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.siteStatusViews.RowDef> enumerateRowDef(
    ) {
     ...
     * com.netxforge.oss2.config.siteStatusViews.RowDef at the
     * given index
     */
    public com.netxforge.oss2.config.siteStatusViews.RowDef getRowDef(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.siteStatusViews.RowDef) _rowDefList.get(index);
    }
    ...
    public com.netxforge.oss2.config.siteStatusViews.RowDef[] getRowDef(
        ...
        com.netxforge.oss2.config.siteStatusViews.RowDef[] array = new com.netxforge.oss2.config.siteStatusViews.RowDef[0];
        return (com.netxforge.oss2.config.siteStatusViews.RowDef[]) this._rowDefList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.siteStatusViews.RowDef> getRowDefCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.siteStatusViews.RowDef> iterateRowDef(
    ) {
     ...
     */
    public com.netxforge.oss2.config.siteStatusViews.RowDef removeRowDefAt(
            final int index) {
        java.lang.Object obj = this._rowDefList.remove(index);
        return (com.netxforge.oss2.config.siteStatusViews.RowDef) obj;
    }
     ...
     */
    public void setRowDef(
            final com.netxforge.oss2.config.siteStatusViews.RowDef[] vRowDefArray) {
        //-- copy array
        _rowDefList.clear();
     ...
     */
    public void setRowDef(
            final java.util.List<com.netxforge.oss2.config.siteStatusViews.RowDef> vRowDefList) {
        // copy vector
        this._rowDefList.clear();
    ...
    public void setRowDefCollection(
            final java.util.List<com.netxforge.oss2.config.siteStatusViews.RowDef> rowDefList) {
     ...
     * com.netxforge.oss2.config.siteStatusViews.Rows
     */
    public static com.netxforge.oss2.config.siteStatusViews.Rows unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.siteStatusViews.Rows) Unmarshaller.unmarshal(com.netxforge.oss2.config.siteStatusViews.Rows.class, reader);
    }
