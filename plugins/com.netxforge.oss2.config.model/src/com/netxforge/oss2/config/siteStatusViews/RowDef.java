...
package com.netxforge.oss2.config.siteStatusViews;
...
@SuppressWarnings("all") public class RowDef implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.siteStatusViews.Category> _categoryList;
    ...
    public RowDef() {
        ...
        this._categoryList = new java.util.ArrayList<com.netxforge.oss2.config.siteStatusViews.Category>();
    }
    ...
    public void addCategory(
            final com.netxforge.oss2.config.siteStatusViews.Category vCategory)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.siteStatusViews.Category> enumerateCategory(
    ) {
     ...
     * com.netxforge.oss2.config.siteStatusViews.Category at the
     * given index
     */
    public com.netxforge.oss2.config.siteStatusViews.Category getCategory(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.siteStatusViews.Category) _categoryList.get(index);
    }
    ...
    public com.netxforge.oss2.config.siteStatusViews.Category[] getCategory(
        ...
        com.netxforge.oss2.config.siteStatusViews.Category[] array = new com.netxforge.oss2.config.siteStatusViews.Category[0];
        return (com.netxforge.oss2.config.siteStatusViews.Category[]) this._categoryList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.siteStatusViews.Category> getCategoryCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.siteStatusViews.Category> iterateCategory(
    ) {
     ...
     */
    public com.netxforge.oss2.config.siteStatusViews.Category removeCategoryAt(
            final int index) {
        java.lang.Object obj = this._categoryList.remove(index);
        return (com.netxforge.oss2.config.siteStatusViews.Category) obj;
    }
     ...
     */
    public void setCategory(
            final com.netxforge.oss2.config.siteStatusViews.Category[] vCategoryArray) {
        //-- copy array
        _categoryList.clear();
     ...
     */
    public void setCategory(
            final java.util.List<com.netxforge.oss2.config.siteStatusViews.Category> vCategoryList) {
        // copy vector
        this._categoryList.clear();
    ...
    public void setCategoryCollection(
            final java.util.List<com.netxforge.oss2.config.siteStatusViews.Category> categoryList) {
     ...
     * com.netxforge.oss2.config.siteStatusViews.RowDef
     */
    public static com.netxforge.oss2.config.siteStatusViews.RowDef unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.siteStatusViews.RowDef) Unmarshaller.unmarshal(com.netxforge.oss2.config.siteStatusViews.RowDef.class, reader);
    }
