...
package com.netxforge.oss2.config.server;
...
@SuppressWarnings("all") public class LocalServer implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.server.LocalServer
     */
    public static com.netxforge.oss2.config.server.LocalServer unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.server.LocalServer) Unmarshaller.unmarshal(com.netxforge.oss2.config.server.LocalServer.class, reader);
    }
