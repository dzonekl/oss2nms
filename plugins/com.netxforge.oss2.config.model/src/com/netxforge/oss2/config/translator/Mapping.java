...
@SuppressWarnings("all") public class Mapping implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.translator.Assignment> _assignmentList;
    ...
    public Mapping() {
        super();
        this._assignmentList = new java.util.ArrayList<com.netxforge.oss2.config.translator.Assignment>();
    }
    ...
    public void addAssignment(
            final com.netxforge.oss2.config.translator.Assignment vAssignment)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.translator.Assignment> enumerateAssignment(
    ) {
     ...
     * com.netxforge.oss2.config.translator.Assignment at the given
     * index
     */
    public com.netxforge.oss2.config.translator.Assignment getAssignment(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.translator.Assignment) _assignmentList.get(index);
    }
    ...
    public com.netxforge.oss2.config.translator.Assignment[] getAssignment(
        ...
        com.netxforge.oss2.config.translator.Assignment[] array = new com.netxforge.oss2.config.translator.Assignment[0];
        return (com.netxforge.oss2.config.translator.Assignment[]) this._assignmentList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.translator.Assignment> getAssignmentCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.translator.Assignment> iterateAssignment(
    ) {
     ...
     */
    public com.netxforge.oss2.config.translator.Assignment removeAssignmentAt(
            final int index) {
        java.lang.Object obj = this._assignmentList.remove(index);
        return (com.netxforge.oss2.config.translator.Assignment) obj;
    }
     ...
     */
    public void setAssignment(
            final com.netxforge.oss2.config.translator.Assignment[] vAssignmentArray) {
        //-- copy array
     ...
     */
    public void setAssignment(
            final java.util.List<com.netxforge.oss2.config.translator.Assignment> vAssignmentList) {
        // copy vector
        this._assignmentList.clear();
    ...
    public void setAssignmentCollection(
            final java.util.List<com.netxforge.oss2.config.translator.Assignment> assignmentList) {
     ...
     * com.netxforge.oss2.config.translator.Mapping
     */
    public static com.netxforge.oss2.config.translator.Mapping unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.translator.Mapping) Unmarshaller.unmarshal(com.netxforge.oss2.config.translator.Mapping.class, reader);
    }
