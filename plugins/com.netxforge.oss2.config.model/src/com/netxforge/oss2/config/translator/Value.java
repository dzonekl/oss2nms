...
@SuppressWarnings("all") public class Value implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.translator.Value> _valueList;
    ...
    public Value() {
        super();
        this._valueList = new java.util.ArrayList<com.netxforge.oss2.config.translator.Value>();
    }
    ...
    public void addValue(
            final com.netxforge.oss2.config.translator.Value vValue)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.translator.Value> enumerateValue(
    ) {
     ...
     * com.netxforge.oss2.config.translator.Value at the given index
     */
    public com.netxforge.oss2.config.translator.Value getValue(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.translator.Value) _valueList.get(index);
    }
    ...
    public com.netxforge.oss2.config.translator.Value[] getValue(
        ...
        com.netxforge.oss2.config.translator.Value[] array = new com.netxforge.oss2.config.translator.Value[0];
        return (com.netxforge.oss2.config.translator.Value[]) this._valueList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.translator.Value> getValueCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.translator.Value> iterateValue(
    ) {
     ...
     */
    public com.netxforge.oss2.config.translator.Value removeValueAt(
            final int index) {
        java.lang.Object obj = this._valueList.remove(index);
        return (com.netxforge.oss2.config.translator.Value) obj;
    }
     ...
     */
    public void setValue(
            final com.netxforge.oss2.config.translator.Value[] vValueArray) {
        //-- copy array
        _valueList.clear();
     ...
     */
    public void setValue(
            final java.util.List<com.netxforge.oss2.config.translator.Value> vValueList) {
        // copy vector
        this._valueList.clear();
    ...
    public void setValueCollection(
            final java.util.List<com.netxforge.oss2.config.translator.Value> valueList) {
     ...
     * com.netxforge.oss2.config.translator.Value
     */
    public static com.netxforge.oss2.config.translator.Value unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.translator.Value) Unmarshaller.unmarshal(com.netxforge.oss2.config.translator.Value.class, reader);
    }
