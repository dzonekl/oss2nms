...
@SuppressWarnings("all") public class DestinationPaths implements java.io.Serializable {
     ...
     *  file.
     */
    private com.netxforge.oss2.config.destinationPaths.Header _header;

    /**
     * Field _pathList.
     */
    private java.util.List<com.netxforge.oss2.config.destinationPaths.Path> _pathList;
    ...
    public DestinationPaths() {
        super();
        this._pathList = new java.util.ArrayList<com.netxforge.oss2.config.destinationPaths.Path>();
    }
     ...
     */
    public void addPath(
            final com.netxforge.oss2.config.destinationPaths.Path vPath)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.destinationPaths.Path> enumeratePath(
    ) {
     ...
     */
    public com.netxforge.oss2.config.destinationPaths.Header getHeader(
    ) {
        return this._header;
    }
     ...
     * com.netxforge.oss2.config.destinationPaths.Path at the given
     * index
     */
    public com.netxforge.oss2.config.destinationPaths.Path getPath(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.destinationPaths.Path) _pathList.get(index);
    }
    ...
    public com.netxforge.oss2.config.destinationPaths.Path[] getPath(
        ...
        com.netxforge.oss2.config.destinationPaths.Path[] array = new com.netxforge.oss2.config.destinationPaths.Path[0];
        return (com.netxforge.oss2.config.destinationPaths.Path[]) this._pathList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.destinationPaths.Path> getPathCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.destinationPaths.Path> iteratePath(
    ) {
     ...
     */
    public com.netxforge.oss2.config.destinationPaths.Path removePathAt(
            final int index) {
        java.lang.Object obj = this._pathList.remove(index);
        return (com.netxforge.oss2.config.destinationPaths.Path) obj;
    }
    ...
    public void setHeader(
            final com.netxforge.oss2.config.destinationPaths.Header header) {
        this._header = header;
    }
     ...
     */
    public void setPath(
            final com.netxforge.oss2.config.destinationPaths.Path[] vPathArray) {
        //-- copy array
        _pathList.clear();
     ...
     */
    public void setPath(
            final java.util.List<com.netxforge.oss2.config.destinationPaths.Path> vPathList) {
        // copy vector
        this._pathList.clear();
    ...
    public void setPathCollection(
            final java.util.List<com.netxforge.oss2.config.destinationPaths.Path> pathList) {
     ...
     * com.netxforge.oss2.config.destinationPaths.DestinationPaths
     */
    public static com.netxforge.oss2.config.destinationPaths.DestinationPaths unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.destinationPaths.DestinationPaths) Unmarshaller.unmarshal(com.netxforge.oss2.config.destinationPaths.DestinationPaths.class, reader);
    }
