...
@SuppressWarnings("all") public class Header implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.destinationPaths.Header
     */
    public static com.netxforge.oss2.config.destinationPaths.Header unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.destinationPaths.Header) Unmarshaller.unmarshal(com.netxforge.oss2.config.destinationPaths.Header.class, reader);
    }
