...
package com.netxforge.oss2.config.databaseReports;
...
@SuppressWarnings("all") public class DatabaseReports implements java.io.Serializable {
     ...
     * A report definition
     */
    private java.util.List<com.netxforge.oss2.config.databaseReports.Report> _reportList;
    ...
    public DatabaseReports() {
        super();
        this._reportList = new java.util.ArrayList<com.netxforge.oss2.config.databaseReports.Report>();
    }
    ...
    public void addReport(
            final com.netxforge.oss2.config.databaseReports.Report vReport)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.databaseReports.Report> enumerateReport(
    ) {
     ...
     * com.netxforge.oss2.config.databaseReports.Report at the
     * given index
     */
    public com.netxforge.oss2.config.databaseReports.Report getReport(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.databaseReports.Report) _reportList.get(index);
    }
    ...
    public com.netxforge.oss2.config.databaseReports.Report[] getReport(
        ...
        com.netxforge.oss2.config.databaseReports.Report[] array = new com.netxforge.oss2.config.databaseReports.Report[0];
        return (com.netxforge.oss2.config.databaseReports.Report[]) this._reportList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.databaseReports.Report> getReportCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.databaseReports.Report> iterateReport(
    ) {
     ...
     */
    public com.netxforge.oss2.config.databaseReports.Report removeReportAt(
            final int index) {
        java.lang.Object obj = this._reportList.remove(index);
        return (com.netxforge.oss2.config.databaseReports.Report) obj;
    }
     ...
     */
    public void setReport(
            final com.netxforge.oss2.config.databaseReports.Report[] vReportArray) {
        //-- copy array
        _reportList.clear();
     ...
     */
    public void setReport(
            final java.util.List<com.netxforge.oss2.config.databaseReports.Report> vReportList) {
        // copy vector
        this._reportList.clear();
    ...
    public void setReportCollection(
            final java.util.List<com.netxforge.oss2.config.databaseReports.Report> reportList) {
     ...
     * com.netxforge.oss2.config.databaseReports.DatabaseReports
     */
    public static com.netxforge.oss2.config.databaseReports.DatabaseReports unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.databaseReports.DatabaseReports) Unmarshaller.unmarshal(com.netxforge.oss2.config.databaseReports.DatabaseReports.class, reader);
    }
