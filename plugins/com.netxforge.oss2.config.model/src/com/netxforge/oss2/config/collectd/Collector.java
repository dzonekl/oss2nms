...
@SuppressWarnings("all") public class Collector implements java.io.Serializable {
     ...
     *  this service
     */
    private java.util.List<com.netxforge.oss2.config.collectd.Parameter> _parameterList;
    ...
    public Collector() {
        super();
        this._parameterList = new java.util.ArrayList<com.netxforge.oss2.config.collectd.Parameter>();
    }
    ...
    public void addParameter(
            final com.netxforge.oss2.config.collectd.Parameter vParameter)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.collectd.Parameter> enumerateParameter(
    ) {
     ...
     * com.netxforge.oss2.config.collectd.Parameter at the given
     * index
     */
    public com.netxforge.oss2.config.collectd.Parameter getParameter(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.collectd.Parameter) _parameterList.get(index);
    }
    ...
    public com.netxforge.oss2.config.collectd.Parameter[] getParameter(
        ...
        com.netxforge.oss2.config.collectd.Parameter[] array = new com.netxforge.oss2.config.collectd.Parameter[0];
        return (com.netxforge.oss2.config.collectd.Parameter[]) this._parameterList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.collectd.Parameter> getParameterCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.collectd.Parameter> iterateParameter(
    ) {
     ...
     */
    public com.netxforge.oss2.config.collectd.Parameter removeParameterAt(
            final int index) {
        java.lang.Object obj = this._parameterList.remove(index);
        return (com.netxforge.oss2.config.collectd.Parameter) obj;
    }
     ...
     */
    public void setParameter(
            final com.netxforge.oss2.config.collectd.Parameter[] vParameterArray) {
        //-- copy array
     ...
     */
    public void setParameter(
            final java.util.List<com.netxforge.oss2.config.collectd.Parameter> vParameterList) {
        // copy vector
        this._parameterList.clear();
    ...
    public void setParameterCollection(
            final java.util.List<com.netxforge.oss2.config.collectd.Parameter> parameterList) {
     ...
     * com.netxforge.oss2.config.collectd.Collector
     */
    public static com.netxforge.oss2.config.collectd.Collector unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.collectd.Collector) Unmarshaller.unmarshal(com.netxforge.oss2.config.collectd.Collector.class, reader);
    }
