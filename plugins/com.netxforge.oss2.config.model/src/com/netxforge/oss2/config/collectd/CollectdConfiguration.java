...
@SuppressWarnings("all") public class CollectdConfiguration implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.collectd.Package> _packageList;

    /**
     * Service collectors
     */
    private java.util.List<com.netxforge.oss2.config.collectd.Collector> _collectorList;
    ...
    public CollectdConfiguration() {
        super();
        this._packageList = new java.util.ArrayList<com.netxforge.oss2.config.collectd.Package>();
        this._collectorList = new java.util.ArrayList<com.netxforge.oss2.config.collectd.Collector>();
    }
    ...
    public void addCollector(
            final com.netxforge.oss2.config.collectd.Collector vCollector)
    ...
    public void addPackage(
            final com.netxforge.oss2.config.collectd.Package vPackage)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.collectd.Collector> enumerateCollector(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.collectd.Package> enumeratePackage(
    ) {
     ...
     * com.netxforge.oss2.config.collectd.Collector at the given
     * index
     */
    public com.netxforge.oss2.config.collectd.Collector getCollector(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.collectd.Collector) _collectorList.get(index);
    }
    ...
    public com.netxforge.oss2.config.collectd.Collector[] getCollector(
        ...
        com.netxforge.oss2.config.collectd.Collector[] array = new com.netxforge.oss2.config.collectd.Collector[0];
        return (com.netxforge.oss2.config.collectd.Collector[]) this._collectorList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.collectd.Collector> getCollectorCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.collectd.Package at the given index
     */
    public com.netxforge.oss2.config.collectd.Package getPackage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.collectd.Package) _packageList.get(index);
    }
    ...
    public com.netxforge.oss2.config.collectd.Package[] getPackage(
        ...
        com.netxforge.oss2.config.collectd.Package[] array = new com.netxforge.oss2.config.collectd.Package[0];
        return (com.netxforge.oss2.config.collectd.Package[]) this._packageList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.collectd.Package> getPackageCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.collectd.Collector> iterateCollector(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.collectd.Package> iteratePackage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.collectd.Collector removeCollectorAt(
            final int index) {
        java.lang.Object obj = this._collectorList.remove(index);
        return (com.netxforge.oss2.config.collectd.Collector) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.collectd.Package removePackageAt(
            final int index) {
        java.lang.Object obj = this._packageList.remove(index);
        return (com.netxforge.oss2.config.collectd.Package) obj;
    }
     ...
     */
    public void setCollector(
            final com.netxforge.oss2.config.collectd.Collector[] vCollectorArray) {
        //-- copy array
     ...
     */
    public void setCollector(
            final java.util.List<com.netxforge.oss2.config.collectd.Collector> vCollectorList) {
        // copy vector
        this._collectorList.clear();
    ...
    public void setCollectorCollection(
            final java.util.List<com.netxforge.oss2.config.collectd.Collector> collectorList) {
     ...
     */
    public void setPackage(
            final com.netxforge.oss2.config.collectd.Package[] vPackageArray) {
        //-- copy array
        _packageList.clear();
     ...
     */
    public void setPackage(
            final java.util.List<com.netxforge.oss2.config.collectd.Package> vPackageList) {
        // copy vector
        this._packageList.clear();
    ...
    public void setPackageCollection(
            final java.util.List<com.netxforge.oss2.config.collectd.Package> _packageList) {
     ...
     * com.netxforge.oss2.config.collectd.CollectdConfiguration
     */
    public static com.netxforge.oss2.config.collectd.CollectdConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.collectd.CollectdConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.collectd.CollectdConfiguration.class, reader);
    }
