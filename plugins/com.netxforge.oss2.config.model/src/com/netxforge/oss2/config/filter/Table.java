...
@SuppressWarnings("all") public class Table implements java.io.Serializable {
     ...
     * Field _joinList.
     */
    private java.util.List<com.netxforge.oss2.config.filter.Join> _joinList;

    /**
     * Field _columnList.
     */
    private java.util.List<com.netxforge.oss2.config.filter.Column> _columnList;
    ...
    public Table() {
        ...
        setVisible("true");
        setKey("secondary");
        this._joinList = new java.util.ArrayList<com.netxforge.oss2.config.filter.Join>();
        this._columnList = new java.util.ArrayList<com.netxforge.oss2.config.filter.Column>();
    }
    ...
    public void addColumn(
            final com.netxforge.oss2.config.filter.Column vColumn)
     ...
     */
    public void addJoin(
            final com.netxforge.oss2.config.filter.Join vJoin)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.filter.Column> enumerateColumn(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.filter.Join> enumerateJoin(
    ) {
     ...
     * com.netxforge.oss2.config.filter.Column at the given index
     */
    public com.netxforge.oss2.config.filter.Column getColumn(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.filter.Column) _columnList.get(index);
    }
    ...
    public com.netxforge.oss2.config.filter.Column[] getColumn(
        ...
        com.netxforge.oss2.config.filter.Column[] array = new com.netxforge.oss2.config.filter.Column[0];
        return (com.netxforge.oss2.config.filter.Column[]) this._columnList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.filter.Column> getColumnCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.filter.Join at the given index
     */
    public com.netxforge.oss2.config.filter.Join getJoin(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.filter.Join) _joinList.get(index);
    }
    ...
    public com.netxforge.oss2.config.filter.Join[] getJoin(
        ...
        com.netxforge.oss2.config.filter.Join[] array = new com.netxforge.oss2.config.filter.Join[0];
        return (com.netxforge.oss2.config.filter.Join[]) this._joinList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.filter.Join> getJoinCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.filter.Column> iterateColumn(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.filter.Join> iterateJoin(
    ) {
     ...
     */
    public com.netxforge.oss2.config.filter.Column removeColumnAt(
            final int index) {
        java.lang.Object obj = this._columnList.remove(index);
        return (com.netxforge.oss2.config.filter.Column) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.filter.Join removeJoinAt(
            final int index) {
        java.lang.Object obj = this._joinList.remove(index);
        return (com.netxforge.oss2.config.filter.Join) obj;
    }
     ...
     */
    public void setColumn(
            final com.netxforge.oss2.config.filter.Column[] vColumnArray) {
        //-- copy array
        _columnList.clear();
     ...
     */
    public void setColumn(
            final java.util.List<com.netxforge.oss2.config.filter.Column> vColumnList) {
        // copy vector
        this._columnList.clear();
    ...
    public void setColumnCollection(
            final java.util.List<com.netxforge.oss2.config.filter.Column> columnList) {
     ...
     */
    public void setJoin(
            final com.netxforge.oss2.config.filter.Join[] vJoinArray) {
        //-- copy array
        _joinList.clear();
     ...
     */
    public void setJoin(
            final java.util.List<com.netxforge.oss2.config.filter.Join> vJoinList) {
        // copy vector
        this._joinList.clear();
    ...
    public void setJoinCollection(
            final java.util.List<com.netxforge.oss2.config.filter.Join> joinList) {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.netxforge.oss2.config.filter.Tabl
     */
    public static com.netxforge.oss2.config.filter.Table unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.filter.Table) Unmarshaller.unmarshal(com.netxforge.oss2.config.filter.Table.class, reader);
    }
