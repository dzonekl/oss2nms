...
@SuppressWarnings("all") public class Constraint implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.filter.Constraint
     */
    public static com.netxforge.oss2.config.filter.Constraint unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.filter.Constraint) Unmarshaller.unmarshal(com.netxforge.oss2.config.filter.Constraint.class, reader);
    }
