...
import com.netxforge.oss2.config.javamail.JavamailConfiguration;
...
@SuppressWarnings("all") public class JavamailConfigurationDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public JavamailConfigurationDescriptor() {
        ...
        //-- _sendmailConfigList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.javamail.SendmailConfig.class, "_sendmailConfigList", "sendmail-config", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    JavamailConfiguration target = (JavamailConfiguration) object;
                    target.addSendmailConfig( (com.netxforge.oss2.config.javamail.SendmailConfig) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.javamail.SendmailConfig();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.javamail.SendmailConfig");
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
        //-- _readmailConfigList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.javamail.ReadmailConfig.class, "_readmailConfigList", "readmail-config", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    JavamailConfiguration target = (JavamailConfiguration) object;
                    target.addReadmailConfig( (com.netxforge.oss2.config.javamail.ReadmailConfig) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.javamail.ReadmailConfig();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.javamail.ReadmailConfig");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/config/javamail-configuration");
        desc.setRequired(true);
        desc.setMultivalued(true);
        ...
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.javamail.End2endMailConfig.class, "_end2endMailConfigList", "end2end-mail-config", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    JavamailConfiguration target = (JavamailConfiguration) object;
                    target.addEnd2endMailConfig( (com.netxforge.oss2.config.javamail.End2endMailConfig) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.javamail.End2endMailConfig();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.javamail.End2endMailConfig");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/config/javamail-configuration");
        desc.setRequired(true);
        desc.setMultivalued(true);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.javamail.JavamailConfiguration.class;
    }
