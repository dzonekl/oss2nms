...
@SuppressWarnings("all") public class SendmailConfig implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.javamail.JavamailProperty> _javamailPropertyList;
     ...
     *  
     */
    private com.netxforge.oss2.config.javamail.SendmailHost _sendmailHost;
     ...
     *  
     */
    private com.netxforge.oss2.config.javamail.SendmailProtocol _sendmailProtocol;
     ...
     *  
     */
    private com.netxforge.oss2.config.javamail.SendmailMessage _sendmailMessage;
     ...
     *  
     */
    private com.netxforge.oss2.config.javamail.UserAuth _userAuth;
    ...
    public SendmailConfig() {
        super();
        this._javamailPropertyList = new java.util.ArrayList<com.netxforge.oss2.config.javamail.JavamailProperty>();
    }
    ...
    public void addJavamailProperty(
            final com.netxforge.oss2.config.javamail.JavamailProperty vJavamailProperty)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.javamail.JavamailProperty> enumerateJavamailProperty(
    ) {
     ...
     * com.netxforge.oss2.config.javamail.JavamailProperty at the
     * given index
     */
    public com.netxforge.oss2.config.javamail.JavamailProperty getJavamailProperty(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.javamail.JavamailProperty) _javamailPropertyList.get(index);
    }
    ...
    public com.netxforge.oss2.config.javamail.JavamailProperty[] getJavamailProperty(
        ...
        com.netxforge.oss2.config.javamail.JavamailProperty[] array = new com.netxforge.oss2.config.javamail.JavamailProperty[0];
        return (com.netxforge.oss2.config.javamail.JavamailProperty[]) this._javamailPropertyList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.javamail.JavamailProperty> getJavamailPropertyCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.javamail.SendmailHost getSendmailHost(
    ) {
     ...
     */
    public com.netxforge.oss2.config.javamail.SendmailMessage getSendmailMessage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.javamail.SendmailProtocol getSendmailProtocol(
    ) {
     ...
     */
    public com.netxforge.oss2.config.javamail.UserAuth getUserAuth(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.javamail.JavamailProperty> iterateJavamailProperty(
    ) {
     ...
     */
    public com.netxforge.oss2.config.javamail.JavamailProperty removeJavamailPropertyAt(
            final int index) {
        java.lang.Object obj = this._javamailPropertyList.remove(index);
        return (com.netxforge.oss2.config.javamail.JavamailProperty) obj;
    }
     ...
     */
    public void setJavamailProperty(
            final com.netxforge.oss2.config.javamail.JavamailProperty[] vJavamailPropertyArray) {
        //-- copy array
     ...
     */
    public void setJavamailProperty(
            final java.util.List<com.netxforge.oss2.config.javamail.JavamailProperty> vJavamailPropertyList) {
        // copy vector
        this._javamailPropertyList.clear();
    ...
    public void setJavamailPropertyCollection(
            final java.util.List<com.netxforge.oss2.config.javamail.JavamailProperty> javamailPropertyList) {
    ...
    public void setSendmailHost(
            final com.netxforge.oss2.config.javamail.SendmailHost sendmailHost) {
    ...
    public void setSendmailMessage(
            final com.netxforge.oss2.config.javamail.SendmailMessage sendmailMessage) {
    ...
    public void setSendmailProtocol(
            final com.netxforge.oss2.config.javamail.SendmailProtocol sendmailProtocol) {
    ...
    public void setUserAuth(
            final com.netxforge.oss2.config.javamail.UserAuth userAuth) {
     ...
     * com.netxforge.oss2.config.javamail.SendmailConfig
     */
    public static com.netxforge.oss2.config.javamail.SendmailConfig unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.javamail.SendmailConfig) Unmarshaller.unmarshal(com.netxforge.oss2.config.javamail.SendmailConfig.class, reader);
    }
