...
@SuppressWarnings("all") public class Definition implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.wmi.Range> _rangeList;
    ...
    public Definition() {
        super();
        this._rangeList = new java.util.ArrayList<com.netxforge.oss2.config.wmi.Range>();
    ...
    public void addRange(
            final com.netxforge.oss2.config.wmi.Range vRange)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.wmi.Range> enumerateRange(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the com.netxforge.oss2.config.wmi.Range
     * at the given index
     */
    public com.netxforge.oss2.config.wmi.Range getRange(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.wmi.Range) _rangeList.get(index);
    }
    ...
    public com.netxforge.oss2.config.wmi.Range[] getRange(
        ...
        com.netxforge.oss2.config.wmi.Range[] array = new com.netxforge.oss2.config.wmi.Range[0];
        return (com.netxforge.oss2.config.wmi.Range[]) this._rangeList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.wmi.Range> getRangeCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.wmi.Range> iterateRange(
    ) {
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.wmi.Range removeRangeAt(
            final int index) {
        java.lang.Object obj = this._rangeList.remove(index);
        return (com.netxforge.oss2.config.wmi.Range) obj;
    }
     ...
     */
    public void setRange(
            final com.netxforge.oss2.config.wmi.Range[] vRangeArray) {
        //-- copy array
        _rangeList.clear();
     ...
     */
    public void setRange(
            final java.util.List<com.netxforge.oss2.config.wmi.Range> vRangeList) {
        // copy vector
        this._rangeList.clear();
    ...
    public void setRangeCollection(
            final java.util.List<com.netxforge.oss2.config.wmi.Range> rangeList) {
     ...
     * com.netxforge.oss2.config.wmi.Definition
     */
    public static com.netxforge.oss2.config.wmi.Definition unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.wmi.Definition) Unmarshaller.unmarshal(com.netxforge.oss2.config.wmi.Definition.class, reader);
    }
