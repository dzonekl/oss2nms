...
@SuppressWarnings("all") public class WmiDatacollectionConfig implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.wmi.WmiCollection> _wmiCollectionList;
    ...
    public WmiDatacollectionConfig() {
        super();
        this._wmiCollectionList = new java.util.ArrayList<com.netxforge.oss2.config.wmi.WmiCollection>();
    }
    ...
    public void addWmiCollection(
            final com.netxforge.oss2.config.wmi.WmiCollection vWmiCollection)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.wmi.WmiCollection> enumerateWmiCollection(
    ) {
     ...
     * com.netxforge.oss2.config.wmi.WmiCollection at the given inde
     */
    public com.netxforge.oss2.config.wmi.WmiCollection getWmiCollection(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.wmi.WmiCollection) _wmiCollectionList.get(index);
    }
    ...
    public com.netxforge.oss2.config.wmi.WmiCollection[] getWmiCollection(
        ...
        com.netxforge.oss2.config.wmi.WmiCollection[] array = new com.netxforge.oss2.config.wmi.WmiCollection[0];
        return (com.netxforge.oss2.config.wmi.WmiCollection[]) this._wmiCollectionList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.wmi.WmiCollection> getWmiCollectionCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.wmi.WmiCollection> iterateWmiCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.wmi.WmiCollection removeWmiCollectionAt(
            final int index) {
        java.lang.Object obj = this._wmiCollectionList.remove(index);
        return (com.netxforge.oss2.config.wmi.WmiCollection) obj;
    }
     ...
     */
    public void setWmiCollection(
            final com.netxforge.oss2.config.wmi.WmiCollection[] vWmiCollectionArray) {
        //-- copy array
     ...
     */
    public void setWmiCollection(
            final java.util.List<com.netxforge.oss2.config.wmi.WmiCollection> vWmiCollectionList) {
        // copy vector
        this._wmiCollectionList.clear();
    ...
    public void setWmiCollectionCollection(
            final java.util.List<com.netxforge.oss2.config.wmi.WmiCollection> wmiCollectionList) {
     ...
     * com.netxforge.oss2.config.wmi.WmiDatacollectionConfig
     */
    public static com.netxforge.oss2.config.wmi.WmiDatacollectionConfig unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.wmi.WmiDatacollectionConfig) Unmarshaller.unmarshal(com.netxforge.oss2.config.wmi.WmiDatacollectionConfig.class, reader);
    }
