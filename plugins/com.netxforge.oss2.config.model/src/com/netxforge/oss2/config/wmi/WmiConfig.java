...
@SuppressWarnings("all") public class WmiConfig implements java.io.Serializable {
     ...
     *  (retries, timeouts...)
     */
    private java.util.List<com.netxforge.oss2.config.wmi.Definition> _definitionList;
    ...
    public WmiConfig() {
        super();
        this._definitionList = new java.util.ArrayList<com.netxforge.oss2.config.wmi.Definition>();
    }
    ...
    public void addDefinition(
            final com.netxforge.oss2.config.wmi.Definition vDefinition)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.wmi.Definition> enumerateDefinition(
    ) {
     ...
     * com.netxforge.oss2.config.wmi.Definition at the given index
     */
    public com.netxforge.oss2.config.wmi.Definition getDefinition(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.wmi.Definition) _definitionList.get(index);
    }
    ...
    public com.netxforge.oss2.config.wmi.Definition[] getDefinition(
        ...
        com.netxforge.oss2.config.wmi.Definition[] array = new com.netxforge.oss2.config.wmi.Definition[0];
        return (com.netxforge.oss2.config.wmi.Definition[]) this._definitionList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.wmi.Definition> getDefinitionCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.wmi.Definition> iterateDefinition(
    ) {
     ...
     */
    public com.netxforge.oss2.config.wmi.Definition removeDefinitionAt(
            final int index) {
        java.lang.Object obj = this._definitionList.remove(index);
        return (com.netxforge.oss2.config.wmi.Definition) obj;
    }
     ...
     */
    public void setDefinition(
            final com.netxforge.oss2.config.wmi.Definition[] vDefinitionArray) {
        //-- copy array
     ...
     */
    public void setDefinition(
            final java.util.List<com.netxforge.oss2.config.wmi.Definition> vDefinitionList) {
        // copy vector
        this._definitionList.clear();
    ...
    public void setDefinitionCollection(
            final java.util.List<com.netxforge.oss2.config.wmi.Definition> definitionList) {
     ...
     * com.netxforge.oss2.config.wmi.WmiConfig
     */
    public static com.netxforge.oss2.config.wmi.WmiConfig unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.wmi.WmiConfig) Unmarshaller.unmarshal(com.netxforge.oss2.config.wmi.WmiConfig.class, reader);
    }
