...
import com.netxforge.oss2.config.wmi.Definition;
...
@SuppressWarnings("all") public class DefinitionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DefinitionDescriptor() {
        super();
        _nsURI = "http://xmlns.opennms.org/xsd/config/wmi";
        _xmlName = "definition";
        ...
        //-- _rangeList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.wmi.Range.class, "_rangeList", "range", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Definition target = (Definition) object;
                    target.addRange( (com.netxforge.oss2.config.wmi.Range) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.wmi.Range();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.wmi.Range");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/config/wmi");
        ...
        desc.setValidator(fieldValidator);
        //-- _ipMatchList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_ipMatchList", "ip-match", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Definition target = (Definition) object;
                    target.addIpMatch( (java.lang.String) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        { //-- local scope
            ...
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
            fieldValidator.setValidator(typeValidator);
            typeValidator.addPattern("([0-9]{1,3}((,|-)[0-9]{1,3})*|\\*)\\.([0-9]{1,3}((,|-)[0-9]{1,3})*|\\*)\\.([0-9]{1,3}((,|-)[0-9]{1,3})*|\\*)\\.([0-9]{1,3}((,|-)[0-9]{1,3})*|\\*)");
            typeValidator.setWhiteSpace("preserve");
        }
        desc.setValidator(fieldValidator);
    }
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.wmi.Definition.class;
    }
