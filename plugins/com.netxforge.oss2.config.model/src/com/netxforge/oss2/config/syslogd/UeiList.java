...
@SuppressWarnings("all") public class UeiList implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.syslogd.UeiMatch> _ueiMatchList;
    ...
    public UeiList() {
        super();
        this._ueiMatchList = new java.util.ArrayList<com.netxforge.oss2.config.syslogd.UeiMatch>();
    }
    ...
    public void addUeiMatch(
            final com.netxforge.oss2.config.syslogd.UeiMatch vUeiMatch)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.syslogd.UeiMatch> enumerateUeiMatch(
    ) {
     ...
     * com.netxforge.oss2.config.syslogd.UeiMatch at the given index
     */
    public com.netxforge.oss2.config.syslogd.UeiMatch getUeiMatch(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.syslogd.UeiMatch) _ueiMatchList.get(index);
    }
    ...
    public com.netxforge.oss2.config.syslogd.UeiMatch[] getUeiMatch(
        ...
        com.netxforge.oss2.config.syslogd.UeiMatch[] array = new com.netxforge.oss2.config.syslogd.UeiMatch[0];
        return (com.netxforge.oss2.config.syslogd.UeiMatch[]) this._ueiMatchList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.syslogd.UeiMatch> getUeiMatchCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.syslogd.UeiMatch> iterateUeiMatch(
    ) {
     ...
     */
    public com.netxforge.oss2.config.syslogd.UeiMatch removeUeiMatchAt(
            final int index) {
        java.lang.Object obj = this._ueiMatchList.remove(index);
        return (com.netxforge.oss2.config.syslogd.UeiMatch) obj;
    }
     ...
     */
    public void setUeiMatch(
            final com.netxforge.oss2.config.syslogd.UeiMatch[] vUeiMatchArray) {
        //-- copy array
        _ueiMatchList.clear();
     ...
     */
    public void setUeiMatch(
            final java.util.List<com.netxforge.oss2.config.syslogd.UeiMatch> vUeiMatchList) {
        // copy vector
        this._ueiMatchList.clear();
    ...
    public void setUeiMatchCollection(
            final java.util.List<com.netxforge.oss2.config.syslogd.UeiMatch> ueiMatchList) {
     ...
     * com.netxforge.oss2.config.syslogd.UeiList
     */
    public static com.netxforge.oss2.config.syslogd.UeiList unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.syslogd.UeiList) Unmarshaller.unmarshal(com.netxforge.oss2.config.syslogd.UeiList.class, reader);
    }
