...
@SuppressWarnings("all") public class HideMessage implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.syslogd.HideMatch> _hideMatchList;
    ...
    public HideMessage() {
        super();
        this._hideMatchList = new java.util.ArrayList<com.netxforge.oss2.config.syslogd.HideMatch>();
    }
    ...
    public void addHideMatch(
            final com.netxforge.oss2.config.syslogd.HideMatch vHideMatch)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.syslogd.HideMatch> enumerateHideMatch(
    ) {
     ...
     * com.netxforge.oss2.config.syslogd.HideMatch at the given inde
     */
    public com.netxforge.oss2.config.syslogd.HideMatch getHideMatch(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.syslogd.HideMatch) _hideMatchList.get(index);
    }
    ...
    public com.netxforge.oss2.config.syslogd.HideMatch[] getHideMatch(
        ...
        com.netxforge.oss2.config.syslogd.HideMatch[] array = new com.netxforge.oss2.config.syslogd.HideMatch[0];
        return (com.netxforge.oss2.config.syslogd.HideMatch[]) this._hideMatchList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.syslogd.HideMatch> getHideMatchCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.syslogd.HideMatch> iterateHideMatch(
    ) {
     ...
     */
    public com.netxforge.oss2.config.syslogd.HideMatch removeHideMatchAt(
            final int index) {
        java.lang.Object obj = this._hideMatchList.remove(index);
        return (com.netxforge.oss2.config.syslogd.HideMatch) obj;
    }
     ...
     */
    public void setHideMatch(
            final com.netxforge.oss2.config.syslogd.HideMatch[] vHideMatchArray) {
        //-- copy array
     ...
     */
    public void setHideMatch(
            final java.util.List<com.netxforge.oss2.config.syslogd.HideMatch> vHideMatchList) {
        // copy vector
        this._hideMatchList.clear();
    ...
    public void setHideMatchCollection(
            final java.util.List<com.netxforge.oss2.config.syslogd.HideMatch> hideMatchList) {
     ...
     * com.netxforge.oss2.config.syslogd.HideMessage
     */
    public static com.netxforge.oss2.config.syslogd.HideMessage unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.syslogd.HideMessage) Unmarshaller.unmarshal(com.netxforge.oss2.config.syslogd.HideMessage.class, reader);
    }
