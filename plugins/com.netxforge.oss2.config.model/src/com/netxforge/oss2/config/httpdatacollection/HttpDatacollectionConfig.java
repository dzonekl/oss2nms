...
@SuppressWarnings("all") public class HttpDatacollectionConfig implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.httpdatacollection.HttpCollection> _httpCollectionList;
    ...
    public HttpDatacollectionConfig() {
        super();
        this._httpCollectionList = new java.util.ArrayList<com.netxforge.oss2.config.httpdatacollection.HttpCollection>();
    }
    ...
    public void addHttpCollection(
            final com.netxforge.oss2.config.httpdatacollection.HttpCollection vHttpCollection)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.httpdatacollection.HttpCollection> enumerateHttpCollection(
    ) {
     ...
     * com.netxforge.oss2.config.httpdatacollection.HttpCollection
     * at the given index
     */
    public com.netxforge.oss2.config.httpdatacollection.HttpCollection getHttpCollection(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.httpdatacollection.HttpCollection) _httpCollectionList.get(index);
    }
    ...
    public com.netxforge.oss2.config.httpdatacollection.HttpCollection[] getHttpCollection(
        ...
        com.netxforge.oss2.config.httpdatacollection.HttpCollection[] array = new com.netxforge.oss2.config.httpdatacollection.HttpCollection[0];
        return (com.netxforge.oss2.config.httpdatacollection.HttpCollection[]) this._httpCollectionList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.httpdatacollection.HttpCollection> getHttpCollectionCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.httpdatacollection.HttpCollection> iterateHttpCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.httpdatacollection.HttpCollection removeHttpCollectionAt(
            final int index) {
        java.lang.Object obj = this._httpCollectionList.remove(index);
        return (com.netxforge.oss2.config.httpdatacollection.HttpCollection) obj;
    }
     ...
     */
    public void setHttpCollection(
            final com.netxforge.oss2.config.httpdatacollection.HttpCollection[] vHttpCollectionArray) {
        //-- copy array
     ...
     */
    public void setHttpCollection(
            final java.util.List<com.netxforge.oss2.config.httpdatacollection.HttpCollection> vHttpCollectionList) {
        // copy vector
        this._httpCollectionList.clear();
    ...
    public void setHttpCollectionCollection(
            final java.util.List<com.netxforge.oss2.config.httpdatacollection.HttpCollection> httpCollectionList) {
     ...
     * com.netxforge.oss2.config.httpdatacollection.HttpDatacollectionConfig
     */
    public static com.netxforge.oss2.config.httpdatacollection.HttpDatacollectionConfig unmarshal(
