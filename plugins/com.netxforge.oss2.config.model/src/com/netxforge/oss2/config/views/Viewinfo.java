...
@SuppressWarnings("all") public class Viewinfo implements java.io.Serializable {
     ...
     *  file.
     */
    private com.netxforge.oss2.config.views.Header _header;

    /**
     * Field _views.
     */
    private com.netxforge.oss2.config.views.Views _views;
     ...
     */
    public com.netxforge.oss2.config.views.Header getHeader(
    ) {
        return this._header;
    }
     ...
     */
    public com.netxforge.oss2.config.views.Views getViews(
    ) {
        return this._views;
    }
    ...
    public void setHeader(
            final com.netxforge.oss2.config.views.Header header) {
        this._header = header;
    }
    ...
    public void setViews(
            final com.netxforge.oss2.config.views.Views views) {
        this._views = views;
    }
     ...
     * com.netxforge.oss2.config.views.Viewinfo
     */
    public static com.netxforge.oss2.config.views.Viewinfo unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.views.Viewinfo) Unmarshaller.unmarshal(com.netxforge.oss2.config.views.Viewinfo.class, reader);
    }
