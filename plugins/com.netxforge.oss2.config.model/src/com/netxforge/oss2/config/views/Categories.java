...
@SuppressWarnings("all") public class Categories implements java.io.Serializable {
     ...
     * Field _categoryList.
     */
    private java.util.List<com.netxforge.oss2.config.views.Category> _categoryList;
    ...
    public Categories() {
        super();
        this._categoryList = new java.util.ArrayList<com.netxforge.oss2.config.views.Category>();
    }
    ...
    public void addCategory(
            final com.netxforge.oss2.config.views.Category vCategory)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.views.Category> enumerateCategory(
    ) {
     ...
     * com.netxforge.oss2.config.views.Category at the given index
     */
    public com.netxforge.oss2.config.views.Category getCategory(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.views.Category) _categoryList.get(index);
    }
    ...
    public com.netxforge.oss2.config.views.Category[] getCategory(
        ...
        com.netxforge.oss2.config.views.Category[] array = new com.netxforge.oss2.config.views.Category[0];
        return (com.netxforge.oss2.config.views.Category[]) this._categoryList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.views.Category> getCategoryCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.views.Category> iterateCategory(
    ) {
     ...
     */
    public com.netxforge.oss2.config.views.Category removeCategoryAt(
            final int index) {
        java.lang.Object obj = this._categoryList.remove(index);
        return (com.netxforge.oss2.config.views.Category) obj;
    }
     ...
     */
    public void setCategory(
            final com.netxforge.oss2.config.views.Category[] vCategoryArray) {
        //-- copy array
        _categoryList.clear();
     ...
     */
    public void setCategory(
            final java.util.List<com.netxforge.oss2.config.views.Category> vCategoryList) {
        // copy vector
        this._categoryList.clear();
    ...
    public void setCategoryCollection(
            final java.util.List<com.netxforge.oss2.config.views.Category> categoryList) {
     ...
     * com.netxforge.oss2.config.views.Categories
     */
    public static com.netxforge.oss2.config.views.Categories unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.views.Categories) Unmarshaller.unmarshal(com.netxforge.oss2.config.views.Categories.class, reader);
    }
