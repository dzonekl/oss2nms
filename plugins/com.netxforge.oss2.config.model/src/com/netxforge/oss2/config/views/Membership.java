...
@SuppressWarnings("all") public class Membership implements java.io.Serializable {
     ...
     * Field _memberList.
     */
    private java.util.List<com.netxforge.oss2.config.views.Member> _memberList;
    ...
    public Membership() {
        super();
        this._memberList = new java.util.ArrayList<com.netxforge.oss2.config.views.Member>();
    }
    ...
    public void addMember(
            final com.netxforge.oss2.config.views.Member vMember)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.views.Member> enumerateMember(
    ) {
     ...
     * com.netxforge.oss2.config.views.Member at the given index
     */
    public com.netxforge.oss2.config.views.Member getMember(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.views.Member) _memberList.get(index);
    }
    ...
    public com.netxforge.oss2.config.views.Member[] getMember(
        ...
        com.netxforge.oss2.config.views.Member[] array = new com.netxforge.oss2.config.views.Member[0];
        return (com.netxforge.oss2.config.views.Member[]) this._memberList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.views.Member> getMemberCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.views.Member> iterateMember(
    ) {
     ...
     */
    public com.netxforge.oss2.config.views.Member removeMemberAt(
            final int index) {
        java.lang.Object obj = this._memberList.remove(index);
        return (com.netxforge.oss2.config.views.Member) obj;
    }
     ...
     */
    public void setMember(
            final com.netxforge.oss2.config.views.Member[] vMemberArray) {
        //-- copy array
        _memberList.clear();
     ...
     */
    public void setMember(
            final java.util.List<com.netxforge.oss2.config.views.Member> vMemberList) {
        // copy vector
        this._memberList.clear();
    ...
    public void setMemberCollection(
            final java.util.List<com.netxforge.oss2.config.views.Member> memberList) {
     ...
     * com.netxforge.oss2.config.views.Membership
     */
    public static com.netxforge.oss2.config.views.Membership unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.views.Membership) Unmarshaller.unmarshal(com.netxforge.oss2.config.views.Membership.class, reader);
    }
