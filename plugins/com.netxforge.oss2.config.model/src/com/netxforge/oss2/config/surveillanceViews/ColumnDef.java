...
@SuppressWarnings("all") public class ColumnDef implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.surveillanceViews.Category> _categoryList;
    ...
    public ColumnDef() {
        super();
        this._categoryList = new java.util.ArrayList<com.netxforge.oss2.config.surveillanceViews.Category>();
    }
    ...
    public void addCategory(
            final com.netxforge.oss2.config.surveillanceViews.Category vCategory)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.surveillanceViews.Category> enumerateCategory(
    ) {
     ...
     * com.netxforge.oss2.config.surveillanceViews.Category at the
     * given index
     */
    public com.netxforge.oss2.config.surveillanceViews.Category getCategory(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.surveillanceViews.Category) _categoryList.get(index);
    }
    ...
    public com.netxforge.oss2.config.surveillanceViews.Category[] getCategory(
        ...
        com.netxforge.oss2.config.surveillanceViews.Category[] array = new com.netxforge.oss2.config.surveillanceViews.Category[0];
        return (com.netxforge.oss2.config.surveillanceViews.Category[]) this._categoryList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.surveillanceViews.Category> getCategoryCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.surveillanceViews.Category> iterateCategory(
    ) {
     ...
     */
    public com.netxforge.oss2.config.surveillanceViews.Category removeCategoryAt(
            final int index) {
        java.lang.Object obj = this._categoryList.remove(index);
        return (com.netxforge.oss2.config.surveillanceViews.Category) obj;
    }
     ...
     */
    public void setCategory(
            final com.netxforge.oss2.config.surveillanceViews.Category[] vCategoryArray) {
        //-- copy array
        _categoryList.clear();
     ...
     */
    public void setCategory(
            final java.util.List<com.netxforge.oss2.config.surveillanceViews.Category> vCategoryList) {
        // copy vector
        this._categoryList.clear();
    ...
    public void setCategoryCollection(
            final java.util.List<com.netxforge.oss2.config.surveillanceViews.Category> categoryList) {
     ...
     * com.netxforge.oss2.config.surveillanceViews.ColumnDef
     */
    public static com.netxforge.oss2.config.surveillanceViews.ColumnDef unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.surveillanceViews.ColumnDef) Unmarshaller.unmarshal(com.netxforge.oss2.config.surveillanceViews.ColumnDef.class, reader);
    }
