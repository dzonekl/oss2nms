...
@SuppressWarnings("all") public class SurveillanceViewConfiguration implements java.io.Serializable {
     ...
     * Field _views.
     */
    private com.netxforge.oss2.config.surveillanceViews.Views _views;
     ...
     */
    public com.netxforge.oss2.config.surveillanceViews.Views getViews(
    ) {
        return this._views;
    }
    ...
    public void setViews(
            final com.netxforge.oss2.config.surveillanceViews.Views views) {
        this._views = views;
    }
     ...
     * com.netxforge.oss2.config.surveillanceViews.SurveillanceViewConfiguration
     */
    public static com.netxforge.oss2.config.surveillanceViews.SurveillanceViewConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.surveillanceViews.SurveillanceViewConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.surveillanceViews.SurveillanceViewConfiguration.class, reader);
    }
