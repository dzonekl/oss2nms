...
package com.netxforge.oss2.config.surveillanceViews;
...
@SuppressWarnings("all") public class Columns implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.surveillanceViews.ColumnDef> _columnDefList;
    ...
    public Columns() {
        super();
        this._columnDefList = new java.util.ArrayList<com.netxforge.oss2.config.surveillanceViews.ColumnDef>();
    }
    ...
    public void addColumnDef(
            final com.netxforge.oss2.config.surveillanceViews.ColumnDef vColumnDef)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.surveillanceViews.ColumnDef> enumerateColumnDef(
    ) {
     ...
     * com.netxforge.oss2.config.surveillanceViews.ColumnDef at the
     * given index
     */
    public com.netxforge.oss2.config.surveillanceViews.ColumnDef getColumnDef(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.surveillanceViews.ColumnDef) _columnDefList.get(index);
    }
    ...
    public com.netxforge.oss2.config.surveillanceViews.ColumnDef[] getColumnDef(
        ...
        com.netxforge.oss2.config.surveillanceViews.ColumnDef[] array = new com.netxforge.oss2.config.surveillanceViews.ColumnDef[0];
        return (com.netxforge.oss2.config.surveillanceViews.ColumnDef[]) this._columnDefList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.surveillanceViews.ColumnDef> getColumnDefCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.surveillanceViews.ColumnDef> iterateColumnDef(
    ) {
     ...
     */
    public com.netxforge.oss2.config.surveillanceViews.ColumnDef removeColumnDefAt(
            final int index) {
        java.lang.Object obj = this._columnDefList.remove(index);
        return (com.netxforge.oss2.config.surveillanceViews.ColumnDef) obj;
    }
     ...
     */
    public void setColumnDef(
            final com.netxforge.oss2.config.surveillanceViews.ColumnDef[] vColumnDefArray) {
        //-- copy array
     ...
     */
    public void setColumnDef(
            final java.util.List<com.netxforge.oss2.config.surveillanceViews.ColumnDef> vColumnDefList) {
        // copy vector
        this._columnDefList.clear();
    ...
    public void setColumnDefCollection(
            final java.util.List<com.netxforge.oss2.config.surveillanceViews.ColumnDef> columnDefList) {
     ...
     * com.netxforge.oss2.config.surveillanceViews.Columns
     */
    public static com.netxforge.oss2.config.surveillanceViews.Columns unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.surveillanceViews.Columns) Unmarshaller.unmarshal(com.netxforge.oss2.config.surveillanceViews.Columns.class, reader);
    }
