...
@SuppressWarnings("all") public class ExternalServers implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.xmlrpcd.XmlrpcServer> _xmlrpcServerList;
    ...
    public ExternalServers() {
        super();
        this._xmlrpcServerList = new java.util.ArrayList<com.netxforge.oss2.config.xmlrpcd.XmlrpcServer>();
    ...
    public void addXmlrpcServer(
            final com.netxforge.oss2.config.xmlrpcd.XmlrpcServer vXmlrpcServer)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.xmlrpcd.XmlrpcServer> enumerateXmlrpcServer(
    ) {
     ...
     * com.netxforge.oss2.config.xmlrpcd.XmlrpcServer at the given
     * index
     */
    public com.netxforge.oss2.config.xmlrpcd.XmlrpcServer getXmlrpcServer(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.xmlrpcd.XmlrpcServer) _xmlrpcServerList.get(index);
    }
    ...
    public com.netxforge.oss2.config.xmlrpcd.XmlrpcServer[] getXmlrpcServer(
        ...
        com.netxforge.oss2.config.xmlrpcd.XmlrpcServer[] array = new com.netxforge.oss2.config.xmlrpcd.XmlrpcServer[0];
        return (com.netxforge.oss2.config.xmlrpcd.XmlrpcServer[]) this._xmlrpcServerList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.xmlrpcd.XmlrpcServer> getXmlrpcServerCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.xmlrpcd.XmlrpcServer> iterateXmlrpcServer(
    ) {
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.xmlrpcd.XmlrpcServer removeXmlrpcServerAt(
            final int index) {
        java.lang.Object obj = this._xmlrpcServerList.remove(index);
        return (com.netxforge.oss2.config.xmlrpcd.XmlrpcServer) obj;
    }
     ...
     */
    public void setXmlrpcServer(
            final com.netxforge.oss2.config.xmlrpcd.XmlrpcServer[] vXmlrpcServerArray) {
        //-- copy array
     ...
     */
    public void setXmlrpcServer(
            final java.util.List<com.netxforge.oss2.config.xmlrpcd.XmlrpcServer> vXmlrpcServerList) {
        // copy vector
        this._xmlrpcServerList.clear();
    ...
    public void setXmlrpcServerCollection(
            final java.util.List<com.netxforge.oss2.config.xmlrpcd.XmlrpcServer> xmlrpcServerList) {
     ...
     * com.netxforge.oss2.config.xmlrpcd.ExternalServers
     */
    public static com.netxforge.oss2.config.xmlrpcd.ExternalServers unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.xmlrpcd.ExternalServers) Unmarshaller.unmarshal(com.netxforge.oss2.config.xmlrpcd.ExternalServers.class, reader);
    }
