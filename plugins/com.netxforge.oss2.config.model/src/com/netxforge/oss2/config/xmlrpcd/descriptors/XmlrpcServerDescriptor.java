...
import com.netxforge.oss2.config.xmlrpcd.XmlrpcServer;

/**
 * Class XmlrpcServerDescriptor.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("all") public class XmlrpcServerDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public XmlrpcServerDescriptor() {
        super();
        _nsURI = "http://xmlns.opennms.org/xsd/config/xmlrpcd";
        _xmlName = "xmlrpc-server";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                XmlrpcServer target = (XmlrpcServer) object;
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.xmlrpcd.XmlrpcServer.class;
    }
