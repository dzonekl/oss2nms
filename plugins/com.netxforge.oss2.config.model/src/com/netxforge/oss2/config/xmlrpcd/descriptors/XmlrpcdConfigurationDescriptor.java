...
package com.netxforge.oss2.config.xmlrpcd.descriptors;

  //---------------------------------/
 //- Imported classes and packages -/
//---------------------------------/

import com.netxforge.oss2.config.xmlrpcd.XmlrpcdConfiguration;
...
@SuppressWarnings("all") public class XmlrpcdConfigurationDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public XmlrpcdConfigurationDescriptor() {
        ...
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.xmlrpcd.ExternalServers.class, "_externalServersList", "external-servers", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    XmlrpcdConfiguration target = (XmlrpcdConfiguration) object;
                    target.addExternalServers( (com.netxforge.oss2.config.xmlrpcd.ExternalServers) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.xmlrpcd.ExternalServers();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.xmlrpcd.ExternalServers");
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
        //-- _subscriptionList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.xmlrpcd.Subscription.class, "_subscriptionList", "subscription", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    XmlrpcdConfiguration target = (XmlrpcdConfiguration) object;
                    target.addSubscription( (com.netxforge.oss2.config.xmlrpcd.Subscription) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.xmlrpcd.Subscription();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.xmlrpcd.Subscription");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/config/xmlrpcd");
        desc.setRequired(true);
        desc.setMultivalued(true);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.xmlrpcd.XmlrpcdConfiguration.class;
    }
