...
@SuppressWarnings("all") public class Subscription implements java.io.Serializable {
     ...
     *  servers
     */
    private java.util.List<com.netxforge.oss2.config.xmlrpcd.SubscribedEvent> _subscribedEventList;
    ...
    public Subscription() {
        super();
        this._subscribedEventList = new java.util.ArrayList<com.netxforge.oss2.config.xmlrpcd.SubscribedEvent>();
    }
    ...
    public void addSubscribedEvent(
            final com.netxforge.oss2.config.xmlrpcd.SubscribedEvent vSubscribedEvent)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.xmlrpcd.SubscribedEvent> enumerateSubscribedEvent(
    ) {
     ...
     * com.netxforge.oss2.config.xmlrpcd.SubscribedEvent at the
     * given index
     */
    public com.netxforge.oss2.config.xmlrpcd.SubscribedEvent getSubscribedEvent(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.xmlrpcd.SubscribedEvent) _subscribedEventList.get(index);
    }
    ...
    public com.netxforge.oss2.config.xmlrpcd.SubscribedEvent[] getSubscribedEvent(
        ...
        com.netxforge.oss2.config.xmlrpcd.SubscribedEvent[] array = new com.netxforge.oss2.config.xmlrpcd.SubscribedEvent[0];
        return (com.netxforge.oss2.config.xmlrpcd.SubscribedEvent[]) this._subscribedEventList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.xmlrpcd.SubscribedEvent> getSubscribedEventCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.xmlrpcd.SubscribedEvent> iterateSubscribedEvent(
    ) {
     ...
     */
    public com.netxforge.oss2.config.xmlrpcd.SubscribedEvent removeSubscribedEventAt(
            final int index) {
        java.lang.Object obj = this._subscribedEventList.remove(index);
        return (com.netxforge.oss2.config.xmlrpcd.SubscribedEvent) obj;
    }
     ...
     */
    public void setSubscribedEvent(
            final com.netxforge.oss2.config.xmlrpcd.SubscribedEvent[] vSubscribedEventArray) {
        //-- copy array
     ...
     */
    public void setSubscribedEvent(
            final java.util.List<com.netxforge.oss2.config.xmlrpcd.SubscribedEvent> vSubscribedEventList) {
        // copy vector
        this._subscribedEventList.clear();
    ...
    public void setSubscribedEventCollection(
            final java.util.List<com.netxforge.oss2.config.xmlrpcd.SubscribedEvent> subscribedEventList) {
     ...
     * com.netxforge.oss2.config.xmlrpcd.Subscription
     */
    public static com.netxforge.oss2.config.xmlrpcd.Subscription unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.xmlrpcd.Subscription) Unmarshaller.unmarshal(com.netxforge.oss2.config.xmlrpcd.Subscription.class, reader);
    }
