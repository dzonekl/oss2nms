...
@SuppressWarnings("all") public class ServiceConfiguration implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.service.Service> _serviceList;
    ...
    public ServiceConfiguration() {
        super();
        this._serviceList = new java.util.ArrayList<com.netxforge.oss2.config.service.Service>();
    }
    ...
    public void addService(
            final com.netxforge.oss2.config.service.Service vService)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.service.Service> enumerateService(
    ) {
     ...
     * com.netxforge.oss2.config.service.Service at the given index
     */
    public com.netxforge.oss2.config.service.Service getService(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.service.Service) _serviceList.get(index);
    }
    ...
    public com.netxforge.oss2.config.service.Service[] getService(
        ...
        com.netxforge.oss2.config.service.Service[] array = new com.netxforge.oss2.config.service.Service[0];
        return (com.netxforge.oss2.config.service.Service[]) this._serviceList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.service.Service> getServiceCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.service.Service> iterateService(
    ) {
     ...
     */
    public com.netxforge.oss2.config.service.Service removeServiceAt(
            final int index) {
        java.lang.Object obj = this._serviceList.remove(index);
        return (com.netxforge.oss2.config.service.Service) obj;
    }
     ...
     */
    public void setService(
            final com.netxforge.oss2.config.service.Service[] vServiceArray) {
        //-- copy array
        _serviceList.clear();
     ...
     */
    public void setService(
            final java.util.List<com.netxforge.oss2.config.service.Service> vServiceList) {
        // copy vector
        this._serviceList.clear();
    ...
    public void setServiceCollection(
            final java.util.List<com.netxforge.oss2.config.service.Service> serviceList) {
     ...
     * com.netxforge.oss2.config.service.ServiceConfiguration
     */
    public static com.netxforge.oss2.config.service.ServiceConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.service.ServiceConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.service.ServiceConfiguration.class, reader);
    }
