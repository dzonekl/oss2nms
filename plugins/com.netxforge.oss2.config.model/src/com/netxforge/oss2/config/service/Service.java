...
package com.netxforge.oss2.config.service;
...
@SuppressWarnings("all") public class Service implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.service.Attribute> _attributeList;

    /**
     * Field _invokeList.
     */
    private java.util.List<com.netxforge.oss2.config.service.Invoke> _invokeList;
    ...
    public Service() {
        super();
        this._attributeList = new java.util.ArrayList<com.netxforge.oss2.config.service.Attribute>();
        this._invokeList = new java.util.ArrayList<com.netxforge.oss2.config.service.Invoke>();
    }
    ...
    public void addAttribute(
            final com.netxforge.oss2.config.service.Attribute vAttribute)
    ...
    public void addInvoke(
            final com.netxforge.oss2.config.service.Invoke vInvoke)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.service.Attribute> enumerateAttribute(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.service.Invoke> enumerateInvoke(
    ) {
     ...
     * com.netxforge.oss2.config.service.Attribute at the given inde
     */
    public com.netxforge.oss2.config.service.Attribute getAttribute(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.service.Attribute) _attributeList.get(index);
    }
    ...
    public com.netxforge.oss2.config.service.Attribute[] getAttribute(
        ...
        com.netxforge.oss2.config.service.Attribute[] array = new com.netxforge.oss2.config.service.Attribute[0];
        return (com.netxforge.oss2.config.service.Attribute[]) this._attributeList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.service.Attribute> getAttributeCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.service.Invoke at the given index
     */
    public com.netxforge.oss2.config.service.Invoke getInvoke(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.service.Invoke) _invokeList.get(index);
    }
    ...
    public com.netxforge.oss2.config.service.Invoke[] getInvoke(
        ...
        com.netxforge.oss2.config.service.Invoke[] array = new com.netxforge.oss2.config.service.Invoke[0];
        return (com.netxforge.oss2.config.service.Invoke[]) this._invokeList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.service.Invoke> getInvokeCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.service.Attribute> iterateAttribute(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.service.Invoke> iterateInvoke(
    ) {
     ...
     */
    public com.netxforge.oss2.config.service.Attribute removeAttributeAt(
            final int index) {
        java.lang.Object obj = this._attributeList.remove(index);
        return (com.netxforge.oss2.config.service.Attribute) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.service.Invoke removeInvokeAt(
            final int index) {
        java.lang.Object obj = this._invokeList.remove(index);
        return (com.netxforge.oss2.config.service.Invoke) obj;
    }
     ...
     */
    public void setAttribute(
            final com.netxforge.oss2.config.service.Attribute[] vAttributeArray) {
        //-- copy array
     ...
     */
    public void setAttribute(
            final java.util.List<com.netxforge.oss2.config.service.Attribute> vAttributeList) {
        // copy vector
        this._attributeList.clear();
    ...
    public void setAttributeCollection(
            final java.util.List<com.netxforge.oss2.config.service.Attribute> attributeList) {
     ...
     */
    public void setInvoke(
            final com.netxforge.oss2.config.service.Invoke[] vInvokeArray) {
        //-- copy array
        _invokeList.clear();
     ...
     */
    public void setInvoke(
            final java.util.List<com.netxforge.oss2.config.service.Invoke> vInvokeList) {
        // copy vector
        this._invokeList.clear();
    ...
    public void setInvokeCollection(
            final java.util.List<com.netxforge.oss2.config.service.Invoke> invokeList) {
     ...
     * com.netxforge.oss2.config.service.Service
     */
    public static com.netxforge.oss2.config.service.Service unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.service.Service) Unmarshaller.unmarshal(com.netxforge.oss2.config.service.Service.class, reader);
    }
