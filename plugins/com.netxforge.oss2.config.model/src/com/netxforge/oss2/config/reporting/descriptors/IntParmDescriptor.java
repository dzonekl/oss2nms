...
import com.netxforge.oss2.config.reporting.IntParm;

/**
 * Class IntParmDescriptor.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("all") public class IntParmDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public IntParmDescriptor() {
        ...
        { //-- local scope
            ...
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
            fieldValidator.setValidator(typeValidator);
            typeValidator.addPattern("(freeText)");
            typeValidator.setWhiteSpace("preserve");
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.reporting.IntParm.class;
    }
