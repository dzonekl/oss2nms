...
package com.netxforge.oss2.config.reporting.opennms;
...
@SuppressWarnings("all") public class OpennmsReports implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.reporting.opennms.Report> _reportList;
    ...
    public OpennmsReports() {
        super();
        this._reportList = new java.util.ArrayList<com.netxforge.oss2.config.reporting.opennms.Report>();
    }
    ...
    public void addReport(
            final com.netxforge.oss2.config.reporting.opennms.Report vReport)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.reporting.opennms.Report> enumerateReport(
    ) {
     ...
     * com.netxforge.oss2.config.reporting.opennms.Report at the
     * given index
     */
    public com.netxforge.oss2.config.reporting.opennms.Report getReport(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.reporting.opennms.Report) _reportList.get(index);
    }
    ...
    public com.netxforge.oss2.config.reporting.opennms.Report[] getReport(
        ...
        com.netxforge.oss2.config.reporting.opennms.Report[] array = new com.netxforge.oss2.config.reporting.opennms.Report[0];
        return (com.netxforge.oss2.config.reporting.opennms.Report[]) this._reportList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.reporting.opennms.Report> getReportCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.reporting.opennms.Report> iterateReport(
    ) {
     ...
     */
    public com.netxforge.oss2.config.reporting.opennms.Report removeReportAt(
            final int index) {
        java.lang.Object obj = this._reportList.remove(index);
        return (com.netxforge.oss2.config.reporting.opennms.Report) obj;
    }
     ...
     */
    public void setReport(
            final com.netxforge.oss2.config.reporting.opennms.Report[] vReportArray) {
        //-- copy array
        _reportList.clear();
     ...
     */
    public void setReport(
            final java.util.List<com.netxforge.oss2.config.reporting.opennms.Report> vReportList) {
        // copy vector
        this._reportList.clear();
    ...
    public void setReportCollection(
            final java.util.List<com.netxforge.oss2.config.reporting.opennms.Report> reportList) {
     ...
     * com.netxforge.oss2.config.reporting.opennms.OpennmsReports
     */
    public static com.netxforge.oss2.config.reporting.opennms.OpennmsReports unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.reporting.opennms.OpennmsReports) Unmarshaller.unmarshal(com.netxforge.oss2.config.reporting.opennms.OpennmsReports.class, reader);
    }
