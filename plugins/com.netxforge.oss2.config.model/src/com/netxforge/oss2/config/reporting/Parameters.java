...
package com.netxforge.oss2.config.reporting;
...
@SuppressWarnings("all") public class Parameters implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.reporting.StringParm> _stringParmList;

    /**
     * Field _dateParmList.
     */
    private java.util.List<com.netxforge.oss2.config.reporting.DateParm> _dateParmList;

    /**
     * Field _intParmList.
     */
    private java.util.List<com.netxforge.oss2.config.reporting.IntParm> _intParmList;
    ...
    public Parameters() {
        super();
        this._stringParmList = new java.util.ArrayList<com.netxforge.oss2.config.reporting.StringParm>();
        this._dateParmList = new java.util.ArrayList<com.netxforge.oss2.config.reporting.DateParm>();
        this._intParmList = new java.util.ArrayList<com.netxforge.oss2.config.reporting.IntParm>();
    }
    ...
    public void addDateParm(
            final com.netxforge.oss2.config.reporting.DateParm vDateParm)
    ...
    public void addIntParm(
            final com.netxforge.oss2.config.reporting.IntParm vIntParm)
    throws java.lang.IndexOutOfBoundsException {
    ...
    public void addStringParm(
            final com.netxforge.oss2.config.reporting.StringParm vStringParm)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.reporting.DateParm> enumerateDateParm(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.reporting.IntParm> enumerateIntParm(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.reporting.StringParm> enumerateStringParm(
    ) {
     ...
     * com.netxforge.oss2.config.reporting.DateParm at the given
     * index
     */
    public com.netxforge.oss2.config.reporting.DateParm getDateParm(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.reporting.DateParm) _dateParmList.get(index);
    }
    ...
    public com.netxforge.oss2.config.reporting.DateParm[] getDateParm(
        ...
        com.netxforge.oss2.config.reporting.DateParm[] array = new com.netxforge.oss2.config.reporting.DateParm[0];
        return (com.netxforge.oss2.config.reporting.DateParm[]) this._dateParmList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.reporting.DateParm> getDateParmCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.reporting.IntParm at the given inde
     */
    public com.netxforge.oss2.config.reporting.IntParm getIntParm(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.reporting.IntParm) _intParmList.get(index);
    }
    ...
    public com.netxforge.oss2.config.reporting.IntParm[] getIntParm(
        ...
        com.netxforge.oss2.config.reporting.IntParm[] array = new com.netxforge.oss2.config.reporting.IntParm[0];
        return (com.netxforge.oss2.config.reporting.IntParm[]) this._intParmList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.reporting.IntParm> getIntParmCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.reporting.StringParm at the given
     * index
     */
    public com.netxforge.oss2.config.reporting.StringParm getStringParm(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.reporting.StringParm) _stringParmList.get(index);
    }
    ...
    public com.netxforge.oss2.config.reporting.StringParm[] getStringParm(
        ...
        com.netxforge.oss2.config.reporting.StringParm[] array = new com.netxforge.oss2.config.reporting.StringParm[0];
        return (com.netxforge.oss2.config.reporting.StringParm[]) this._stringParmList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.reporting.StringParm> getStringParmCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.reporting.DateParm> iterateDateParm(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.reporting.IntParm> iterateIntParm(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.reporting.StringParm> iterateStringParm(
    ) {
     ...
     */
    public com.netxforge.oss2.config.reporting.DateParm removeDateParmAt(
            final int index) {
        java.lang.Object obj = this._dateParmList.remove(index);
        return (com.netxforge.oss2.config.reporting.DateParm) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.reporting.IntParm removeIntParmAt(
            final int index) {
        java.lang.Object obj = this._intParmList.remove(index);
        return (com.netxforge.oss2.config.reporting.IntParm) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.reporting.StringParm removeStringParmAt(
            final int index) {
        java.lang.Object obj = this._stringParmList.remove(index);
        return (com.netxforge.oss2.config.reporting.StringParm) obj;
    }
     ...
     */
    public void setDateParm(
            final com.netxforge.oss2.config.reporting.DateParm[] vDateParmArray) {
        //-- copy array
        _dateParmList.clear();
     ...
     */
    public void setDateParm(
            final java.util.List<com.netxforge.oss2.config.reporting.DateParm> vDateParmList) {
        // copy vector
        this._dateParmList.clear();
    ...
    public void setDateParmCollection(
            final java.util.List<com.netxforge.oss2.config.reporting.DateParm> dateParmList) {
     ...
     */
    public void setIntParm(
            final com.netxforge.oss2.config.reporting.IntParm[] vIntParmArray) {
        //-- copy array
        _intParmList.clear();
     ...
     */
    public void setIntParm(
            final java.util.List<com.netxforge.oss2.config.reporting.IntParm> vIntParmList) {
        // copy vector
        this._intParmList.clear();
    ...
    public void setIntParmCollection(
            final java.util.List<com.netxforge.oss2.config.reporting.IntParm> intParmList) {
     ...
     */
    public void setStringParm(
            final com.netxforge.oss2.config.reporting.StringParm[] vStringParmArray) {
        //-- copy array
     ...
     */
    public void setStringParm(
            final java.util.List<com.netxforge.oss2.config.reporting.StringParm> vStringParmList) {
        // copy vector
        this._stringParmList.clear();
    ...
    public void setStringParmCollection(
            final java.util.List<com.netxforge.oss2.config.reporting.StringParm> stringParmList) {
     ...
     * com.netxforge.oss2.config.reporting.Parameters
     */
    public static com.netxforge.oss2.config.reporting.Parameters unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.reporting.Parameters) Unmarshaller.unmarshal(com.netxforge.oss2.config.reporting.Parameters.class, reader);
    }
