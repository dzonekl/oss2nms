...
import com.netxforge.oss2.config.reporting.StringParm;

/**
 * Class StringParmDescriptor.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("all") public class StringParmDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public StringParmDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                StringParm target = (StringParm) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _inputType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_inputType", "input-type", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    StringParm target = (StringParm) object;
                    target.setInputType( (java.lang.String) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _inputType
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            org.exolab.castor.xml.validators.StringValidator typeValidator;
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
            fieldValidator.setValidator(typeValidator);
            typeValidator.addPattern("(reportCategorySelector|freeText)");
            typeValidator.setWhiteSpace("preserve");
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.reporting.StringParm.class;
    }
