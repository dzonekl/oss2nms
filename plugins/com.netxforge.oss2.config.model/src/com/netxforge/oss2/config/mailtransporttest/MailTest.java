...
@SuppressWarnings("all") public class MailTest implements java.io.Serializable {
     ...
     *  
     */
    private com.netxforge.oss2.config.mailtransporttest.SendmailTest _sendmailTest;

    /**
     * Field _readmailTest.
     */
    private com.netxforge.oss2.config.mailtransporttest.ReadmailTest _readmailTest;
     ...
     */
    public com.netxforge.oss2.config.mailtransporttest.ReadmailTest getReadmailTest(
    ) {
     ...
     */
    public com.netxforge.oss2.config.mailtransporttest.SendmailTest getSendmailTest(
    ) {
    ...
    public void setReadmailTest(
            final com.netxforge.oss2.config.mailtransporttest.ReadmailTest readmailTest) {
    ...
    public void setSendmailTest(
            final com.netxforge.oss2.config.mailtransporttest.SendmailTest sendmailTest) {
     ...
     * com.netxforge.oss2.config.mailtransporttest.MailTest
     */
    public static com.netxforge.oss2.config.mailtransporttest.MailTest unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.mailtransporttest.MailTest) Unmarshaller.unmarshal(com.netxforge.oss2.config.mailtransporttest.MailTest.class, reader);
    }
