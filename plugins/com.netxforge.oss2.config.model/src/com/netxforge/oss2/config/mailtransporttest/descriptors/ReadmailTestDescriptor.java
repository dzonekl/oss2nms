...
import com.netxforge.oss2.config.mailtransporttest.ReadmailTest;
...
@SuppressWarnings("all") public class ReadmailTestDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReadmailTestDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _readmailHost
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.mailtransporttest.ReadmailHost.class, "_readmailHost", "readmail-host", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ReadmailTest target = (ReadmailTest) object;
                    target.setReadmailHost( (com.netxforge.oss2.config.mailtransporttest.ReadmailHost) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.mailtransporttest.ReadmailHost();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.mailtransporttest.ReadmailHost");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/mail-transport-test");
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.mailtransporttest.ReadmailTest.class;
    }
