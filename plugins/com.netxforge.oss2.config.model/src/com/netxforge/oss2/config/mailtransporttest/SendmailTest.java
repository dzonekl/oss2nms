...
package com.netxforge.oss2.config.mailtransporttest;
...
@SuppressWarnings("all") public class SendmailTest implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.mailtransporttest.JavamailProperty> _javamailPropertyList;
     ...
     *  
     */
    private com.netxforge.oss2.config.mailtransporttest.SendmailHost _sendmailHost;
     ...
     *  
     */
    private com.netxforge.oss2.config.mailtransporttest.SendmailProtocol _sendmailProtocol;
     ...
     *  
     */
    private com.netxforge.oss2.config.mailtransporttest.SendmailMessage _sendmailMessage;
     ...
     *  
     */
    private com.netxforge.oss2.config.mailtransporttest.UserAuth _userAuth;
    ...
    public SendmailTest() {
        super();
        this._javamailPropertyList = new java.util.ArrayList<com.netxforge.oss2.config.mailtransporttest.JavamailProperty>();
    }
    ...
    public void addJavamailProperty(
            final com.netxforge.oss2.config.mailtransporttest.JavamailProperty vJavamailProperty)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.mailtransporttest.JavamailProperty> enumerateJavamailProperty(
    ) {
     ...
     * com.netxforge.oss2.config.mailtransporttest.JavamailProperty
     * at the given index
     */
    public com.netxforge.oss2.config.mailtransporttest.JavamailProperty getJavamailProperty(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.mailtransporttest.JavamailProperty) _javamailPropertyList.get(index);
    }
    ...
    public com.netxforge.oss2.config.mailtransporttest.JavamailProperty[] getJavamailProperty(
        ...
        com.netxforge.oss2.config.mailtransporttest.JavamailProperty[] array = new com.netxforge.oss2.config.mailtransporttest.JavamailProperty[0];
        return (com.netxforge.oss2.config.mailtransporttest.JavamailProperty[]) this._javamailPropertyList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.mailtransporttest.JavamailProperty> getJavamailPropertyCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.mailtransporttest.SendmailHost getSendmailHost(
    ) {
     ...
     */
    public com.netxforge.oss2.config.mailtransporttest.SendmailMessage getSendmailMessage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.mailtransporttest.SendmailProtocol getSendmailProtocol(
    ) {
     ...
     */
    public com.netxforge.oss2.config.mailtransporttest.UserAuth getUserAuth(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.mailtransporttest.JavamailProperty> iterateJavamailProperty(
    ) {
     ...
     */
    public com.netxforge.oss2.config.mailtransporttest.JavamailProperty removeJavamailPropertyAt(
            final int index) {
        java.lang.Object obj = this._javamailPropertyList.remove(index);
        return (com.netxforge.oss2.config.mailtransporttest.JavamailProperty) obj;
    }
     ...
     */
    public void setJavamailProperty(
            final com.netxforge.oss2.config.mailtransporttest.JavamailProperty[] vJavamailPropertyArray) {
        //-- copy array
     ...
     */
    public void setJavamailProperty(
            final java.util.List<com.netxforge.oss2.config.mailtransporttest.JavamailProperty> vJavamailPropertyList) {
        // copy vector
        this._javamailPropertyList.clear();
    ...
    public void setJavamailPropertyCollection(
            final java.util.List<com.netxforge.oss2.config.mailtransporttest.JavamailProperty> javamailPropertyList) {
    ...
    public void setSendmailHost(
            final com.netxforge.oss2.config.mailtransporttest.SendmailHost sendmailHost) {
    ...
    public void setSendmailMessage(
            final com.netxforge.oss2.config.mailtransporttest.SendmailMessage sendmailMessage) {
    ...
    public void setSendmailProtocol(
            final com.netxforge.oss2.config.mailtransporttest.SendmailProtocol sendmailProtocol) {
    ...
    public void setUserAuth(
            final com.netxforge.oss2.config.mailtransporttest.UserAuth userAuth) {
     ...
     * com.netxforge.oss2.config.mailtransporttest.SendmailTest
     */
    public static com.netxforge.oss2.config.mailtransporttest.SendmailTest unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.mailtransporttest.SendmailTest) Unmarshaller.unmarshal(com.netxforge.oss2.config.mailtransporttest.SendmailTest.class, reader);
    }
