...
@SuppressWarnings("all") public class MailTransportTest implements java.io.Serializable {
     ...
     *  
     */
    private com.netxforge.oss2.config.mailtransporttest.MailTest _mailTest;
     ...
     */
    public com.netxforge.oss2.config.mailtransporttest.MailTest getMailTest(
    ) {
    ...
    public void setMailTest(
            final com.netxforge.oss2.config.mailtransporttest.MailTest mailTest) {
     ...
     * com.netxforge.oss2.config.mailtransporttest.MailTransportTest
     */
    public static com.netxforge.oss2.config.mailtransporttest.MailTransportTest unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.mailtransporttest.MailTransportTest) Unmarshaller.unmarshal(com.netxforge.oss2.config.mailtransporttest.MailTransportTest.class, reader);
    }
