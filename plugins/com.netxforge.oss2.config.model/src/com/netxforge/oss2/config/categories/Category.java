...
@SuppressWarnings("all") public class Category implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.categories.Category
     */
    public static com.netxforge.oss2.config.categories.Category unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.categories.Category) Unmarshaller.unmarshal(com.netxforge.oss2.config.categories.Category.class, reader);
    }
