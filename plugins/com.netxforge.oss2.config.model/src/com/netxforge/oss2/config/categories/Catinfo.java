...
@SuppressWarnings("all") public class Catinfo implements java.io.Serializable {
     ...
     */
    private com.netxforge.oss2.config.categories.Header _header;

    /**
     * The category groups.
     */
    private java.util.List<com.netxforge.oss2.config.categories.Categorygroup> _categorygroupList;
    ...
    public Catinfo() {
        super();
        this._categorygroupList = new java.util.ArrayList<com.netxforge.oss2.config.categories.Categorygroup>();
    }
    ...
    public void addCategorygroup(
            final com.netxforge.oss2.config.categories.Categorygroup vCategorygroup)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.categories.Categorygroup> enumerateCategorygroup(
    ) {
     ...
     * com.netxforge.oss2.config.categories.Categorygroup at the
     * given index
     */
    public com.netxforge.oss2.config.categories.Categorygroup getCategorygroup(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.categories.Categorygroup) _categorygroupList.get(index);
    }
    ...
    public com.netxforge.oss2.config.categories.Categorygroup[] getCategorygroup(
        ...
        com.netxforge.oss2.config.categories.Categorygroup[] array = new com.netxforge.oss2.config.categories.Categorygroup[0];
        return (com.netxforge.oss2.config.categories.Categorygroup[]) this._categorygroupList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.categories.Categorygroup> getCategorygroupCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.categories.Header getHeader(
    ) {
        return this._header;
    }
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.categories.Categorygroup> iterateCategorygroup(
    ) {
     ...
     */
    public com.netxforge.oss2.config.categories.Categorygroup removeCategorygroupAt(
            final int index) {
        java.lang.Object obj = this._categorygroupList.remove(index);
        return (com.netxforge.oss2.config.categories.Categorygroup) obj;
    }
     ...
     */
    public void setCategorygroup(
            final com.netxforge.oss2.config.categories.Categorygroup[] vCategorygroupArray) {
        //-- copy array
     ...
     */
    public void setCategorygroup(
            final java.util.List<com.netxforge.oss2.config.categories.Categorygroup> vCategorygroupList) {
        // copy vector
        this._categorygroupList.clear();
    ...
    public void setCategorygroupCollection(
            final java.util.List<com.netxforge.oss2.config.categories.Categorygroup> categorygroupList) {
    ...
    public void setHeader(
            final com.netxforge.oss2.config.categories.Header header) {
        this._header = header;
    }
     ...
     * com.netxforge.oss2.config.categories.Catinfo
     */
    public static com.netxforge.oss2.config.categories.Catinfo unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.categories.Catinfo) Unmarshaller.unmarshal(com.netxforge.oss2.config.categories.Catinfo.class, reader);
    }
