...
@SuppressWarnings("all") public class Categorygroup implements java.io.Serializable {
     ...
     *  the group.
     */
    private com.netxforge.oss2.config.categories.Common _common;

    /**
     * The categories belonging to this category
     *  group.
     */
    private com.netxforge.oss2.config.categories.Categories _categories;
     ...
     */
    public com.netxforge.oss2.config.categories.Categories getCategories(
    ) {
     ...
     */
    public com.netxforge.oss2.config.categories.Common getCommon(
    ) {
        return this._common;
    }
    ...
    public void setCategories(
            final com.netxforge.oss2.config.categories.Categories categories) {
    ...
    public void setCommon(
            final com.netxforge.oss2.config.categories.Common common) {
        this._common = common;
    }
     ...
     * com.netxforge.oss2.config.categories.Categorygroup
     */
    public static com.netxforge.oss2.config.categories.Categorygroup unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.categories.Categorygroup) Unmarshaller.unmarshal(com.netxforge.oss2.config.categories.Categorygroup.class, reader);
    }
