...
import com.netxforge.oss2.config.ackd.ReaderSchedule;

/**
 * Class ReaderScheduleDescriptor.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("all") public class ReaderScheduleDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReaderScheduleDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ReaderSchedule target = (ReaderSchedule) object;
        ...
        { //-- local scope
            ...
            fieldValidator.setValidator(typeValidator);
            typeValidator.addPattern("d|h|m|s|ms");
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.ackd.ReaderSchedule.class;
    }
