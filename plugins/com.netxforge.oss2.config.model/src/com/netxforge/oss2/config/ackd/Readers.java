...
@SuppressWarnings("all") public class Readers implements java.io.Serializable {
     ...
     * Field _readerList.
     */
    private java.util.List<com.netxforge.oss2.config.ackd.Reader> _readerList;
    ...
    public Readers() {
        super();
        this._readerList = new java.util.ArrayList<com.netxforge.oss2.config.ackd.Reader>();
    }
    ...
    public void addReader(
            final com.netxforge.oss2.config.ackd.Reader vReader)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.ackd.Reader> enumerateReader(
    ) {
     ...
     * com.netxforge.oss2.config.ackd.Reader at the given index
     */
    public com.netxforge.oss2.config.ackd.Reader getReader(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.ackd.Reader) _readerList.get(index);
    }
    ...
    public com.netxforge.oss2.config.ackd.Reader[] getReader(
        ...
        com.netxforge.oss2.config.ackd.Reader[] array = new com.netxforge.oss2.config.ackd.Reader[0];
        return (com.netxforge.oss2.config.ackd.Reader[]) this._readerList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.ackd.Reader> getReaderCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.ackd.Reader> iterateReader(
    ) {
     ...
     */
    public com.netxforge.oss2.config.ackd.Reader removeReaderAt(
            final int index) {
        java.lang.Object obj = this._readerList.remove(index);
        return (com.netxforge.oss2.config.ackd.Reader) obj;
    }
     ...
     */
    public void setReader(
            final com.netxforge.oss2.config.ackd.Reader[] vReaderArray) {
        //-- copy array
        _readerList.clear();
     ...
     */
    public void setReader(
            final java.util.List<com.netxforge.oss2.config.ackd.Reader> vReaderList) {
        // copy vector
        this._readerList.clear();
    ...
    public void setReaderCollection(
            final java.util.List<com.netxforge.oss2.config.ackd.Reader> readerList) {
     ...
     */
    public static com.netxforge.oss2.config.ackd.Readers unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.ackd.Readers) Unmarshaller.unmarshal(com.netxforge.oss2.config.ackd.Readers.class, reader);
    }
