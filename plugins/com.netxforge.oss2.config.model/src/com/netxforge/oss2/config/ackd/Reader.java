...
package com.netxforge.oss2.config.ackd;
...
@SuppressWarnings("all") public class Reader implements java.io.Serializable {
     ...
     *  
     */
    private com.netxforge.oss2.config.ackd.ReaderSchedule _readerSchedule;

    /**
     * Parameters to be used for collecting this service.
     *  Parameters are specfic to the service monitor.
     */
    private java.util.List<com.netxforge.oss2.config.ackd.Parameter> _parameterList;
    ...
    public Reader() {
        super();
        this._parameterList = new java.util.ArrayList<com.netxforge.oss2.config.ackd.Parameter>();
    }
    ...
    public void addParameter(
            final com.netxforge.oss2.config.ackd.Parameter vParameter)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.ackd.Parameter> enumerateParameter(
    ) {
     ...
     * com.netxforge.oss2.config.ackd.Parameter at the given index
     */
    public com.netxforge.oss2.config.ackd.Parameter getParameter(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.ackd.Parameter) _parameterList.get(index);
    }
    ...
    public com.netxforge.oss2.config.ackd.Parameter[] getParameter(
        ...
        com.netxforge.oss2.config.ackd.Parameter[] array = new com.netxforge.oss2.config.ackd.Parameter[0];
        return (com.netxforge.oss2.config.ackd.Parameter[]) this._parameterList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.ackd.Parameter> getParameterCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.ackd.ReaderSchedule getReaderSchedule(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.ackd.Parameter> iterateParameter(
    ) {
     ...
     */
    public com.netxforge.oss2.config.ackd.Parameter removeParameterAt(
            final int index) {
        java.lang.Object obj = this._parameterList.remove(index);
        return (com.netxforge.oss2.config.ackd.Parameter) obj;
    }
     ...
     */
    public void setParameter(
            final com.netxforge.oss2.config.ackd.Parameter[] vParameterArray) {
        //-- copy array
     ...
     */
    public void setParameter(
            final java.util.List<com.netxforge.oss2.config.ackd.Parameter> vParameterList) {
        // copy vector
        this._parameterList.clear();
    ...
    public void setParameterCollection(
            final java.util.List<com.netxforge.oss2.config.ackd.Parameter> parameterList) {
    ...
    public void setReaderSchedule(
            final com.netxforge.oss2.config.ackd.ReaderSchedule readerSchedule) {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.netxforge.oss2.config.ackd.Reader
     */
    public static com.netxforge.oss2.config.ackd.Reader unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.ackd.Reader) Unmarshaller.unmarshal(com.netxforge.oss2.config.ackd.Reader.class, reader);
    }
