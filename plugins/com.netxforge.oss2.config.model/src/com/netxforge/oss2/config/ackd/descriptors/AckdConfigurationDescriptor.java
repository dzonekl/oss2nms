...
import com.netxforge.oss2.config.ackd.AckdConfiguration;
...
@SuppressWarnings("all") public class AckdConfigurationDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AckdConfigurationDescriptor() {
        ...
        //-- _readers
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.ackd.Readers.class, "_readers", "readers", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    AckdConfiguration target = (AckdConfiguration) object;
                    target.setReaders( (com.netxforge.oss2.config.ackd.Readers) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.ackd.Readers();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.ackd.Readers");
        desc.setHandler(handler);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.ackd.AckdConfiguration.class;
    }
