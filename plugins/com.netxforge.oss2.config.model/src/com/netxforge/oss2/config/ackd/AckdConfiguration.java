...
@SuppressWarnings("all") public class AckdConfiguration implements java.io.Serializable {
     ...
     *  
     */
    private com.netxforge.oss2.config.ackd.Readers _readers;
     ...
     */
    public com.netxforge.oss2.config.ackd.Readers getReaders(
    ) {
    ...
    public void setReaders(
            final com.netxforge.oss2.config.ackd.Readers readers) {
     ...
     * com.netxforge.oss2.config.ackd.AckdConfiguration
     */
    public static com.netxforge.oss2.config.ackd.AckdConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.ackd.AckdConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.ackd.AckdConfiguration.class, reader);
    }
