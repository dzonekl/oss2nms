...
package com.netxforge.oss2.config.monitoringLocations;
...
@SuppressWarnings("all") public class Locations implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.monitoringLocations.LocationDef> _locationDefList;
    ...
    public Locations() {
        super();
        this._locationDefList = new java.util.ArrayList<com.netxforge.oss2.config.monitoringLocations.LocationDef>();
    }
    ...
    public void addLocationDef(
            final com.netxforge.oss2.config.monitoringLocations.LocationDef vLocationDef)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.monitoringLocations.LocationDef> enumerateLocationDef(
    ) {
     ...
     * com.netxforge.oss2.config.monitoringLocations.LocationDef at
     * the given index
     */
    public com.netxforge.oss2.config.monitoringLocations.LocationDef getLocationDef(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.monitoringLocations.LocationDef) _locationDefList.get(index);
    }
    ...
    public com.netxforge.oss2.config.monitoringLocations.LocationDef[] getLocationDef(
        ...
        com.netxforge.oss2.config.monitoringLocations.LocationDef[] array = new com.netxforge.oss2.config.monitoringLocations.LocationDef[0];
        return (com.netxforge.oss2.config.monitoringLocations.LocationDef[]) this._locationDefList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.monitoringLocations.LocationDef> getLocationDefCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.monitoringLocations.LocationDef> iterateLocationDef(
    ) {
     ...
     */
    public com.netxforge.oss2.config.monitoringLocations.LocationDef removeLocationDefAt(
            final int index) {
        java.lang.Object obj = this._locationDefList.remove(index);
        return (com.netxforge.oss2.config.monitoringLocations.LocationDef) obj;
    }
     ...
     */
    public void setLocationDef(
            final com.netxforge.oss2.config.monitoringLocations.LocationDef[] vLocationDefArray) {
        //-- copy array
     ...
     */
    public void setLocationDef(
            final java.util.List<com.netxforge.oss2.config.monitoringLocations.LocationDef> vLocationDefList) {
        // copy vector
        this._locationDefList.clear();
    ...
    public void setLocationDefCollection(
            final java.util.List<com.netxforge.oss2.config.monitoringLocations.LocationDef> locationDefList) {
     ...
     */
    public static com.netxforge.oss2.config.monitoringLocations.Locations unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.monitoringLocations.Locations) Unmarshaller.unmarshal(com.netxforge.oss2.config.monitoringLocations.Locations.class, reader);
    }
