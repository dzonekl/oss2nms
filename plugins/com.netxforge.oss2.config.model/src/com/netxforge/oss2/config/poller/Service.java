...
@SuppressWarnings("all") public class Service implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.poller.Parameter> _parameterList;
    ...
    public Service() {
        ...
        setStatus("on");
        this._parameterList = new java.util.ArrayList<com.netxforge.oss2.config.poller.Parameter>();
    }
    ...
    public void addParameter(
            final com.netxforge.oss2.config.poller.Parameter vParameter)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.poller.Parameter> enumerateParameter(
    ) {
     ...
     * com.netxforge.oss2.config.poller.Parameter at the given index
     */
    public com.netxforge.oss2.config.poller.Parameter getParameter(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.poller.Parameter) _parameterList.get(index);
    }
    ...
    public com.netxforge.oss2.config.poller.Parameter[] getParameter(
        ...
        com.netxforge.oss2.config.poller.Parameter[] array = new com.netxforge.oss2.config.poller.Parameter[0];
        return (com.netxforge.oss2.config.poller.Parameter[]) this._parameterList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.poller.Parameter> getParameterCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.poller.Parameter> iterateParameter(
    ) {
     ...
     */
    public com.netxforge.oss2.config.poller.Parameter removeParameterAt(
            final int index) {
        java.lang.Object obj = this._parameterList.remove(index);
        return (com.netxforge.oss2.config.poller.Parameter) obj;
    }
     ...
     */
    public void setParameter(
            final com.netxforge.oss2.config.poller.Parameter[] vParameterArray) {
        //-- copy array
     ...
     */
    public void setParameter(
            final java.util.List<com.netxforge.oss2.config.poller.Parameter> vParameterList) {
        // copy vector
        this._parameterList.clear();
    ...
    public void setParameterCollection(
            final java.util.List<com.netxforge.oss2.config.poller.Parameter> parameterList) {
     ...
     * com.netxforge.oss2.config.poller.Service
     */
    public static com.netxforge.oss2.config.poller.Service unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.poller.Service) Unmarshaller.unmarshal(com.netxforge.oss2.config.poller.Service.class, reader);
    }
