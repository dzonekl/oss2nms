...
@SuppressWarnings("all") public class PollerConfiguration implements java.io.Serializable {
     ...
     *  ID.
     */
    private java.lang.String _nextOutageId = "SELECT nextval('outageNxtId')";
     ...
     *  feature is enabled
     */
    private java.lang.String _pathOutageEnabled = "false";

    /**
     * Configuration of node-outage
     *  functionality
     */
    private com.netxforge.oss2.config.poller.NodeOutage _nodeOutage;

    /**
     * Package encapsulating addresses, services to be
     *  polled for these addresses, etc..
     */
    private java.util.List<com.netxforge.oss2.config.poller.Package> _packageList;

    /**
     * Service monitors
     */
    private java.util.List<com.netxforge.oss2.config.poller.Monitor> _monitorList;
    ...
    public PollerConfiguration() {
        ...
        this._packageList = new java.util.ArrayList<com.netxforge.oss2.config.poller.Package>();
        this._monitorList = new java.util.ArrayList<com.netxforge.oss2.config.poller.Monitor>();
    }
    ...
    public void addMonitor(
            final com.netxforge.oss2.config.poller.Monitor vMonitor)
    ...
    public void addPackage(
            final com.netxforge.oss2.config.poller.Package vPackage)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.poller.Monitor> enumerateMonitor(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.poller.Package> enumeratePackage(
    ) {
     ...
     * com.netxforge.oss2.config.poller.Monitor at the given index
     */
    public com.netxforge.oss2.config.poller.Monitor getMonitor(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.poller.Monitor) _monitorList.get(index);
    }
    ...
    public com.netxforge.oss2.config.poller.Monitor[] getMonitor(
        ...
        com.netxforge.oss2.config.poller.Monitor[] array = new com.netxforge.oss2.config.poller.Monitor[0];
        return (com.netxforge.oss2.config.poller.Monitor[]) this._monitorList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.poller.Monitor> getMonitorCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.poller.NodeOutage getNodeOutage(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.poller.Package at the given index
     */
    public com.netxforge.oss2.config.poller.Package getPackage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.poller.Package) _packageList.get(index);
    }
    ...
    public com.netxforge.oss2.config.poller.Package[] getPackage(
        ...
        com.netxforge.oss2.config.poller.Package[] array = new com.netxforge.oss2.config.poller.Package[0];
        return (com.netxforge.oss2.config.poller.Package[]) this._packageList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.poller.Package> getPackageCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.poller.Monitor> iterateMonitor(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.poller.Package> iteratePackage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.poller.Monitor removeMonitorAt(
            final int index) {
        java.lang.Object obj = this._monitorList.remove(index);
        return (com.netxforge.oss2.config.poller.Monitor) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.poller.Package removePackageAt(
            final int index) {
        java.lang.Object obj = this._packageList.remove(index);
        return (com.netxforge.oss2.config.poller.Package) obj;
    }
     ...
     */
    public void setMonitor(
            final com.netxforge.oss2.config.poller.Monitor[] vMonitorArray) {
        //-- copy array
        _monitorList.clear();
     ...
     */
    public void setMonitor(
            final java.util.List<com.netxforge.oss2.config.poller.Monitor> vMonitorList) {
        // copy vector
        this._monitorList.clear();
    ...
    public void setMonitorCollection(
            final java.util.List<com.netxforge.oss2.config.poller.Monitor> monitorList) {
    ...
    public void setNodeOutage(
            final com.netxforge.oss2.config.poller.NodeOutage nodeOutage) {
     ...
     */
    public void setPackage(
            final com.netxforge.oss2.config.poller.Package[] vPackageArray) {
        //-- copy array
        _packageList.clear();
     ...
     */
    public void setPackage(
            final java.util.List<com.netxforge.oss2.config.poller.Package> vPackageList) {
        // copy vector
        this._packageList.clear();
    ...
    public void setPackageCollection(
            final java.util.List<com.netxforge.oss2.config.poller.Package> _packageList) {
     ...
     * com.netxforge.oss2.config.poller.PollerConfiguration
     */
    public static com.netxforge.oss2.config.poller.PollerConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.poller.PollerConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.poller.PollerConfiguration.class, reader);
    }
