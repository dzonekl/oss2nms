...
package com.netxforge.oss2.config.poller;
...
@SuppressWarnings("all") public class Package implements java.io.Serializable {
     ...
     *  this filter.
     */
    private com.netxforge.oss2.config.poller.Filter _filter;
     ...
     */
    private java.util.List<com.netxforge.oss2.config.poller.IncludeRange> _includeRangeList;

    /**
     * Range of adresses to be excluded from this
     *  package.
     */
    private java.util.List<com.netxforge.oss2.config.poller.ExcludeRange> _excludeRangeList;
     ...
     *  data.
     */
    private com.netxforge.oss2.config.poller.Rrd _rrd;

    /**
     * Services to be polled for addresses belonging to
     *  this package.
     */
    private java.util.List<com.netxforge.oss2.config.poller.Service> _serviceList;
     ...
     *  periods.
     */
    private java.util.List<com.netxforge.oss2.config.poller.Downtime> _downtimeList;
    ...
    public Package() {
        ...
        this._includeRangeList = new java.util.ArrayList<com.netxforge.oss2.config.poller.IncludeRange>();
        this._excludeRangeList = new java.util.ArrayList<com.netxforge.oss2.config.poller.ExcludeRange>();
        this._includeUrlList = new java.util.ArrayList<java.lang.String>();
        this._serviceList = new java.util.ArrayList<com.netxforge.oss2.config.poller.Service>();
        this._outageCalendarList = new java.util.ArrayList<java.lang.String>();
        this._downtimeList = new java.util.ArrayList<com.netxforge.oss2.config.poller.Downtime>();
    }
    ...
    public void addDowntime(
            final com.netxforge.oss2.config.poller.Downtime vDowntime)
    ...
    public void addExcludeRange(
            final com.netxforge.oss2.config.poller.ExcludeRange vExcludeRange)
    throws java.lang.IndexOutOfBoundsException {
    ...
    public void addIncludeRange(
            final com.netxforge.oss2.config.poller.IncludeRange vIncludeRange)
    throws java.lang.IndexOutOfBoundsException {
    ...
    public void addService(
            final com.netxforge.oss2.config.poller.Service vService)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.poller.Downtime> enumerateDowntime(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.poller.ExcludeRange> enumerateExcludeRange(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.poller.IncludeRange> enumerateIncludeRange(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.poller.Service> enumerateService(
    ) {
    ...
    public boolean equals(
        ...
        if (obj instanceof Package) {
            ...
            if (this._remote != temp._remote)
                return false;
            if (this._has_remote != temp._has_remote)
                return false;
     ...
     * com.netxforge.oss2.config.poller.Downtime at the given index
     */
    public com.netxforge.oss2.config.poller.Downtime getDowntime(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.poller.Downtime) _downtimeList.get(index);
    }
    ...
    public com.netxforge.oss2.config.poller.Downtime[] getDowntime(
        ...
        com.netxforge.oss2.config.poller.Downtime[] array = new com.netxforge.oss2.config.poller.Downtime[0];
        return (com.netxforge.oss2.config.poller.Downtime[]) this._downtimeList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.poller.Downtime> getDowntimeCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.poller.ExcludeRange at the given
     * index
     */
    public com.netxforge.oss2.config.poller.ExcludeRange getExcludeRange(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.poller.ExcludeRange) _excludeRangeList.get(index);
    }
    ...
    public com.netxforge.oss2.config.poller.ExcludeRange[] getExcludeRange(
        ...
        com.netxforge.oss2.config.poller.ExcludeRange[] array = new com.netxforge.oss2.config.poller.ExcludeRange[0];
        return (com.netxforge.oss2.config.poller.ExcludeRange[]) this._excludeRangeList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.poller.ExcludeRange> getExcludeRangeCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.poller.Filter getFilter(
    ) {
        return this._filter;
    }
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.poller.IncludeRange at the given
     * index
     */
    public com.netxforge.oss2.config.poller.IncludeRange getIncludeRange(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.poller.IncludeRange) _includeRangeList.get(index);
    }
    ...
    public com.netxforge.oss2.config.poller.IncludeRange[] getIncludeRange(
        ...
        com.netxforge.oss2.config.poller.IncludeRange[] array = new com.netxforge.oss2.config.poller.IncludeRange[0];
        return (com.netxforge.oss2.config.poller.IncludeRange[]) this._includeRangeList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.poller.IncludeRange> getIncludeRangeCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.poller.Rrd getRrd(
    ) {
        return this._rrd;
    }
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.poller.Service at the given index
     */
    public com.netxforge.oss2.config.poller.Service getService(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.poller.Service) _serviceList.get(index);
    }
    ...
    public com.netxforge.oss2.config.poller.Service[] getService(
        ...
        com.netxforge.oss2.config.poller.Service[] array = new com.netxforge.oss2.config.poller.Service[0];
        return (com.netxforge.oss2.config.poller.Service[]) this._serviceList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.poller.Service> getServiceCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.poller.Downtime> iterateDowntime(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.poller.ExcludeRange> iterateExcludeRange(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.poller.IncludeRange> iterateIncludeRange(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.poller.Service> iterateService(
    ) {
     ...
     */
    public com.netxforge.oss2.config.poller.Downtime removeDowntimeAt(
            final int index) {
        java.lang.Object obj = this._downtimeList.remove(index);
        return (com.netxforge.oss2.config.poller.Downtime) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.poller.ExcludeRange removeExcludeRangeAt(
            final int index) {
        java.lang.Object obj = this._excludeRangeList.remove(index);
        return (com.netxforge.oss2.config.poller.ExcludeRange) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.poller.IncludeRange removeIncludeRangeAt(
            final int index) {
        java.lang.Object obj = this._includeRangeList.remove(index);
        return (com.netxforge.oss2.config.poller.IncludeRange) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.poller.Service removeServiceAt(
            final int index) {
        java.lang.Object obj = this._serviceList.remove(index);
        return (com.netxforge.oss2.config.poller.Service) obj;
    }
     ...
     */
    public void setDowntime(
            final com.netxforge.oss2.config.poller.Downtime[] vDowntimeArray) {
        //-- copy array
        _downtimeList.clear();
     ...
     */
    public void setDowntime(
            final java.util.List<com.netxforge.oss2.config.poller.Downtime> vDowntimeList) {
        // copy vector
        this._downtimeList.clear();
    ...
    public void setDowntimeCollection(
            final java.util.List<com.netxforge.oss2.config.poller.Downtime> downtimeList) {
     ...
     */
    public void setExcludeRange(
            final com.netxforge.oss2.config.poller.ExcludeRange[] vExcludeRangeArray) {
        //-- copy array
     ...
     */
    public void setExcludeRange(
            final java.util.List<com.netxforge.oss2.config.poller.ExcludeRange> vExcludeRangeList) {
        // copy vector
        this._excludeRangeList.clear();
    ...
    public void setExcludeRangeCollection(
            final java.util.List<com.netxforge.oss2.config.poller.ExcludeRange> excludeRangeList) {
    ...
    public void setFilter(
            final com.netxforge.oss2.config.poller.Filter filter) {
        this._filter = filter;
    }
     ...
     */
    public void setIncludeRange(
            final com.netxforge.oss2.config.poller.IncludeRange[] vIncludeRangeArray) {
        //-- copy array
     ...
     */
    public void setIncludeRange(
            final java.util.List<com.netxforge.oss2.config.poller.IncludeRange> vIncludeRangeList) {
        // copy vector
        this._includeRangeList.clear();
    ...
    public void setIncludeRangeCollection(
            final java.util.List<com.netxforge.oss2.config.poller.IncludeRange> includeRangeList) {
     ...
     */
    public void setRrd(
            final com.netxforge.oss2.config.poller.Rrd rrd) {
        this._rrd = rrd;
    }
     ...
     */
    public void setService(
            final com.netxforge.oss2.config.poller.Service[] vServiceArray) {
        //-- copy array
        _serviceList.clear();
     ...
     */
    public void setService(
            final java.util.List<com.netxforge.oss2.config.poller.Service> vServiceList) {
        // copy vector
        this._serviceList.clear();
    ...
    public void setServiceCollection(
            final java.util.List<com.netxforge.oss2.config.poller.Service> serviceList) {
     ...
     * com.netxforge.oss2.config.poller.Package
     */
    public static com.netxforge.oss2.config.poller.Package unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.poller.Package) Unmarshaller.unmarshal(com.netxforge.oss2.config.poller.Package.class, reader);
    }
