...
@SuppressWarnings("all") public class Rrd implements java.io.Serializable {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.netxforge.oss2.config.poller.Rrd
     */
    public static com.netxforge.oss2.config.poller.Rrd unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.poller.Rrd) Unmarshaller.unmarshal(com.netxforge.oss2.config.poller.Rrd.class, reader);
    }
