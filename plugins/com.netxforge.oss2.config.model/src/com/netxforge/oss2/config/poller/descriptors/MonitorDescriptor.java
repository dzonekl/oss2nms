...
import com.netxforge.oss2.config.poller.Monitor;
...
@SuppressWarnings("all") public class MonitorDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MonitorDescriptor() {
        ...
        //-- _parameterList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.poller.Parameter.class, "_parameterList", "parameter", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Monitor target = (Monitor) object;
                    target.addParameter( (com.netxforge.oss2.config.poller.Parameter) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.poller.Parameter();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.poller.Parameter");
        desc.setHandler(handler);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.poller.Monitor.class;
    }
