...
import com.netxforge.oss2.config.poller.NodeOutage;
...
@SuppressWarnings("all") public class NodeOutageDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public NodeOutageDescriptor() {
        ...
        //-- _criticalService
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.poller.CriticalService.class, "_criticalService", "critical-service", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    NodeOutage target = (NodeOutage) object;
                    target.setCriticalService( (com.netxforge.oss2.config.poller.CriticalService) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.poller.CriticalService();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.poller.CriticalService");
        desc.setHandler(handler);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.poller.NodeOutage.class;
    }
