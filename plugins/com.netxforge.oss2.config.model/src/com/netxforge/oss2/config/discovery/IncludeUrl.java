...
@SuppressWarnings("all") public class IncludeUrl implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.discovery.IncludeUrl
     */
    public static com.netxforge.oss2.config.discovery.IncludeUrl unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.discovery.IncludeUrl) Unmarshaller.unmarshal(com.netxforge.oss2.config.discovery.IncludeUrl.class, reader);
    }
