...
@SuppressWarnings("all") public class Specific implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.discovery.Specific
     */
    public static com.netxforge.oss2.config.discovery.Specific unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.discovery.Specific) Unmarshaller.unmarshal(com.netxforge.oss2.config.discovery.Specific.class, reader);
    }
