...
@SuppressWarnings("all") public class ImageSize implements java.io.Serializable {
     ...
     * Field _hzSize.
     */
    private com.netxforge.oss2.config.charts.HzSize _hzSize;

    /**
     * Field _vtSize.
     */
    private com.netxforge.oss2.config.charts.VtSize _vtSize;
     ...
     */
    public com.netxforge.oss2.config.charts.HzSize getHzSize(
    ) {
        return this._hzSize;
    }
     ...
     */
    public com.netxforge.oss2.config.charts.VtSize getVtSize(
    ) {
        return this._vtSize;
    }
    ...
    public void setHzSize(
            final com.netxforge.oss2.config.charts.HzSize hzSize) {
        this._hzSize = hzSize;
    }
    ...
    public void setVtSize(
            final com.netxforge.oss2.config.charts.VtSize vtSize) {
        this._vtSize = vtSize;
    }
     ...
     * com.netxforge.oss2.config.charts.ImageSize
     */
    public static com.netxforge.oss2.config.charts.ImageSize unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.charts.ImageSize) Unmarshaller.unmarshal(com.netxforge.oss2.config.charts.ImageSize.class, reader);
    }
