...
@SuppressWarnings("all") public class SeriesDef implements java.io.Serializable {
     ...
     * Field _jdbcDataSet.
     */
    private com.netxforge.oss2.config.charts.JdbcDataSet _jdbcDataSet;

    /**
     * Field _rgb.
     */
    private com.netxforge.oss2.config.charts.Rgb _rgb;
     ...
     */
    public com.netxforge.oss2.config.charts.JdbcDataSet getJdbcDataSet(
    ) {
     ...
     */
    public com.netxforge.oss2.config.charts.Rgb getRgb(
    ) {
        return this._rgb;
    }
    ...
    public void setJdbcDataSet(
            final com.netxforge.oss2.config.charts.JdbcDataSet jdbcDataSet) {
     ...
     */
    public void setRgb(
            final com.netxforge.oss2.config.charts.Rgb rgb) {
        this._rgb = rgb;
    }
     ...
     * com.netxforge.oss2.config.charts.SeriesDef
     */
    public static com.netxforge.oss2.config.charts.SeriesDef unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.charts.SeriesDef) Unmarshaller.unmarshal(com.netxforge.oss2.config.charts.SeriesDef.class, reader);
    }
