...
@SuppressWarnings("all") public class ChartConfiguration implements java.io.Serializable {
     ...
     * Field _barChartList.
     */
    private java.util.List<com.netxforge.oss2.config.charts.BarChart> _barChartList;
    ...
    public ChartConfiguration() {
        super();
        this._barChartList = new java.util.ArrayList<com.netxforge.oss2.config.charts.BarChart>();
    }
    ...
    public void addBarChart(
            final com.netxforge.oss2.config.charts.BarChart vBarChart)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.charts.BarChart> enumerateBarChart(
    ) {
     ...
     * com.netxforge.oss2.config.charts.BarChart at the given index
     */
    public com.netxforge.oss2.config.charts.BarChart getBarChart(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.charts.BarChart) _barChartList.get(index);
    }
    ...
    public com.netxforge.oss2.config.charts.BarChart[] getBarChart(
        ...
        com.netxforge.oss2.config.charts.BarChart[] array = new com.netxforge.oss2.config.charts.BarChart[0];
        return (com.netxforge.oss2.config.charts.BarChart[]) this._barChartList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.charts.BarChart> getBarChartCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.charts.BarChart> iterateBarChart(
    ) {
     ...
     */
    public com.netxforge.oss2.config.charts.BarChart removeBarChartAt(
            final int index) {
        java.lang.Object obj = this._barChartList.remove(index);
        return (com.netxforge.oss2.config.charts.BarChart) obj;
    }
     ...
     */
    public void setBarChart(
            final com.netxforge.oss2.config.charts.BarChart[] vBarChartArray) {
        //-- copy array
        _barChartList.clear();
     ...
     */
    public void setBarChart(
            final java.util.List<com.netxforge.oss2.config.charts.BarChart> vBarChartList) {
        // copy vector
        this._barChartList.clear();
    ...
    public void setBarChartCollection(
            final java.util.List<com.netxforge.oss2.config.charts.BarChart> barChartList) {
     ...
     * com.netxforge.oss2.config.charts.ChartConfiguration
     */
    public static com.netxforge.oss2.config.charts.ChartConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.charts.ChartConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.charts.ChartConfiguration.class, reader);
    }
