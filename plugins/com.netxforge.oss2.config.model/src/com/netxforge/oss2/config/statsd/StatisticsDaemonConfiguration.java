...
package com.netxforge.oss2.config.statsd;
...
@SuppressWarnings("all") public class StatisticsDaemonConfiguration implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.statsd.Package> _packageList;

    /**
     * Reports
     */
    private java.util.List<com.netxforge.oss2.config.statsd.Report> _reportList;
    ...
    public StatisticsDaemonConfiguration() {
        super();
        this._packageList = new java.util.ArrayList<com.netxforge.oss2.config.statsd.Package>();
        this._reportList = new java.util.ArrayList<com.netxforge.oss2.config.statsd.Report>();
    }
    ...
    public void addPackage(
            final com.netxforge.oss2.config.statsd.Package vPackage)
    ...
    public void addReport(
            final com.netxforge.oss2.config.statsd.Report vReport)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.statsd.Package> enumeratePackage(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.statsd.Report> enumerateReport(
    ) {
     ...
     * com.netxforge.oss2.config.statsd.Package at the given index
     */
    public com.netxforge.oss2.config.statsd.Package getPackage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.statsd.Package) _packageList.get(index);
    }
    ...
    public com.netxforge.oss2.config.statsd.Package[] getPackage(
        ...
        com.netxforge.oss2.config.statsd.Package[] array = new com.netxforge.oss2.config.statsd.Package[0];
        return (com.netxforge.oss2.config.statsd.Package[]) this._packageList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.statsd.Package> getPackageCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.statsd.Report at the given index
     */
    public com.netxforge.oss2.config.statsd.Report getReport(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.statsd.Report) _reportList.get(index);
    }
    ...
    public com.netxforge.oss2.config.statsd.Report[] getReport(
        ...
        com.netxforge.oss2.config.statsd.Report[] array = new com.netxforge.oss2.config.statsd.Report[0];
        return (com.netxforge.oss2.config.statsd.Report[]) this._reportList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.statsd.Report> getReportCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.statsd.Package> iteratePackage(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.statsd.Report> iterateReport(
    ) {
     ...
     */
    public com.netxforge.oss2.config.statsd.Package removePackageAt(
            final int index) {
        java.lang.Object obj = this._packageList.remove(index);
        return (com.netxforge.oss2.config.statsd.Package) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.statsd.Report removeReportAt(
            final int index) {
        java.lang.Object obj = this._reportList.remove(index);
        return (com.netxforge.oss2.config.statsd.Report) obj;
    }
     ...
     */
    public void setPackage(
            final com.netxforge.oss2.config.statsd.Package[] vPackageArray) {
        //-- copy array
        _packageList.clear();
     ...
     */
    public void setPackage(
            final java.util.List<com.netxforge.oss2.config.statsd.Package> vPackageList) {
        // copy vector
        this._packageList.clear();
    ...
    public void setPackageCollection(
            final java.util.List<com.netxforge.oss2.config.statsd.Package> _packageList) {
     ...
     */
    public void setReport(
            final com.netxforge.oss2.config.statsd.Report[] vReportArray) {
        //-- copy array
        _reportList.clear();
     ...
     */
    public void setReport(
            final java.util.List<com.netxforge.oss2.config.statsd.Report> vReportList) {
        // copy vector
        this._reportList.clear();
    ...
    public void setReportCollection(
            final java.util.List<com.netxforge.oss2.config.statsd.Report> reportList) {
     ...
     * com.netxforge.oss2.config.statsd.StatisticsDaemonConfiguratio
     */
    public static com.netxforge.oss2.config.statsd.StatisticsDaemonConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.statsd.StatisticsDaemonConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.statsd.StatisticsDaemonConfiguration.class, reader);
    }
