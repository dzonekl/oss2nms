...
@SuppressWarnings("all") public class Package implements java.io.Serializable {
     ...
     *  this filter.
     */
    private com.netxforge.oss2.config.statsd.Filter _filter;

    /**
     * Reports to be run on the nodes in this
     *  package
     */
    private java.util.List<com.netxforge.oss2.config.statsd.PackageReport> _packageReportList;
    ...
    public Package() {
        super();
        this._packageReportList = new java.util.ArrayList<com.netxforge.oss2.config.statsd.PackageReport>();
    }
    ...
    public void addPackageReport(
            final com.netxforge.oss2.config.statsd.PackageReport vPackageReport)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.statsd.PackageReport> enumeratePackageReport(
    ) {
     ...
     */
    public com.netxforge.oss2.config.statsd.Filter getFilter(
    ) {
        return this._filter;
    }
     ...
     * com.netxforge.oss2.config.statsd.PackageReport at the given
     * index
     */
    public com.netxforge.oss2.config.statsd.PackageReport getPackageReport(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.statsd.PackageReport) _packageReportList.get(index);
    }
    ...
    public com.netxforge.oss2.config.statsd.PackageReport[] getPackageReport(
        ...
        com.netxforge.oss2.config.statsd.PackageReport[] array = new com.netxforge.oss2.config.statsd.PackageReport[0];
        return (com.netxforge.oss2.config.statsd.PackageReport[]) this._packageReportList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.statsd.PackageReport> getPackageReportCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.statsd.PackageReport> iteratePackageReport(
    ) {
     ...
     */
    public com.netxforge.oss2.config.statsd.PackageReport removePackageReportAt(
            final int index) {
        java.lang.Object obj = this._packageReportList.remove(index);
        return (com.netxforge.oss2.config.statsd.PackageReport) obj;
    }
    ...
    public void setFilter(
            final com.netxforge.oss2.config.statsd.Filter filter) {
        this._filter = filter;
    }
     ...
     */
    public void setPackageReport(
            final com.netxforge.oss2.config.statsd.PackageReport[] vPackageReportArray) {
        //-- copy array
     ...
     */
    public void setPackageReport(
            final java.util.List<com.netxforge.oss2.config.statsd.PackageReport> vPackageReportList) {
        // copy vector
        this._packageReportList.clear();
    ...
    public void setPackageReportCollection(
            final java.util.List<com.netxforge.oss2.config.statsd.PackageReport> packageReportList) {
     ...
     * com.netxforge.oss2.config.statsd.Package
     */
    public static com.netxforge.oss2.config.statsd.Package unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.statsd.Package) Unmarshaller.unmarshal(com.netxforge.oss2.config.statsd.Package.class, reader);
    }
