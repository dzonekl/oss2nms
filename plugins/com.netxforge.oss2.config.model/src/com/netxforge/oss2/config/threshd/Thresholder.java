...
@SuppressWarnings("all") public class Thresholder implements java.io.Serializable {
     ...
     *  thresholder.
     */
    private java.util.List<com.netxforge.oss2.config.threshd.Parameter> _parameterList;
    ...
    public Thresholder() {
        super();
        this._parameterList = new java.util.ArrayList<com.netxforge.oss2.config.threshd.Parameter>();
    }
    ...
    public void addParameter(
            final com.netxforge.oss2.config.threshd.Parameter vParameter)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.threshd.Parameter> enumerateParameter(
    ) {
     ...
     * com.netxforge.oss2.config.threshd.Parameter at the given inde
     */
    public com.netxforge.oss2.config.threshd.Parameter getParameter(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.threshd.Parameter) _parameterList.get(index);
    }
    ...
    public com.netxforge.oss2.config.threshd.Parameter[] getParameter(
        ...
        com.netxforge.oss2.config.threshd.Parameter[] array = new com.netxforge.oss2.config.threshd.Parameter[0];
        return (com.netxforge.oss2.config.threshd.Parameter[]) this._parameterList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.threshd.Parameter> getParameterCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.threshd.Parameter> iterateParameter(
    ) {
     ...
     */
    public com.netxforge.oss2.config.threshd.Parameter removeParameterAt(
            final int index) {
        java.lang.Object obj = this._parameterList.remove(index);
        return (com.netxforge.oss2.config.threshd.Parameter) obj;
    }
     ...
     */
    public void setParameter(
            final com.netxforge.oss2.config.threshd.Parameter[] vParameterArray) {
        //-- copy array
     ...
     */
    public void setParameter(
            final java.util.List<com.netxforge.oss2.config.threshd.Parameter> vParameterList) {
        // copy vector
        this._parameterList.clear();
    ...
    public void setParameterCollection(
            final java.util.List<com.netxforge.oss2.config.threshd.Parameter> parameterList) {
     ...
     * com.netxforge.oss2.config.threshd.Thresholder
     */
    public static com.netxforge.oss2.config.threshd.Thresholder unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.threshd.Thresholder) Unmarshaller.unmarshal(com.netxforge.oss2.config.threshd.Thresholder.class, reader);
    }
