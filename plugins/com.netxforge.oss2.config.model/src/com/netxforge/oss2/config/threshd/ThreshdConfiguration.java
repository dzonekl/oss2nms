...
@SuppressWarnings("all") public class ThreshdConfiguration implements java.io.Serializable {
     ...
     *  thresholding.
     */
    private java.util.List<com.netxforge.oss2.config.threshd.Package> _packageList;

    /**
     * Service thresholders
     */
    private java.util.List<com.netxforge.oss2.config.threshd.Thresholder> _thresholderList;
    ...
    public ThreshdConfiguration() {
        super();
        this._packageList = new java.util.ArrayList<com.netxforge.oss2.config.threshd.Package>();
        this._thresholderList = new java.util.ArrayList<com.netxforge.oss2.config.threshd.Thresholder>();
    }
    ...
    public void addPackage(
            final com.netxforge.oss2.config.threshd.Package vPackage)
    ...
    public void addThresholder(
            final com.netxforge.oss2.config.threshd.Thresholder vThresholder)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.threshd.Package> enumeratePackage(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.threshd.Thresholder> enumerateThresholder(
    ) {
     ...
     * com.netxforge.oss2.config.threshd.Package at the given index
     */
    public com.netxforge.oss2.config.threshd.Package getPackage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.threshd.Package) _packageList.get(index);
    }
    ...
    public com.netxforge.oss2.config.threshd.Package[] getPackage(
        ...
        com.netxforge.oss2.config.threshd.Package[] array = new com.netxforge.oss2.config.threshd.Package[0];
        return (com.netxforge.oss2.config.threshd.Package[]) this._packageList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.threshd.Package> getPackageCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.threshd.Thresholder at the given
     * index
     */
    public com.netxforge.oss2.config.threshd.Thresholder getThresholder(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.threshd.Thresholder) _thresholderList.get(index);
    }
    ...
    public com.netxforge.oss2.config.threshd.Thresholder[] getThresholder(
        ...
        com.netxforge.oss2.config.threshd.Thresholder[] array = new com.netxforge.oss2.config.threshd.Thresholder[0];
        return (com.netxforge.oss2.config.threshd.Thresholder[]) this._thresholderList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.threshd.Thresholder> getThresholderCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.threshd.Package> iteratePackage(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.threshd.Thresholder> iterateThresholder(
    ) {
     ...
     */
    public com.netxforge.oss2.config.threshd.Package removePackageAt(
            final int index) {
        java.lang.Object obj = this._packageList.remove(index);
        return (com.netxforge.oss2.config.threshd.Package) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.threshd.Thresholder removeThresholderAt(
            final int index) {
        java.lang.Object obj = this._thresholderList.remove(index);
        return (com.netxforge.oss2.config.threshd.Thresholder) obj;
    }
     ...
     */
    public void setPackage(
            final com.netxforge.oss2.config.threshd.Package[] vPackageArray) {
        //-- copy array
        _packageList.clear();
     ...
     */
    public void setPackage(
            final java.util.List<com.netxforge.oss2.config.threshd.Package> vPackageList) {
        // copy vector
        this._packageList.clear();
    ...
    public void setPackageCollection(
            final java.util.List<com.netxforge.oss2.config.threshd.Package> _packageList) {
     ...
     */
    public void setThresholder(
            final com.netxforge.oss2.config.threshd.Thresholder[] vThresholderArray) {
        //-- copy array
     ...
     */
    public void setThresholder(
            final java.util.List<com.netxforge.oss2.config.threshd.Thresholder> vThresholderList) {
        // copy vector
        this._thresholderList.clear();
    ...
    public void setThresholderCollection(
            final java.util.List<com.netxforge.oss2.config.threshd.Thresholder> thresholderList) {
     ...
     * com.netxforge.oss2.config.threshd.ThreshdConfiguration
     */
    public static com.netxforge.oss2.config.threshd.ThreshdConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.threshd.ThreshdConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.threshd.ThreshdConfiguration.class, reader);
    }
