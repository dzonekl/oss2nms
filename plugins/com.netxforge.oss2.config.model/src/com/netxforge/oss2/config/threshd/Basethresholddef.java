...
@SuppressWarnings("all") public abstract class Basethresholddef implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.threshd.ResourceFilter> _resourceFilterList;
    ...
    public Basethresholddef() {
        ...
        this._resourceFilterList = new java.util.ArrayList<com.netxforge.oss2.config.threshd.ResourceFilter>();
    }
    ...
    public void addResourceFilter(
            final com.netxforge.oss2.config.threshd.ResourceFilter vResourceFilter)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.threshd.ResourceFilter> enumerateResourceFilter(
    ) {
     ...
     * com.netxforge.oss2.config.threshd.ResourceFilter at the
     * given index
     */
    public com.netxforge.oss2.config.threshd.ResourceFilter getResourceFilter(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.threshd.ResourceFilter) _resourceFilterList.get(index);
    }
    ...
    public com.netxforge.oss2.config.threshd.ResourceFilter[] getResourceFilter(
        ...
        com.netxforge.oss2.config.threshd.ResourceFilter[] array = new com.netxforge.oss2.config.threshd.ResourceFilter[0];
        return (com.netxforge.oss2.config.threshd.ResourceFilter[]) this._resourceFilterList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.threshd.ResourceFilter> getResourceFilterCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.threshd.ResourceFilter> iterateResourceFilter(
    ) {
     ...
     */
    public com.netxforge.oss2.config.threshd.ResourceFilter removeResourceFilterAt(
            final int index) {
        java.lang.Object obj = this._resourceFilterList.remove(index);
        return (com.netxforge.oss2.config.threshd.ResourceFilter) obj;
    }
     ...
     */
    public void setResourceFilter(
            final com.netxforge.oss2.config.threshd.ResourceFilter[] vResourceFilterArray) {
        //-- copy array
     ...
     */
    public void setResourceFilter(
            final java.util.List<com.netxforge.oss2.config.threshd.ResourceFilter> vResourceFilterList) {
        // copy vector
        this._resourceFilterList.clear();
    ...
    public void setResourceFilterCollection(
            final java.util.List<com.netxforge.oss2.config.threshd.ResourceFilter> resourceFilterList) {
