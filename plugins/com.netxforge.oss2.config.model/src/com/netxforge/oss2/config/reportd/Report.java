...
package com.netxforge.oss2.config.reportd;
...
@SuppressWarnings("all") public class Report implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.reportd.Parameter> _parameterList;
    ...
    public Report() {
        ...
        this._parameterList = new java.util.ArrayList<com.netxforge.oss2.config.reportd.Parameter>();
    }
    ...
    public void addParameter(
            final com.netxforge.oss2.config.reportd.Parameter vParameter)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.reportd.Parameter> enumerateParameter(
    ) {
     ...
     * com.netxforge.oss2.config.reportd.Parameter at the given inde
     */
    public com.netxforge.oss2.config.reportd.Parameter getParameter(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.reportd.Parameter) _parameterList.get(index);
    }
    ...
    public com.netxforge.oss2.config.reportd.Parameter[] getParameter(
        ...
        com.netxforge.oss2.config.reportd.Parameter[] array = new com.netxforge.oss2.config.reportd.Parameter[0];
        return (com.netxforge.oss2.config.reportd.Parameter[]) this._parameterList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.reportd.Parameter> getParameterCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.reportd.Parameter> iterateParameter(
    ) {
     ...
     */
    public com.netxforge.oss2.config.reportd.Parameter removeParameterAt(
            final int index) {
        java.lang.Object obj = this._parameterList.remove(index);
        return (com.netxforge.oss2.config.reportd.Parameter) obj;
    }
     ...
     */
    public void setParameter(
            final com.netxforge.oss2.config.reportd.Parameter[] vParameterArray) {
        //-- copy array
     ...
     */
    public void setParameter(
            final java.util.List<com.netxforge.oss2.config.reportd.Parameter> vParameterList) {
        // copy vector
        this._parameterList.clear();
    ...
    public void setParameterCollection(
            final java.util.List<com.netxforge.oss2.config.reportd.Parameter> parameterList) {
     ...
     * com.netxforge.oss2.config.reportd.Report
     */
    public static com.netxforge.oss2.config.reportd.Report unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.reportd.Report) Unmarshaller.unmarshal(com.netxforge.oss2.config.reportd.Report.class, reader);
    }
