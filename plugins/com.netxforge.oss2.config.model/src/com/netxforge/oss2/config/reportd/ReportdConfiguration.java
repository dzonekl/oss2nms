...
@SuppressWarnings("all") public class ReportdConfiguration implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.reportd.Report> _reportList;
    ...
    public ReportdConfiguration() {
        super();
        this._reportList = new java.util.ArrayList<com.netxforge.oss2.config.reportd.Report>();
    }
    ...
    public void addReport(
            final com.netxforge.oss2.config.reportd.Report vReport)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.reportd.Report> enumerateReport(
    ) {
     ...
     * com.netxforge.oss2.config.reportd.Report at the given index
     */
    public com.netxforge.oss2.config.reportd.Report getReport(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.reportd.Report) _reportList.get(index);
    }
    ...
    public com.netxforge.oss2.config.reportd.Report[] getReport(
        ...
        com.netxforge.oss2.config.reportd.Report[] array = new com.netxforge.oss2.config.reportd.Report[0];
        return (com.netxforge.oss2.config.reportd.Report[]) this._reportList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.reportd.Report> getReportCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.reportd.Report> iterateReport(
    ) {
     ...
     */
    public com.netxforge.oss2.config.reportd.Report removeReportAt(
            final int index) {
        java.lang.Object obj = this._reportList.remove(index);
        return (com.netxforge.oss2.config.reportd.Report) obj;
    }
     ...
     */
    public void setReport(
            final com.netxforge.oss2.config.reportd.Report[] vReportArray) {
        //-- copy array
        _reportList.clear();
     ...
     */
    public void setReport(
            final java.util.List<com.netxforge.oss2.config.reportd.Report> vReportList) {
        // copy vector
        this._reportList.clear();
    ...
    public void setReportCollection(
            final java.util.List<com.netxforge.oss2.config.reportd.Report> reportList) {
     ...
     * com.netxforge.oss2.config.reportd.ReportdConfiguration
     */
    public static com.netxforge.oss2.config.reportd.ReportdConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.reportd.ReportdConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.reportd.ReportdConfiguration.class, reader);
    }
