...
package com.netxforge.oss2.config.notifications;
...
@SuppressWarnings("all") public class Notifications implements java.io.Serializable {
     ...
     *  file.
     */
    private com.netxforge.oss2.config.notifications.Header _header;

    /**
     * Field _notificationList.
     */
    private java.util.List<com.netxforge.oss2.config.notifications.Notification> _notificationList;
    ...
    public Notifications() {
        super();
        this._notificationList = new java.util.ArrayList<com.netxforge.oss2.config.notifications.Notification>();
    }
    ...
    public void addNotification(
            final com.netxforge.oss2.config.notifications.Notification vNotification)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.notifications.Notification> enumerateNotification(
    ) {
     ...
     */
    public com.netxforge.oss2.config.notifications.Header getHeader(
    ) {
        return this._header;
    }
     ...
     * com.netxforge.oss2.config.notifications.Notification at the
     * given index
     */
    public com.netxforge.oss2.config.notifications.Notification getNotification(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.notifications.Notification) _notificationList.get(index);
    }
    ...
    public com.netxforge.oss2.config.notifications.Notification[] getNotification(
        ...
        com.netxforge.oss2.config.notifications.Notification[] array = new com.netxforge.oss2.config.notifications.Notification[0];
        return (com.netxforge.oss2.config.notifications.Notification[]) this._notificationList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.notifications.Notification> getNotificationCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.notifications.Notification> iterateNotification(
    ) {
     ...
     */
    public com.netxforge.oss2.config.notifications.Notification removeNotificationAt(
            final int index) {
        java.lang.Object obj = this._notificationList.remove(index);
        return (com.netxforge.oss2.config.notifications.Notification) obj;
    }
    ...
    public void setHeader(
            final com.netxforge.oss2.config.notifications.Header header) {
        this._header = header;
    }
     ...
     */
    public void setNotification(
            final com.netxforge.oss2.config.notifications.Notification[] vNotificationArray) {
        //-- copy array
     ...
     */
    public void setNotification(
            final java.util.List<com.netxforge.oss2.config.notifications.Notification> vNotificationList) {
        // copy vector
        this._notificationList.clear();
    ...
    public void setNotificationCollection(
            final java.util.List<com.netxforge.oss2.config.notifications.Notification> notificationList) {
     ...
     * com.netxforge.oss2.config.notifications.Notifications
     */
    public static com.netxforge.oss2.config.notifications.Notifications unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.notifications.Notifications) Unmarshaller.unmarshal(com.netxforge.oss2.config.notifications.Notifications.class, reader);
    }
