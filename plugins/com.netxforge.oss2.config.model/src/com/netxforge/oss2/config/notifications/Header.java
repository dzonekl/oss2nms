...
@SuppressWarnings("all") public class Header implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.notifications.Header
     */
    public static com.netxforge.oss2.config.notifications.Header unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.notifications.Header) Unmarshaller.unmarshal(com.netxforge.oss2.config.notifications.Header.class, reader);
    }
