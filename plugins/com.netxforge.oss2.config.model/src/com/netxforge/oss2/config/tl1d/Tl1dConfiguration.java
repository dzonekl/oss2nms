...
package com.netxforge.oss2.config.tl1d;
...
@SuppressWarnings("all") public class Tl1dConfiguration implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.tl1d.Tl1Element> _tl1ElementList;
    ...
    public Tl1dConfiguration() {
        super();
        this._tl1ElementList = new java.util.ArrayList<com.netxforge.oss2.config.tl1d.Tl1Element>();
    }
    ...
    public void addTl1Element(
            final com.netxforge.oss2.config.tl1d.Tl1Element vTl1Element)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.tl1d.Tl1Element> enumerateTl1Element(
    ) {
     ...
     * com.netxforge.oss2.config.tl1d.Tl1Element at the given index
     */
    public com.netxforge.oss2.config.tl1d.Tl1Element getTl1Element(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.tl1d.Tl1Element) _tl1ElementList.get(index);
    }
    ...
    public com.netxforge.oss2.config.tl1d.Tl1Element[] getTl1Element(
        ...
        com.netxforge.oss2.config.tl1d.Tl1Element[] array = new com.netxforge.oss2.config.tl1d.Tl1Element[0];
        return (com.netxforge.oss2.config.tl1d.Tl1Element[]) this._tl1ElementList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.tl1d.Tl1Element> getTl1ElementCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.tl1d.Tl1Element> iterateTl1Element(
    ) {
     ...
     */
    public com.netxforge.oss2.config.tl1d.Tl1Element removeTl1ElementAt(
            final int index) {
        java.lang.Object obj = this._tl1ElementList.remove(index);
        return (com.netxforge.oss2.config.tl1d.Tl1Element) obj;
    }
     ...
     */
    public void setTl1Element(
            final com.netxforge.oss2.config.tl1d.Tl1Element[] vTl1ElementArray) {
        //-- copy array
     ...
     */
    public void setTl1Element(
            final java.util.List<com.netxforge.oss2.config.tl1d.Tl1Element> vTl1ElementList) {
        // copy vector
        this._tl1ElementList.clear();
    ...
    public void setTl1ElementCollection(
            final java.util.List<com.netxforge.oss2.config.tl1d.Tl1Element> tl1ElementList) {
     ...
     * com.netxforge.oss2.config.tl1d.Tl1dConfiguration
     */
    public static com.netxforge.oss2.config.tl1d.Tl1dConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.tl1d.Tl1dConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.tl1d.Tl1dConfiguration.class, reader);
    }
