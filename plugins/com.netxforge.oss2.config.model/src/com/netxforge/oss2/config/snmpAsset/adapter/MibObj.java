...
@SuppressWarnings("all") public class MibObj implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.snmpAsset.adapter.MibObj
     */
    public static com.netxforge.oss2.config.snmpAsset.adapter.MibObj unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.snmpAsset.adapter.MibObj) Unmarshaller.unmarshal(com.netxforge.oss2.config.snmpAsset.adapter.MibObj.class, reader);
    }
