...
@SuppressWarnings("all") public class SnmpAssetAdapterConfiguration implements java.io.Serializable {
     ...
     * Field _packageList.
     */
    private java.util.List<com.netxforge.oss2.config.snmpAsset.adapter.Package> _packageList;
    ...
    public SnmpAssetAdapterConfiguration() {
        super();
        this._packageList = new java.util.ArrayList<com.netxforge.oss2.config.snmpAsset.adapter.Package>();
    }
    ...
    public void addPackage(
            final com.netxforge.oss2.config.snmpAsset.adapter.Package vPackage)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.snmpAsset.adapter.Package> enumeratePackage(
    ) {
     ...
     * com.netxforge.oss2.config.snmpAsset.adapter.Package at the
     * given index
     */
    public com.netxforge.oss2.config.snmpAsset.adapter.Package getPackage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.snmpAsset.adapter.Package) _packageList.get(index);
    }
    ...
    public com.netxforge.oss2.config.snmpAsset.adapter.Package[] getPackage(
        ...
        com.netxforge.oss2.config.snmpAsset.adapter.Package[] array = new com.netxforge.oss2.config.snmpAsset.adapter.Package[0];
        return (com.netxforge.oss2.config.snmpAsset.adapter.Package[]) this._packageList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.snmpAsset.adapter.Package> getPackageCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.snmpAsset.adapter.Package> iteratePackage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.snmpAsset.adapter.Package removePackageAt(
            final int index) {
        java.lang.Object obj = this._packageList.remove(index);
        return (com.netxforge.oss2.config.snmpAsset.adapter.Package) obj;
    }
     ...
     */
    public void setPackage(
            final com.netxforge.oss2.config.snmpAsset.adapter.Package[] vPackageArray) {
        //-- copy array
        _packageList.clear();
     ...
     */
    public void setPackage(
            final java.util.List<com.netxforge.oss2.config.snmpAsset.adapter.Package> vPackageList) {
        // copy vector
        this._packageList.clear();
    ...
    public void setPackageCollection(
            final java.util.List<com.netxforge.oss2.config.snmpAsset.adapter.Package> _packageList) {
     ...
     * com.netxforge.oss2.config.snmpAsset.adapter.SnmpAssetAdapterConfiguration
     */
    public static com.netxforge.oss2.config.snmpAsset.adapter.SnmpAssetAdapterConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.snmpAsset.adapter.SnmpAssetAdapterConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.snmpAsset.adapter.SnmpAssetAdapterConfiguration.class, reader);
    }
