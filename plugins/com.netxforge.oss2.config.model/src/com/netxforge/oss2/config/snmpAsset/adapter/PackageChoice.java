...
@SuppressWarnings("all") public class PackageChoice implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.snmpAsset.adapter.PackageChoice
     */
    public static com.netxforge.oss2.config.snmpAsset.adapter.PackageChoice unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.snmpAsset.adapter.PackageChoice) Unmarshaller.unmarshal(com.netxforge.oss2.config.snmpAsset.adapter.PackageChoice.class, reader);
    }
