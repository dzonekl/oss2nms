...
@SuppressWarnings("all") public class MibObjs implements java.io.Serializable {
     ...
     * a MIB object
     */
    private java.util.List<com.netxforge.oss2.config.snmpAsset.adapter.MibObj> _mibObjList;
    ...
    public MibObjs() {
        super();
        this._mibObjList = new java.util.ArrayList<com.netxforge.oss2.config.snmpAsset.adapter.MibObj>();
    }
    ...
    public void addMibObj(
            final com.netxforge.oss2.config.snmpAsset.adapter.MibObj vMibObj)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.snmpAsset.adapter.MibObj> enumerateMibObj(
    ) {
     ...
     * com.netxforge.oss2.config.snmpAsset.adapter.MibObj at the
     * given index
     */
    public com.netxforge.oss2.config.snmpAsset.adapter.MibObj getMibObj(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.snmpAsset.adapter.MibObj) _mibObjList.get(index);
    }
    ...
    public com.netxforge.oss2.config.snmpAsset.adapter.MibObj[] getMibObj(
        ...
        com.netxforge.oss2.config.snmpAsset.adapter.MibObj[] array = new com.netxforge.oss2.config.snmpAsset.adapter.MibObj[0];
        return (com.netxforge.oss2.config.snmpAsset.adapter.MibObj[]) this._mibObjList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.snmpAsset.adapter.MibObj> getMibObjCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.snmpAsset.adapter.MibObj> iterateMibObj(
    ) {
     ...
     */
    public com.netxforge.oss2.config.snmpAsset.adapter.MibObj removeMibObjAt(
            final int index) {
        java.lang.Object obj = this._mibObjList.remove(index);
        return (com.netxforge.oss2.config.snmpAsset.adapter.MibObj) obj;
    }
     ...
     */
    public void setMibObj(
            final com.netxforge.oss2.config.snmpAsset.adapter.MibObj[] vMibObjArray) {
        //-- copy array
        _mibObjList.clear();
     ...
     */
    public void setMibObj(
            final java.util.List<com.netxforge.oss2.config.snmpAsset.adapter.MibObj> vMibObjList) {
        // copy vector
        this._mibObjList.clear();
    ...
    public void setMibObjCollection(
            final java.util.List<com.netxforge.oss2.config.snmpAsset.adapter.MibObj> mibObjList) {
     ...
     * com.netxforge.oss2.config.snmpAsset.adapter.MibObjs
     */
    public static com.netxforge.oss2.config.snmpAsset.adapter.MibObjs unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.snmpAsset.adapter.MibObjs) Unmarshaller.unmarshal(com.netxforge.oss2.config.snmpAsset.adapter.MibObjs.class, reader);
    }
