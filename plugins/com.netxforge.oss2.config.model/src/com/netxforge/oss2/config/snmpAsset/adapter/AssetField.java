...
@SuppressWarnings("all") public class AssetField implements java.io.Serializable {
     ...
     * Field _mibObjs.
     */
    private com.netxforge.oss2.config.snmpAsset.adapter.MibObjs _mibObjs;
     ...
     */
    public com.netxforge.oss2.config.snmpAsset.adapter.MibObjs getMibObjs(
    ) {
    ...
    public void setMibObjs(
            final com.netxforge.oss2.config.snmpAsset.adapter.MibObjs mibObjs) {
     ...
     * com.netxforge.oss2.config.snmpAsset.adapter.AssetField
     */
    public static com.netxforge.oss2.config.snmpAsset.adapter.AssetField unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.snmpAsset.adapter.AssetField) Unmarshaller.unmarshal(com.netxforge.oss2.config.snmpAsset.adapter.AssetField.class, reader);
    }
