...
package com.netxforge.oss2.config.users;
...
@SuppressWarnings("all") public class User implements java.io.Serializable {
     ...
     * Field _password.
     */
    private com.netxforge.oss2.config.users.Password _password;

    /**
     * Field _contactList.
     */
    private java.util.List<com.netxforge.oss2.config.users.Contact> _contactList;
    ...
    public User() {
        super();
        this._contactList = new java.util.ArrayList<com.netxforge.oss2.config.users.Contact>();
    ...
    public void addContact(
            final com.netxforge.oss2.config.users.Contact vContact)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.users.Contact> enumerateContact(
    ) {
     ...
     * com.netxforge.oss2.config.users.Contact at the given index
     */
    public com.netxforge.oss2.config.users.Contact getContact(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.users.Contact) _contactList.get(index);
    }
    ...
    public com.netxforge.oss2.config.users.Contact[] getContact(
        ...
        com.netxforge.oss2.config.users.Contact[] array = new com.netxforge.oss2.config.users.Contact[0];
        return (com.netxforge.oss2.config.users.Contact[]) this._contactList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.users.Contact> getContactCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.users.Password getPassword(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.users.Contact> iterateContact(
    ) {
     ...
     */
    public com.netxforge.oss2.config.users.Contact removeContactAt(
            final int index) {
        java.lang.Object obj = this._contactList.remove(index);
        return (com.netxforge.oss2.config.users.Contact) obj;
    }
     ...
     */
    public void setContact(
            final com.netxforge.oss2.config.users.Contact[] vContactArray) {
        //-- copy array
        _contactList.clear();
     ...
     */
    public void setContact(
            final java.util.List<com.netxforge.oss2.config.users.Contact> vContactList) {
        // copy vector
        this._contactList.clear();
    ...
    public void setContactCollection(
            final java.util.List<com.netxforge.oss2.config.users.Contact> contactList) {
    ...
    public void setPassword(
            final com.netxforge.oss2.config.users.Password password) {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.netxforge.oss2.config.users.User
     */
    public static com.netxforge.oss2.config.users.User unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.users.User) Unmarshaller.unmarshal(com.netxforge.oss2.config.users.User.class, reader);
    }
