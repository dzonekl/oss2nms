...
@SuppressWarnings("all") public class Header implements java.io.Serializable {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.netxforge.oss2.config.users.Heade
     */
    public static com.netxforge.oss2.config.users.Header unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.users.Header) Unmarshaller.unmarshal(com.netxforge.oss2.config.users.Header.class, reader);
    }
