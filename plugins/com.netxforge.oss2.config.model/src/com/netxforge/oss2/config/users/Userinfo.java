...
@SuppressWarnings("all") public class Userinfo implements java.io.Serializable {
     ...
     *  file.
     */
    private com.netxforge.oss2.config.users.Header _header;

    /**
     * Field _users.
     */
    private com.netxforge.oss2.config.users.Users _users;
     ...
     */
    public com.netxforge.oss2.config.users.Header getHeader(
    ) {
        return this._header;
    }
     ...
     */
    public com.netxforge.oss2.config.users.Users getUsers(
    ) {
        return this._users;
    }
    ...
    public void setHeader(
            final com.netxforge.oss2.config.users.Header header) {
        this._header = header;
    }
    ...
    public void setUsers(
            final com.netxforge.oss2.config.users.Users users) {
        this._users = users;
    }
     ...
     * com.netxforge.oss2.config.users.Userinfo
     */
    public static com.netxforge.oss2.config.users.Userinfo unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.users.Userinfo) Unmarshaller.unmarshal(com.netxforge.oss2.config.users.Userinfo.class, reader);
    }
