...
package com.netxforge.oss2.config.groups;
...
@SuppressWarnings("all") public class Role implements java.io.Serializable {
     ...
     * Field _scheduleList.
     */
    private java.util.List<com.netxforge.oss2.config.groups.Schedule> _scheduleList;
    ...
    public Role() {
        super();
        this._scheduleList = new java.util.ArrayList<com.netxforge.oss2.config.groups.Schedule>();
    }
    ...
    public void addSchedule(
            final com.netxforge.oss2.config.groups.Schedule vSchedule)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.groups.Schedule> enumerateSchedule(
    ) {
     ...
     * com.netxforge.oss2.config.groups.Schedule at the given index
     */
    public com.netxforge.oss2.config.groups.Schedule getSchedule(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.groups.Schedule) _scheduleList.get(index);
    }
    ...
    public com.netxforge.oss2.config.groups.Schedule[] getSchedule(
        ...
        com.netxforge.oss2.config.groups.Schedule[] array = new com.netxforge.oss2.config.groups.Schedule[0];
        return (com.netxforge.oss2.config.groups.Schedule[]) this._scheduleList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.groups.Schedule> getScheduleCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.groups.Schedule> iterateSchedule(
    ) {
     ...
     */
    public com.netxforge.oss2.config.groups.Schedule removeScheduleAt(
            final int index) {
        java.lang.Object obj = this._scheduleList.remove(index);
        return (com.netxforge.oss2.config.groups.Schedule) obj;
    }
     ...
     */
    public void setSchedule(
            final com.netxforge.oss2.config.groups.Schedule[] vScheduleArray) {
        //-- copy array
        _scheduleList.clear();
     ...
     */
    public void setSchedule(
            final java.util.List<com.netxforge.oss2.config.groups.Schedule> vScheduleList) {
        // copy vector
        this._scheduleList.clear();
    ...
    public void setScheduleCollection(
            final java.util.List<com.netxforge.oss2.config.groups.Schedule> scheduleList) {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.netxforge.oss2.config.groups.Role
     */
    public static com.netxforge.oss2.config.groups.Role unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.groups.Role) Unmarshaller.unmarshal(com.netxforge.oss2.config.groups.Role.class, reader);
    }
