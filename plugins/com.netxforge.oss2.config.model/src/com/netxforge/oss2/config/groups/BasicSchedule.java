...
@SuppressWarnings("all") public class BasicSchedule implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.groups.Time> _timeList;
    ...
    public BasicSchedule() {
        super();
        this._timeList = new java.util.ArrayList<com.netxforge.oss2.config.groups.Time>();
    }
     ...
     */
    public void addTime(
            final com.netxforge.oss2.config.groups.Time vTime)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.groups.Time> enumerateTime(
    ) {
     ...
     * com.netxforge.oss2.config.groups.Time at the given index
     */
    public com.netxforge.oss2.config.groups.Time getTime(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.groups.Time) _timeList.get(index);
    }
    ...
    public com.netxforge.oss2.config.groups.Time[] getTime(
        ...
        com.netxforge.oss2.config.groups.Time[] array = new com.netxforge.oss2.config.groups.Time[0];
        return (com.netxforge.oss2.config.groups.Time[]) this._timeList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.groups.Time> getTimeCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.groups.Time> iterateTime(
    ) {
     ...
     */
    public com.netxforge.oss2.config.groups.Time removeTimeAt(
            final int index) {
        java.lang.Object obj = this._timeList.remove(index);
        return (com.netxforge.oss2.config.groups.Time) obj;
    }
     ...
     */
    public void setTime(
            final com.netxforge.oss2.config.groups.Time[] vTimeArray) {
        //-- copy array
        _timeList.clear();
     ...
     */
    public void setTime(
            final java.util.List<com.netxforge.oss2.config.groups.Time> vTimeList) {
        // copy vector
        this._timeList.clear();
    ...
    public void setTimeCollection(
            final java.util.List<com.netxforge.oss2.config.groups.Time> timeList) {
     ...
     * com.netxforge.oss2.config.groups.BasicSchedule
     */
    public static com.netxforge.oss2.config.groups.BasicSchedule unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.groups.BasicSchedule) Unmarshaller.unmarshal(com.netxforge.oss2.config.groups.BasicSchedule.class, reader);
    }
