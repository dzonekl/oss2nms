...
import com.netxforge.oss2.config.trapd.Snmpv3User;

/**
 * Class Snmpv3UserDescriptor.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("all") public class Snmpv3UserDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public Snmpv3UserDescriptor() {
        super();
        _nsURI = "http://xmlns.opennms.org/xsd/config/trapd";
        _xmlName = "snmpv3-user";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                Snmpv3User target = (Snmpv3User) object;
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.trapd.Snmpv3User.class;
    }
