...
package com.netxforge.oss2.config.trapd;
...
@SuppressWarnings("all") public class TrapdConfiguration implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.trapd.Snmpv3User> _snmpv3UserList;
    ...
    public TrapdConfiguration() {
        super();
        setSnmpTrapAddress("*");
        this._snmpv3UserList = new java.util.ArrayList<com.netxforge.oss2.config.trapd.Snmpv3User>();
    }
    ...
    public void addSnmpv3User(
            final com.netxforge.oss2.config.trapd.Snmpv3User vSnmpv3User)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.trapd.Snmpv3User> enumerateSnmpv3User(
    ) {
     ...
     * com.netxforge.oss2.config.trapd.Snmpv3User at the given index
     */
    public com.netxforge.oss2.config.trapd.Snmpv3User getSnmpv3User(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.trapd.Snmpv3User) _snmpv3UserList.get(index);
    }
    ...
    public com.netxforge.oss2.config.trapd.Snmpv3User[] getSnmpv3User(
        ...
        com.netxforge.oss2.config.trapd.Snmpv3User[] array = new com.netxforge.oss2.config.trapd.Snmpv3User[0];
        return (com.netxforge.oss2.config.trapd.Snmpv3User[]) this._snmpv3UserList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.trapd.Snmpv3User> getSnmpv3UserCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.trapd.Snmpv3User> iterateSnmpv3User(
    ) {
     ...
     */
    public com.netxforge.oss2.config.trapd.Snmpv3User removeSnmpv3UserAt(
            final int index) {
        java.lang.Object obj = this._snmpv3UserList.remove(index);
        return (com.netxforge.oss2.config.trapd.Snmpv3User) obj;
    }
     ...
     */
    public void setSnmpv3User(
            final com.netxforge.oss2.config.trapd.Snmpv3User[] vSnmpv3UserArray) {
        //-- copy array
     ...
     */
    public void setSnmpv3User(
            final java.util.List<com.netxforge.oss2.config.trapd.Snmpv3User> vSnmpv3UserList) {
        // copy vector
        this._snmpv3UserList.clear();
    ...
    public void setSnmpv3UserCollection(
            final java.util.List<com.netxforge.oss2.config.trapd.Snmpv3User> snmpv3UserList) {
     ...
     * com.netxforge.oss2.config.trapd.TrapdConfiguration
     */
    public static com.netxforge.oss2.config.trapd.TrapdConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.trapd.TrapdConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.trapd.TrapdConfiguration.class, reader);
    }
