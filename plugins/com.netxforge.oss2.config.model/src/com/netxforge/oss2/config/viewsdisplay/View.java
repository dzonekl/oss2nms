...
package com.netxforge.oss2.config.viewsdisplay;
...
@SuppressWarnings("all") public class View implements java.io.Serializable {
     ...
     * Field _sectionList.
     */
    private java.util.List<com.netxforge.oss2.config.viewsdisplay.Section> _sectionList;
    ...
    public View() {
        super();
        this._sectionList = new java.util.ArrayList<com.netxforge.oss2.config.viewsdisplay.Section>();
    }
    ...
    public void addSection(
            final com.netxforge.oss2.config.viewsdisplay.Section vSection)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.viewsdisplay.Section> enumerateSection(
    ) {
     ...
     * com.netxforge.oss2.config.viewsdisplay.Section at the given
     * index
     */
    public com.netxforge.oss2.config.viewsdisplay.Section getSection(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.viewsdisplay.Section) _sectionList.get(index);
    }
    ...
    public com.netxforge.oss2.config.viewsdisplay.Section[] getSection(
        ...
        com.netxforge.oss2.config.viewsdisplay.Section[] array = new com.netxforge.oss2.config.viewsdisplay.Section[0];
        return (com.netxforge.oss2.config.viewsdisplay.Section[]) this._sectionList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.viewsdisplay.Section> getSectionCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.viewsdisplay.Section> iterateSection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.viewsdisplay.Section removeSectionAt(
            final int index) {
        java.lang.Object obj = this._sectionList.remove(index);
        return (com.netxforge.oss2.config.viewsdisplay.Section) obj;
    }
     ...
     */
    public void setSection(
            final com.netxforge.oss2.config.viewsdisplay.Section[] vSectionArray) {
        //-- copy array
        _sectionList.clear();
     ...
     */
    public void setSection(
            final java.util.List<com.netxforge.oss2.config.viewsdisplay.Section> vSectionList) {
        // copy vector
        this._sectionList.clear();
    ...
    public void setSectionCollection(
            final java.util.List<com.netxforge.oss2.config.viewsdisplay.Section> sectionList) {
     ...
     * com.netxforge.oss2.config.viewsdisplay.View
     */
    public static com.netxforge.oss2.config.viewsdisplay.View unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.viewsdisplay.View) Unmarshaller.unmarshal(com.netxforge.oss2.config.viewsdisplay.View.class, reader);
    }
