...
@SuppressWarnings("all") public class Viewinfo implements java.io.Serializable {
     ...
     * Field _viewList.
     */
    private java.util.List<com.netxforge.oss2.config.viewsdisplay.View> _viewList;
    ...
    public Viewinfo() {
        ...
        this._viewList = new java.util.ArrayList<com.netxforge.oss2.config.viewsdisplay.View>();
    }
     ...
     */
    public void addView(
            final com.netxforge.oss2.config.viewsdisplay.View vView)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.viewsdisplay.View> enumerateView(
    ) {
     ...
     * com.netxforge.oss2.config.viewsdisplay.View at the given inde
     */
    public com.netxforge.oss2.config.viewsdisplay.View getView(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.viewsdisplay.View) _viewList.get(index);
    }
    ...
    public com.netxforge.oss2.config.viewsdisplay.View[] getView(
        ...
        com.netxforge.oss2.config.viewsdisplay.View[] array = new com.netxforge.oss2.config.viewsdisplay.View[0];
        return (com.netxforge.oss2.config.viewsdisplay.View[]) this._viewList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.viewsdisplay.View> getViewCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.viewsdisplay.View> iterateView(
    ) {
     ...
     */
    public com.netxforge.oss2.config.viewsdisplay.View removeViewAt(
            final int index) {
        java.lang.Object obj = this._viewList.remove(index);
        return (com.netxforge.oss2.config.viewsdisplay.View) obj;
    }
     ...
     */
    public void setView(
            final com.netxforge.oss2.config.viewsdisplay.View[] vViewArray) {
        //-- copy array
        _viewList.clear();
     ...
     */
    public void setView(
            final java.util.List<com.netxforge.oss2.config.viewsdisplay.View> vViewList) {
        // copy vector
        this._viewList.clear();
    ...
    public void setViewCollection(
            final java.util.List<com.netxforge.oss2.config.viewsdisplay.View> viewList) {
     ...
     * com.netxforge.oss2.config.viewsdisplay.Viewinfo
     */
    public static com.netxforge.oss2.config.viewsdisplay.Viewinfo unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.viewsdisplay.Viewinfo) Unmarshaller.unmarshal(com.netxforge.oss2.config.viewsdisplay.Viewinfo.class, reader);
    }
