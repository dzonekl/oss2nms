...
@SuppressWarnings("all") public class Section implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.viewsdisplay.Section
     */
    public static com.netxforge.oss2.config.viewsdisplay.Section unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.viewsdisplay.Section) Unmarshaller.unmarshal(com.netxforge.oss2.config.viewsdisplay.Section.class, reader);
    }
