...
@SuppressWarnings("all") public class Report implements java.io.Serializable {
     ...
     * Field _graphList.
     */
    private java.util.List<com.netxforge.oss2.config.kscReports.Graph> _graphList;
    ...
    public Report() {
        super();
        this._graphList = new java.util.ArrayList<com.netxforge.oss2.config.kscReports.Graph>();
    }
    ...
    public void addGraph(
            final com.netxforge.oss2.config.kscReports.Graph vGraph)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.kscReports.Graph> enumerateGraph(
    ) {
     ...
     * com.netxforge.oss2.config.kscReports.Graph at the given index
     */
    public com.netxforge.oss2.config.kscReports.Graph getGraph(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.kscReports.Graph) _graphList.get(index);
    }
    ...
    public com.netxforge.oss2.config.kscReports.Graph[] getGraph(
        ...
        com.netxforge.oss2.config.kscReports.Graph[] array = new com.netxforge.oss2.config.kscReports.Graph[0];
        return (com.netxforge.oss2.config.kscReports.Graph[]) this._graphList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.kscReports.Graph> getGraphCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.kscReports.Graph> iterateGraph(
    ) {
     ...
     */
    public com.netxforge.oss2.config.kscReports.Graph removeGraphAt(
            final int index) {
        java.lang.Object obj = this._graphList.remove(index);
        return (com.netxforge.oss2.config.kscReports.Graph) obj;
    }
     ...
     */
    public void setGraph(
            final com.netxforge.oss2.config.kscReports.Graph[] vGraphArray) {
        //-- copy array
        _graphList.clear();
     ...
     */
    public void setGraph(
            final java.util.List<com.netxforge.oss2.config.kscReports.Graph> vGraphList) {
        // copy vector
        this._graphList.clear();
    ...
    public void setGraphCollection(
            final java.util.List<com.netxforge.oss2.config.kscReports.Graph> graphList) {
     ...
     * com.netxforge.oss2.config.kscReports.Report
     */
    public static com.netxforge.oss2.config.kscReports.Report unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.kscReports.Report) Unmarshaller.unmarshal(com.netxforge.oss2.config.kscReports.Report.class, reader);
    }
