...
@SuppressWarnings("all") public class MapsAdapterConfiguration implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.map.adapter.Package> _packageList;

    /**
     * Configuration of maps
     *  functionality
     */
    private com.netxforge.oss2.config.map.adapter.Cmaps _cmaps;
    ...
    public MapsAdapterConfiguration() {
        super();
        this._packageList = new java.util.ArrayList<com.netxforge.oss2.config.map.adapter.Package>();
    }
    ...
    public void addPackage(
            final com.netxforge.oss2.config.map.adapter.Package vPackage)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.map.adapter.Package> enumeratePackage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.map.adapter.Cmaps getCmaps(
    ) {
        return this._cmaps;
    }
     ...
     * com.netxforge.oss2.config.map.adapter.Package at the given
     * index
     */
    public com.netxforge.oss2.config.map.adapter.Package getPackage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.map.adapter.Package) _packageList.get(index);
    }
    ...
    public com.netxforge.oss2.config.map.adapter.Package[] getPackage(
        ...
        com.netxforge.oss2.config.map.adapter.Package[] array = new com.netxforge.oss2.config.map.adapter.Package[0];
        return (com.netxforge.oss2.config.map.adapter.Package[]) this._packageList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.map.adapter.Package> getPackageCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.map.adapter.Package> iteratePackage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.map.adapter.Package removePackageAt(
            final int index) {
        java.lang.Object obj = this._packageList.remove(index);
        return (com.netxforge.oss2.config.map.adapter.Package) obj;
    }
    ...
    public void setCmaps(
            final com.netxforge.oss2.config.map.adapter.Cmaps cmaps) {
        this._cmaps = cmaps;
    }
     ...
     */
    public void setPackage(
            final com.netxforge.oss2.config.map.adapter.Package[] vPackageArray) {
        //-- copy array
        _packageList.clear();
     ...
     */
    public void setPackage(
            final java.util.List<com.netxforge.oss2.config.map.adapter.Package> vPackageList) {
        // copy vector
        this._packageList.clear();
    ...
    public void setPackageCollection(
            final java.util.List<com.netxforge.oss2.config.map.adapter.Package> _packageList) {
     ...
     * com.netxforge.oss2.config.map.adapter.MapsAdapterConfiguratio
     */
    public static com.netxforge.oss2.config.map.adapter.MapsAdapterConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.map.adapter.MapsAdapterConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.map.adapter.MapsAdapterConfiguration.class, reader);
    }
