...
@SuppressWarnings("all") public class Cmaps implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.map.adapter.Cmap> _cmapList;
    ...
    public Cmaps() {
        super();
        this._cmapList = new java.util.ArrayList<com.netxforge.oss2.config.map.adapter.Cmap>();
    }
     ...
     */
    public void addCmap(
            final com.netxforge.oss2.config.map.adapter.Cmap vCmap)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.map.adapter.Cmap> enumerateCmap(
    ) {
     ...
     * com.netxforge.oss2.config.map.adapter.Cmap at the given index
     */
    public com.netxforge.oss2.config.map.adapter.Cmap getCmap(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.map.adapter.Cmap) _cmapList.get(index);
    }
    ...
    public com.netxforge.oss2.config.map.adapter.Cmap[] getCmap(
        ...
        com.netxforge.oss2.config.map.adapter.Cmap[] array = new com.netxforge.oss2.config.map.adapter.Cmap[0];
        return (com.netxforge.oss2.config.map.adapter.Cmap[]) this._cmapList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.map.adapter.Cmap> getCmapCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.map.adapter.Cmap> iterateCmap(
    ) {
     ...
     */
    public com.netxforge.oss2.config.map.adapter.Cmap removeCmapAt(
            final int index) {
        java.lang.Object obj = this._cmapList.remove(index);
        return (com.netxforge.oss2.config.map.adapter.Cmap) obj;
    }
     ...
     */
    public void setCmap(
            final com.netxforge.oss2.config.map.adapter.Cmap[] vCmapArray) {
        //-- copy array
        _cmapList.clear();
     ...
     */
    public void setCmap(
            final java.util.List<com.netxforge.oss2.config.map.adapter.Cmap> vCmapList) {
        // copy vector
        this._cmapList.clear();
    ...
    public void setCmapCollection(
            final java.util.List<com.netxforge.oss2.config.map.adapter.Cmap> cmapList) {
     ...
     * com.netxforge.oss2.config.map.adapter.Cmaps
     */
    public static com.netxforge.oss2.config.map.adapter.Cmaps unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.map.adapter.Cmaps) Unmarshaller.unmarshal(com.netxforge.oss2.config.map.adapter.Cmaps.class, reader);
    }
