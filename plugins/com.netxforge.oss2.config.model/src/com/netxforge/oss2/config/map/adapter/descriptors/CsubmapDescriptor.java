...
import com.netxforge.oss2.config.map.adapter.Csubmap;

/**
 * Class CsubmapDescriptor.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("all") public class CsubmapDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CsubmapDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _addwithoutelements
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Boolean.TYPE, "_addwithoutelements", "addwithoutelements", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Csubmap target = (Csubmap) object;
                if (!target.hasAddwithoutelements()) { return null; }
                return (target.getAddwithoutelements() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    // if null, use delete method for optional primitives 
                    if (value == null) {
                        target.deleteAddwithoutelements();
                        return;
                    }
                    target.setAddwithoutelements( ((java.lang.Boolean) value).booleanValue());
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _addwithoutelements
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.map.adapter.Csubmap.class;
    }
