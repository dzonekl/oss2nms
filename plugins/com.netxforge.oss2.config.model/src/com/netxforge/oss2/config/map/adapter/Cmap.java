...
@SuppressWarnings("all") public class Cmap implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.map.adapter.Celement> _celementList;

    /**
     * Field _csubmapList.
     */
    private java.util.List<com.netxforge.oss2.config.map.adapter.Csubmap> _csubmapList;
    ...
    public Cmap() {
        super();
        setMapBG("ffffff");
        this._celementList = new java.util.ArrayList<com.netxforge.oss2.config.map.adapter.Celement>();
        this._csubmapList = new java.util.ArrayList<com.netxforge.oss2.config.map.adapter.Csubmap>();
    }
    ...
    public void addCelement(
            final com.netxforge.oss2.config.map.adapter.Celement vCelement)
    ...
    public void addCsubmap(
            final com.netxforge.oss2.config.map.adapter.Csubmap vCsubmap)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.map.adapter.Celement> enumerateCelement(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.map.adapter.Csubmap> enumerateCsubmap(
    ) {
     ...
     * com.netxforge.oss2.config.map.adapter.Celement at the given
     * index
     */
    public com.netxforge.oss2.config.map.adapter.Celement getCelement(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.map.adapter.Celement) _celementList.get(index);
    }
    ...
    public com.netxforge.oss2.config.map.adapter.Celement[] getCelement(
        ...
        com.netxforge.oss2.config.map.adapter.Celement[] array = new com.netxforge.oss2.config.map.adapter.Celement[0];
        return (com.netxforge.oss2.config.map.adapter.Celement[]) this._celementList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.map.adapter.Celement> getCelementCollection(
    ) {
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.map.adapter.Csubmap at the given
     * index
     */
    public com.netxforge.oss2.config.map.adapter.Csubmap getCsubmap(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.map.adapter.Csubmap) _csubmapList.get(index);
    }
    ...
    public com.netxforge.oss2.config.map.adapter.Csubmap[] getCsubmap(
        ...
        com.netxforge.oss2.config.map.adapter.Csubmap[] array = new com.netxforge.oss2.config.map.adapter.Csubmap[0];
        return (com.netxforge.oss2.config.map.adapter.Csubmap[]) this._csubmapList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.map.adapter.Csubmap> getCsubmapCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.map.adapter.Celement> iterateCelement(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.map.adapter.Csubmap> iterateCsubmap(
    ) {
     ...
     */
    public com.netxforge.oss2.config.map.adapter.Celement removeCelementAt(
            final int index) {
        java.lang.Object obj = this._celementList.remove(index);
        return (com.netxforge.oss2.config.map.adapter.Celement) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.map.adapter.Csubmap removeCsubmapAt(
            final int index) {
        java.lang.Object obj = this._csubmapList.remove(index);
        return (com.netxforge.oss2.config.map.adapter.Csubmap) obj;
    }
     ...
     */
    public void setCelement(
            final com.netxforge.oss2.config.map.adapter.Celement[] vCelementArray) {
        //-- copy array
        _celementList.clear();
     ...
     */
    public void setCelement(
            final java.util.List<com.netxforge.oss2.config.map.adapter.Celement> vCelementList) {
        // copy vector
        this._celementList.clear();
    ...
    public void setCelementCollection(
            final java.util.List<com.netxforge.oss2.config.map.adapter.Celement> celementList) {
     ...
     */
    public void setCsubmap(
            final com.netxforge.oss2.config.map.adapter.Csubmap[] vCsubmapArray) {
        //-- copy array
        _csubmapList.clear();
     ...
     */
    public void setCsubmap(
            final java.util.List<com.netxforge.oss2.config.map.adapter.Csubmap> vCsubmapList) {
        // copy vector
        this._csubmapList.clear();
    ...
    public void setCsubmapCollection(
            final java.util.List<com.netxforge.oss2.config.map.adapter.Csubmap> csubmapList) {
     ...
     * com.netxforge.oss2.config.map.adapter.Cmap
     */
    public static com.netxforge.oss2.config.map.adapter.Cmap unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.map.adapter.Cmap) Unmarshaller.unmarshal(com.netxforge.oss2.config.map.adapter.Cmap.class, reader);
    }
