...
@SuppressWarnings("all") public class ExcludeRange implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.map.adapter.ExcludeRange
     */
    public static com.netxforge.oss2.config.map.adapter.ExcludeRange unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.map.adapter.ExcludeRange) Unmarshaller.unmarshal(com.netxforge.oss2.config.map.adapter.ExcludeRange.class, reader);
    }
