...
@SuppressWarnings("all") public class Csubmap implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.map.adapter.Csubmap
     */
    public static com.netxforge.oss2.config.map.adapter.Csubmap unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.map.adapter.Csubmap) Unmarshaller.unmarshal(com.netxforge.oss2.config.map.adapter.Csubmap.class, reader);
    }
