...
@SuppressWarnings("all") public class Celement implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.map.adapter.Celement
     */
    public static com.netxforge.oss2.config.map.adapter.Celement unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.map.adapter.Celement) Unmarshaller.unmarshal(com.netxforge.oss2.config.map.adapter.Celement.class, reader);
    }
