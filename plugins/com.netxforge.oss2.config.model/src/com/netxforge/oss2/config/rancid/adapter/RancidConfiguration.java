...
@SuppressWarnings("all") public class RancidConfiguration implements java.io.Serializable {
     ...
     *  functionality
     */
    private com.netxforge.oss2.config.rancid.adapter.Policies _policies;

    /**
     * A map from sysoids masks and rancid device type.
     */
    private java.util.List<com.netxforge.oss2.config.rancid.adapter.Mapping> _mappingList;
    ...
    public RancidConfiguration() {
        ...
        this._mappingList = new java.util.ArrayList<com.netxforge.oss2.config.rancid.adapter.Mapping>();
    }
    ...
    public void addMapping(
            final com.netxforge.oss2.config.rancid.adapter.Mapping vMapping)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.rancid.adapter.Mapping> enumerateMapping(
    ) {
     ...
     * com.netxforge.oss2.config.rancid.adapter.Mapping at the
     * given index
     */
    public com.netxforge.oss2.config.rancid.adapter.Mapping getMapping(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.rancid.adapter.Mapping) _mappingList.get(index);
    }
    ...
    public com.netxforge.oss2.config.rancid.adapter.Mapping[] getMapping(
        ...
        com.netxforge.oss2.config.rancid.adapter.Mapping[] array = new com.netxforge.oss2.config.rancid.adapter.Mapping[0];
        return (com.netxforge.oss2.config.rancid.adapter.Mapping[]) this._mappingList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.rancid.adapter.Mapping> getMappingCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.rancid.adapter.Policies getPolicies(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.rancid.adapter.Mapping> iterateMapping(
    ) {
     ...
     */
    public com.netxforge.oss2.config.rancid.adapter.Mapping removeMappingAt(
            final int index) {
        java.lang.Object obj = this._mappingList.remove(index);
        return (com.netxforge.oss2.config.rancid.adapter.Mapping) obj;
    }
     ...
     */
    public void setMapping(
            final com.netxforge.oss2.config.rancid.adapter.Mapping[] vMappingArray) {
        //-- copy array
        _mappingList.clear();
     ...
     */
    public void setMapping(
            final java.util.List<com.netxforge.oss2.config.rancid.adapter.Mapping> vMappingList) {
        // copy vector
        this._mappingList.clear();
    ...
    public void setMappingCollection(
            final java.util.List<com.netxforge.oss2.config.rancid.adapter.Mapping> mappingList) {
    ...
    public void setPolicies(
            final com.netxforge.oss2.config.rancid.adapter.Policies policies) {
     ...
     * com.netxforge.oss2.config.rancid.adapter.RancidConfiguration
     */
    public static com.netxforge.oss2.config.rancid.adapter.RancidConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.rancid.adapter.RancidConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.rancid.adapter.RancidConfiguration.class, reader);
    }
