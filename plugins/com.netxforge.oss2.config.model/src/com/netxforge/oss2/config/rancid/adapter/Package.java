...
package com.netxforge.oss2.config.rancid.adapter;
...
@SuppressWarnings("all") public class Package implements java.io.Serializable {
     ...
     *  this filter.
     */
    private com.netxforge.oss2.config.rancid.adapter.Filter _filter;
     ...
     */
    private java.util.List<com.netxforge.oss2.config.rancid.adapter.IncludeRange> _includeRangeList;

    /**
     * Range of addresses to be excluded from this
     *  package.
     */
    private java.util.List<com.netxforge.oss2.config.rancid.adapter.ExcludeRange> _excludeRangeList;
    ...
    public Package() {
        ...
        this._includeRangeList = new java.util.ArrayList<com.netxforge.oss2.config.rancid.adapter.IncludeRange>();
        this._excludeRangeList = new java.util.ArrayList<com.netxforge.oss2.config.rancid.adapter.ExcludeRange>();
    ...
    public void addExcludeRange(
            final com.netxforge.oss2.config.rancid.adapter.ExcludeRange vExcludeRange)
    ...
    public void addIncludeRange(
            final com.netxforge.oss2.config.rancid.adapter.IncludeRange vIncludeRange)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.rancid.adapter.ExcludeRange> enumerateExcludeRange(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.rancid.adapter.IncludeRange> enumerateIncludeRange(
    ) {
     ...
     * com.netxforge.oss2.config.rancid.adapter.ExcludeRange at the
     * given index
     */
    public com.netxforge.oss2.config.rancid.adapter.ExcludeRange getExcludeRange(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.rancid.adapter.ExcludeRange) _excludeRangeList.get(index);
    }
    ...
    public com.netxforge.oss2.config.rancid.adapter.ExcludeRange[] getExcludeRange(
        ...
        com.netxforge.oss2.config.rancid.adapter.ExcludeRange[] array = new com.netxforge.oss2.config.rancid.adapter.ExcludeRange[0];
        return (com.netxforge.oss2.config.rancid.adapter.ExcludeRange[]) this._excludeRangeList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.rancid.adapter.ExcludeRange> getExcludeRangeCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.rancid.adapter.Filter getFilter(
    ) {
        return this._filter;
    }
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.netxforge.oss2.config.rancid.adapter.IncludeRange at the
     * given index
     */
    public com.netxforge.oss2.config.rancid.adapter.IncludeRange getIncludeRange(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.netxforge.oss2.config.rancid.adapter.IncludeRange) _includeRangeList.get(index);
    }
    ...
    public com.netxforge.oss2.config.rancid.adapter.IncludeRange[] getIncludeRange(
        ...
        com.netxforge.oss2.config.rancid.adapter.IncludeRange[] array = new com.netxforge.oss2.config.rancid.adapter.IncludeRange[0];
        return (com.netxforge.oss2.config.rancid.adapter.IncludeRange[]) this._includeRangeList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<com.netxforge.oss2.config.rancid.adapter.IncludeRange> getIncludeRangeCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.rancid.adapter.ExcludeRange> iterateExcludeRange(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.rancid.adapter.IncludeRange> iterateIncludeRange(
    ) {
     ...
     */
    public com.netxforge.oss2.config.rancid.adapter.ExcludeRange removeExcludeRangeAt(
            final int index) {
        java.lang.Object obj = this._excludeRangeList.remove(index);
        return (com.netxforge.oss2.config.rancid.adapter.ExcludeRange) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.netxforge.oss2.config.rancid.adapter.IncludeRange removeIncludeRangeAt(
            final int index) {
        java.lang.Object obj = this._includeRangeList.remove(index);
        return (com.netxforge.oss2.config.rancid.adapter.IncludeRange) obj;
    }
     ...
     */
    public void setExcludeRange(
            final com.netxforge.oss2.config.rancid.adapter.ExcludeRange[] vExcludeRangeArray) {
        //-- copy array
     ...
     */
    public void setExcludeRange(
            final java.util.List<com.netxforge.oss2.config.rancid.adapter.ExcludeRange> vExcludeRangeList) {
        // copy vector
        this._excludeRangeList.clear();
    ...
    public void setExcludeRangeCollection(
            final java.util.List<com.netxforge.oss2.config.rancid.adapter.ExcludeRange> excludeRangeList) {
    ...
    public void setFilter(
            final com.netxforge.oss2.config.rancid.adapter.Filter filter) {
        this._filter = filter;
    }
     ...
     */
    public void setIncludeRange(
            final com.netxforge.oss2.config.rancid.adapter.IncludeRange[] vIncludeRangeArray) {
        //-- copy array
     ...
     */
    public void setIncludeRange(
            final java.util.List<com.netxforge.oss2.config.rancid.adapter.IncludeRange> vIncludeRangeList) {
        // copy vector
        this._includeRangeList.clear();
    ...
    public void setIncludeRangeCollection(
            final java.util.List<com.netxforge.oss2.config.rancid.adapter.IncludeRange> includeRangeList) {
     ...
     * com.netxforge.oss2.config.rancid.adapter.Package
     */
    public static com.netxforge.oss2.config.rancid.adapter.Package unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.rancid.adapter.Package) Unmarshaller.unmarshal(com.netxforge.oss2.config.rancid.adapter.Package.class, reader);
    }
