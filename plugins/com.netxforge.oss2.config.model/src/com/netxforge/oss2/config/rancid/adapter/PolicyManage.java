...
@SuppressWarnings("all") public class PolicyManage implements java.io.Serializable {
     ...
     */
    private com.netxforge.oss2.config.rancid.adapter.Package _package;

    /**
     * This is a time when you can schedule set up/down
     *  to rancid
     */
    private java.util.List<com.netxforge.oss2.config.rancid.adapter.Schedule> _scheduleList;
    ...
    public PolicyManage() {
        super();
        this._scheduleList = new java.util.ArrayList<com.netxforge.oss2.config.rancid.adapter.Schedule>();
    }
    ...
    public void addSchedule(
            final com.netxforge.oss2.config.rancid.adapter.Schedule vSchedule)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.rancid.adapter.Schedule> enumerateSchedule(
    ) {
     ...
     */
    public com.netxforge.oss2.config.rancid.adapter.Package getPackage(
    ) {
     ...
     * com.netxforge.oss2.config.rancid.adapter.Schedule at the
     * given index
     */
    public com.netxforge.oss2.config.rancid.adapter.Schedule getSchedule(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.rancid.adapter.Schedule) _scheduleList.get(index);
    }
    ...
    public com.netxforge.oss2.config.rancid.adapter.Schedule[] getSchedule(
        ...
        com.netxforge.oss2.config.rancid.adapter.Schedule[] array = new com.netxforge.oss2.config.rancid.adapter.Schedule[0];
        return (com.netxforge.oss2.config.rancid.adapter.Schedule[]) this._scheduleList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.rancid.adapter.Schedule> getScheduleCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.rancid.adapter.Schedule> iterateSchedule(
    ) {
     ...
     */
    public com.netxforge.oss2.config.rancid.adapter.Schedule removeScheduleAt(
            final int index) {
        java.lang.Object obj = this._scheduleList.remove(index);
        return (com.netxforge.oss2.config.rancid.adapter.Schedule) obj;
    }
    ...
    public void setPackage(
            final com.netxforge.oss2.config.rancid.adapter.Package _package) {
     ...
     */
    public void setSchedule(
            final com.netxforge.oss2.config.rancid.adapter.Schedule[] vScheduleArray) {
        //-- copy array
        _scheduleList.clear();
     ...
     */
    public void setSchedule(
            final java.util.List<com.netxforge.oss2.config.rancid.adapter.Schedule> vScheduleList) {
        // copy vector
        this._scheduleList.clear();
    ...
    public void setScheduleCollection(
            final java.util.List<com.netxforge.oss2.config.rancid.adapter.Schedule> scheduleList) {
     ...
     * com.netxforge.oss2.config.rancid.adapter.PolicyManage
     */
    public static com.netxforge.oss2.config.rancid.adapter.PolicyManage unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.rancid.adapter.PolicyManage) Unmarshaller.unmarshal(com.netxforge.oss2.config.rancid.adapter.PolicyManage.class, reader);
    }
