...
@SuppressWarnings("all") public class Mapping implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.rancid.adapter.Mapping
     */
    public static com.netxforge.oss2.config.rancid.adapter.Mapping unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.rancid.adapter.Mapping) Unmarshaller.unmarshal(com.netxforge.oss2.config.rancid.adapter.Mapping.class, reader);
    }
