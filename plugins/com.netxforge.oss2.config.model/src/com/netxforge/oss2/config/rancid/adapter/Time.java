...
@SuppressWarnings("all") public class Time implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.rancid.adapter.Time
     */
    public static com.netxforge.oss2.config.rancid.adapter.Time unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.rancid.adapter.Time) Unmarshaller.unmarshal(com.netxforge.oss2.config.rancid.adapter.Time.class, reader);
    }
