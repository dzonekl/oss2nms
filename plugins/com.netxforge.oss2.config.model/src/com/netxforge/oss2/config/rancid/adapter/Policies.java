...
@SuppressWarnings("all") public class Policies implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.rancid.adapter.PolicyManage> _policyManageList;
    ...
    public Policies() {
        super();
        this._policyManageList = new java.util.ArrayList<com.netxforge.oss2.config.rancid.adapter.PolicyManage>();
    }
    ...
    public void addPolicyManage(
            final com.netxforge.oss2.config.rancid.adapter.PolicyManage vPolicyManage)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.rancid.adapter.PolicyManage> enumeratePolicyManage(
    ) {
     ...
     * com.netxforge.oss2.config.rancid.adapter.PolicyManage at the
     * given index
     */
    public com.netxforge.oss2.config.rancid.adapter.PolicyManage getPolicyManage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.rancid.adapter.PolicyManage) _policyManageList.get(index);
    }
    ...
    public com.netxforge.oss2.config.rancid.adapter.PolicyManage[] getPolicyManage(
        ...
        com.netxforge.oss2.config.rancid.adapter.PolicyManage[] array = new com.netxforge.oss2.config.rancid.adapter.PolicyManage[0];
        return (com.netxforge.oss2.config.rancid.adapter.PolicyManage[]) this._policyManageList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.rancid.adapter.PolicyManage> getPolicyManageCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.rancid.adapter.PolicyManage> iteratePolicyManage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.rancid.adapter.PolicyManage removePolicyManageAt(
            final int index) {
        java.lang.Object obj = this._policyManageList.remove(index);
        return (com.netxforge.oss2.config.rancid.adapter.PolicyManage) obj;
    }
     ...
     */
    public void setPolicyManage(
            final com.netxforge.oss2.config.rancid.adapter.PolicyManage[] vPolicyManageArray) {
        //-- copy array
     ...
     */
    public void setPolicyManage(
            final java.util.List<com.netxforge.oss2.config.rancid.adapter.PolicyManage> vPolicyManageList) {
        // copy vector
        this._policyManageList.clear();
    ...
    public void setPolicyManageCollection(
            final java.util.List<com.netxforge.oss2.config.rancid.adapter.PolicyManage> policyManageList) {
     ...
     * com.netxforge.oss2.config.rancid.adapter.Policies
     */
    public static com.netxforge.oss2.config.rancid.adapter.Policies unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.rancid.adapter.Policies) Unmarshaller.unmarshal(com.netxforge.oss2.config.rancid.adapter.Policies.class, reader);
    }
