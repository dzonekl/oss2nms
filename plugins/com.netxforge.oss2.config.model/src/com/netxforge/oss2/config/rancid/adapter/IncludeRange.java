...
@SuppressWarnings("all") public class IncludeRange implements java.io.Serializable {
     ...
     * com.netxforge.oss2.config.rancid.adapter.IncludeRange
     */
    public static com.netxforge.oss2.config.rancid.adapter.IncludeRange unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.rancid.adapter.IncludeRange) Unmarshaller.unmarshal(com.netxforge.oss2.config.rancid.adapter.IncludeRange.class, reader);
    }
