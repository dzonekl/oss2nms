...
package com.netxforge.oss2.config.microblog;
...
@SuppressWarnings("all") public class MicroblogConfiguration implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.microblog.MicroblogProfile> _microblogProfileList;
    ...
    public MicroblogConfiguration() {
        super();
        this._microblogProfileList = new java.util.ArrayList<com.netxforge.oss2.config.microblog.MicroblogProfile>();
    }
    ...
    public void addMicroblogProfile(
            final com.netxforge.oss2.config.microblog.MicroblogProfile vMicroblogProfile)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.microblog.MicroblogProfile> enumerateMicroblogProfile(
    ) {
     ...
     * com.netxforge.oss2.config.microblog.MicroblogProfile at the
     * given index
     */
    public com.netxforge.oss2.config.microblog.MicroblogProfile getMicroblogProfile(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.microblog.MicroblogProfile) _microblogProfileList.get(index);
    }
    ...
    public com.netxforge.oss2.config.microblog.MicroblogProfile[] getMicroblogProfile(
        ...
        com.netxforge.oss2.config.microblog.MicroblogProfile[] array = new com.netxforge.oss2.config.microblog.MicroblogProfile[0];
        return (com.netxforge.oss2.config.microblog.MicroblogProfile[]) this._microblogProfileList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.microblog.MicroblogProfile> getMicroblogProfileCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.microblog.MicroblogProfile> iterateMicroblogProfile(
    ) {
     ...
     */
    public com.netxforge.oss2.config.microblog.MicroblogProfile removeMicroblogProfileAt(
            final int index) {
        java.lang.Object obj = this._microblogProfileList.remove(index);
        return (com.netxforge.oss2.config.microblog.MicroblogProfile) obj;
    }
     ...
     */
    public void setMicroblogProfile(
            final com.netxforge.oss2.config.microblog.MicroblogProfile[] vMicroblogProfileArray) {
        //-- copy array
     ...
     */
    public void setMicroblogProfile(
            final java.util.List<com.netxforge.oss2.config.microblog.MicroblogProfile> vMicroblogProfileList) {
        // copy vector
        this._microblogProfileList.clear();
    ...
    public void setMicroblogProfileCollection(
            final java.util.List<com.netxforge.oss2.config.microblog.MicroblogProfile> microblogProfileList) {
     ...
     * com.netxforge.oss2.config.microblog.MicroblogConfiguration
     */
    public static com.netxforge.oss2.config.microblog.MicroblogConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.microblog.MicroblogConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.microblog.MicroblogConfiguration.class, reader);
    }
