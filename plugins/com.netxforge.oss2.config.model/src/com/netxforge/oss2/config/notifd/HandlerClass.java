...
@SuppressWarnings("all") public class HandlerClass implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.notifd.InitParams> _initParamsList;
    ...
    public HandlerClass() {
        super();
        this._initParamsList = new java.util.ArrayList<com.netxforge.oss2.config.notifd.InitParams>();
    }
    ...
    public void addInitParams(
            final com.netxforge.oss2.config.notifd.InitParams vInitParams)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.notifd.InitParams> enumerateInitParams(
    ) {
     ...
     * com.netxforge.oss2.config.notifd.InitParams at the given inde
     */
    public com.netxforge.oss2.config.notifd.InitParams getInitParams(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.notifd.InitParams) _initParamsList.get(index);
    }
    ...
    public com.netxforge.oss2.config.notifd.InitParams[] getInitParams(
        ...
        com.netxforge.oss2.config.notifd.InitParams[] array = new com.netxforge.oss2.config.notifd.InitParams[0];
        return (com.netxforge.oss2.config.notifd.InitParams[]) this._initParamsList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.notifd.InitParams> getInitParamsCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.notifd.InitParams> iterateInitParams(
    ) {
     ...
     */
    public com.netxforge.oss2.config.notifd.InitParams removeInitParamsAt(
            final int index) {
        java.lang.Object obj = this._initParamsList.remove(index);
        return (com.netxforge.oss2.config.notifd.InitParams) obj;
    }
     ...
     */
    public void setInitParams(
            final com.netxforge.oss2.config.notifd.InitParams[] vInitParamsArray) {
        //-- copy array
     ...
     */
    public void setInitParams(
            final java.util.List<com.netxforge.oss2.config.notifd.InitParams> vInitParamsList) {
        // copy vector
        this._initParamsList.clear();
    ...
    public void setInitParamsCollection(
            final java.util.List<com.netxforge.oss2.config.notifd.InitParams> initParamsList) {
     ...
     * com.netxforge.oss2.config.notifd.HandlerClass
     */
    public static com.netxforge.oss2.config.notifd.HandlerClass unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.notifd.HandlerClass) Unmarshaller.unmarshal(com.netxforge.oss2.config.notifd.HandlerClass.class, reader);
    }
