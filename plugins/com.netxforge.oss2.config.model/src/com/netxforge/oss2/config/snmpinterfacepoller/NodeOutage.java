...
@SuppressWarnings("all") public class NodeOutage implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.snmpinterfacepoller.CriticalService> _criticalServiceList;
    ...
    public NodeOutage() {
        super();
        this._criticalServiceList = new java.util.ArrayList<com.netxforge.oss2.config.snmpinterfacepoller.CriticalService>();
    }
    ...
    public void addCriticalService(
            final com.netxforge.oss2.config.snmpinterfacepoller.CriticalService vCriticalService)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.snmpinterfacepoller.CriticalService> enumerateCriticalService(
    ) {
     ...
     * com.netxforge.oss2.config.snmpinterfacepoller.CriticalService
     * at the given index
     */
    public com.netxforge.oss2.config.snmpinterfacepoller.CriticalService getCriticalService(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.snmpinterfacepoller.CriticalService) _criticalServiceList.get(index);
    }
    ...
    public com.netxforge.oss2.config.snmpinterfacepoller.CriticalService[] getCriticalService(
        ...
        com.netxforge.oss2.config.snmpinterfacepoller.CriticalService[] array = new com.netxforge.oss2.config.snmpinterfacepoller.CriticalService[0];
        return (com.netxforge.oss2.config.snmpinterfacepoller.CriticalService[]) this._criticalServiceList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.snmpinterfacepoller.CriticalService> getCriticalServiceCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.snmpinterfacepoller.CriticalService> iterateCriticalService(
    ) {
     ...
     */
    public com.netxforge.oss2.config.snmpinterfacepoller.CriticalService removeCriticalServiceAt(
            final int index) {
        java.lang.Object obj = this._criticalServiceList.remove(index);
        return (com.netxforge.oss2.config.snmpinterfacepoller.CriticalService) obj;
    }
     ...
     */
    public void setCriticalService(
            final com.netxforge.oss2.config.snmpinterfacepoller.CriticalService[] vCriticalServiceArray) {
        //-- copy array
     ...
     */
    public void setCriticalService(
            final java.util.List<com.netxforge.oss2.config.snmpinterfacepoller.CriticalService> vCriticalServiceList) {
        // copy vector
        this._criticalServiceList.clear();
    ...
    public void setCriticalServiceCollection(
            final java.util.List<com.netxforge.oss2.config.snmpinterfacepoller.CriticalService> criticalServiceList) {
     ...
     * com.netxforge.oss2.config.snmpinterfacepoller.NodeOutage
     */
    public static com.netxforge.oss2.config.snmpinterfacepoller.NodeOutage unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.snmpinterfacepoller.NodeOutage) Unmarshaller.unmarshal(com.netxforge.oss2.config.snmpinterfacepoller.NodeOutage.class, reader);
    }
