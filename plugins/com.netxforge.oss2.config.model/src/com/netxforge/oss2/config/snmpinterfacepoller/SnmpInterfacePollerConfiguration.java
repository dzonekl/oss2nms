...
@SuppressWarnings("all") public class SnmpInterfacePollerConfiguration implements java.io.Serializable {
     ...
     *  functionality
     */
    private com.netxforge.oss2.config.snmpinterfacepoller.NodeOutage _nodeOutage;

    /**
     * Package encapsulating addresses, services to be
     *  polled for these addresses, etc..
     */
    private java.util.List<com.netxforge.oss2.config.snmpinterfacepoller.Package> _packageList;
    ...
    public SnmpInterfacePollerConfiguration() {
        ...
        this._packageList = new java.util.ArrayList<com.netxforge.oss2.config.snmpinterfacepoller.Package>();
    }
    ...
    public void addPackage(
            final com.netxforge.oss2.config.snmpinterfacepoller.Package vPackage)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.snmpinterfacepoller.Package> enumeratePackage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.snmpinterfacepoller.NodeOutage getNodeOutage(
    ) {
     ...
     * com.netxforge.oss2.config.snmpinterfacepoller.Package at the
     * given index
     */
    public com.netxforge.oss2.config.snmpinterfacepoller.Package getPackage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.snmpinterfacepoller.Package) _packageList.get(index);
    }
    ...
    public com.netxforge.oss2.config.snmpinterfacepoller.Package[] getPackage(
        ...
        com.netxforge.oss2.config.snmpinterfacepoller.Package[] array = new com.netxforge.oss2.config.snmpinterfacepoller.Package[0];
        return (com.netxforge.oss2.config.snmpinterfacepoller.Package[]) this._packageList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.snmpinterfacepoller.Package> getPackageCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.snmpinterfacepoller.Package> iteratePackage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.snmpinterfacepoller.Package removePackageAt(
            final int index) {
        java.lang.Object obj = this._packageList.remove(index);
        return (com.netxforge.oss2.config.snmpinterfacepoller.Package) obj;
    }
    ...
    public void setNodeOutage(
            final com.netxforge.oss2.config.snmpinterfacepoller.NodeOutage nodeOutage) {
     ...
     */
    public void setPackage(
            final com.netxforge.oss2.config.snmpinterfacepoller.Package[] vPackageArray) {
        //-- copy array
        _packageList.clear();
     ...
     */
    public void setPackage(
            final java.util.List<com.netxforge.oss2.config.snmpinterfacepoller.Package> vPackageList) {
        // copy vector
        this._packageList.clear();
    ...
    public void setPackageCollection(
            final java.util.List<com.netxforge.oss2.config.snmpinterfacepoller.Package> _packageList) {
     ...
     * com.netxforge.oss2.config.snmpinterfacepoller.SnmpInterfacePollerConfiguration
     */
    public static com.netxforge.oss2.config.snmpinterfacepoller.SnmpInterfacePollerConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.snmpinterfacepoller.SnmpInterfacePollerConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.snmpinterfacepoller.SnmpInterfacePollerConfiguration.class, reader);
    }
