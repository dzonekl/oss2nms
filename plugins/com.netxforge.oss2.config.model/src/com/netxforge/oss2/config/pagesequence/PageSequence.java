...
@SuppressWarnings("all") public class PageSequence implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.pagesequence.Page> _pageList;
    ...
    public PageSequence() {
        super();
        this._pageList = new java.util.ArrayList<com.netxforge.oss2.config.pagesequence.Page>();
    }
     ...
     */
    public void addPage(
            final com.netxforge.oss2.config.pagesequence.Page vPage)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.pagesequence.Page> enumeratePage(
    ) {
     ...
     * com.netxforge.oss2.config.pagesequence.Page at the given inde
     */
    public com.netxforge.oss2.config.pagesequence.Page getPage(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.pagesequence.Page) _pageList.get(index);
    }
    ...
    public com.netxforge.oss2.config.pagesequence.Page[] getPage(
        ...
        com.netxforge.oss2.config.pagesequence.Page[] array = new com.netxforge.oss2.config.pagesequence.Page[0];
        return (com.netxforge.oss2.config.pagesequence.Page[]) this._pageList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.pagesequence.Page> getPageCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.pagesequence.Page> iteratePage(
    ) {
     ...
     */
    public com.netxforge.oss2.config.pagesequence.Page removePageAt(
            final int index) {
        java.lang.Object obj = this._pageList.remove(index);
        return (com.netxforge.oss2.config.pagesequence.Page) obj;
    }
     ...
     */
    public void setPage(
            final com.netxforge.oss2.config.pagesequence.Page[] vPageArray) {
        //-- copy array
        _pageList.clear();
     ...
     */
    public void setPage(
            final java.util.List<com.netxforge.oss2.config.pagesequence.Page> vPageList) {
        // copy vector
        this._pageList.clear();
    ...
    public void setPageCollection(
            final java.util.List<com.netxforge.oss2.config.pagesequence.Page> pageList) {
     ...
     * com.netxforge.oss2.config.pagesequence.PageSequence
     */
    public static com.netxforge.oss2.config.pagesequence.PageSequence unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.pagesequence.PageSequence) Unmarshaller.unmarshal(com.netxforge.oss2.config.pagesequence.PageSequence.class, reader);
    }
