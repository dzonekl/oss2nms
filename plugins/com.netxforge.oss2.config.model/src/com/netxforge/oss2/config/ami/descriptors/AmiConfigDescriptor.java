...
import com.netxforge.oss2.config.ami.AmiConfig;
...
@SuppressWarnings("all") public class AmiConfigDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AmiConfigDescriptor() {
        ...
        //-- _definitionList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.ami.Definition.class, "_definitionList", "definition", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    AmiConfig target = (AmiConfig) object;
                    target.addDefinition( (com.netxforge.oss2.config.ami.Definition) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.ami.Definition();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.ami.Definition");
        desc.setHandler(handler);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.ami.AmiConfig.class;
    }
