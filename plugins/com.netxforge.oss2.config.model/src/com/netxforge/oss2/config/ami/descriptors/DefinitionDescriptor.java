...
package com.netxforge.oss2.config.ami.descriptors;

  //---------------------------------/
 //- Imported classes and packages -/
//---------------------------------/

import com.netxforge.oss2.config.ami.Definition;
...
@SuppressWarnings("all") public class DefinitionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DefinitionDescriptor() {
        ...
        //-- _rangeList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.netxforge.oss2.config.ami.Range.class, "_rangeList", "range", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Definition target = (Definition) object;
                    target.addRange( (com.netxforge.oss2.config.ami.Range) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.netxforge.oss2.config.ami.Range();
            }
        };
        desc.setSchemaType("com.netxforge.oss2.config.ami.Range");
        desc.setHandler(handler);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return com.netxforge.oss2.config.ami.Definition.class;
    }
