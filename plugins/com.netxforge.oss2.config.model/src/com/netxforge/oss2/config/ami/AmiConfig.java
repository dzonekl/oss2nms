...
package com.netxforge.oss2.config.ami;
...
@SuppressWarnings("all") public class AmiConfig implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<com.netxforge.oss2.config.ami.Definition> _definitionList;
    ...
    public AmiConfig() {
        super();
        this._definitionList = new java.util.ArrayList<com.netxforge.oss2.config.ami.Definition>();
    }
    ...
    public void addDefinition(
            final com.netxforge.oss2.config.ami.Definition vDefinition)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.ami.Definition> enumerateDefinition(
    ) {
     ...
     * com.netxforge.oss2.config.ami.Definition at the given index
     */
    public com.netxforge.oss2.config.ami.Definition getDefinition(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.ami.Definition) _definitionList.get(index);
    }
    ...
    public com.netxforge.oss2.config.ami.Definition[] getDefinition(
        ...
        com.netxforge.oss2.config.ami.Definition[] array = new com.netxforge.oss2.config.ami.Definition[0];
        return (com.netxforge.oss2.config.ami.Definition[]) this._definitionList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.ami.Definition> getDefinitionCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.ami.Definition> iterateDefinition(
    ) {
     ...
     */
    public com.netxforge.oss2.config.ami.Definition removeDefinitionAt(
            final int index) {
        java.lang.Object obj = this._definitionList.remove(index);
        return (com.netxforge.oss2.config.ami.Definition) obj;
    }
     ...
     */
    public void setDefinition(
            final com.netxforge.oss2.config.ami.Definition[] vDefinitionArray) {
        //-- copy array
     ...
     */
    public void setDefinition(
            final java.util.List<com.netxforge.oss2.config.ami.Definition> vDefinitionList) {
        // copy vector
        this._definitionList.clear();
    ...
    public void setDefinitionCollection(
            final java.util.List<com.netxforge.oss2.config.ami.Definition> definitionList) {
     ...
     * com.netxforge.oss2.config.ami.AmiConfig
     */
    public static com.netxforge.oss2.config.ami.AmiConfig unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.ami.AmiConfig) Unmarshaller.unmarshal(com.netxforge.oss2.config.ami.AmiConfig.class, reader);
    }
