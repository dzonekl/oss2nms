...
@SuppressWarnings("all") public class AutoEvents implements java.io.Serializable {
     ...
     *  trigger
     */
    private java.util.List<com.netxforge.oss2.config.vacuumd.AutoEvent> _autoEventList;
    ...
    public AutoEvents() {
        super();
        this._autoEventList = new java.util.ArrayList<com.netxforge.oss2.config.vacuumd.AutoEvent>();
    }
    ...
    public void addAutoEvent(
            final com.netxforge.oss2.config.vacuumd.AutoEvent vAutoEvent)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.vacuumd.AutoEvent> enumerateAutoEvent(
    ) {
     ...
     * com.netxforge.oss2.config.vacuumd.AutoEvent at the given inde
     */
    public com.netxforge.oss2.config.vacuumd.AutoEvent getAutoEvent(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.vacuumd.AutoEvent) _autoEventList.get(index);
    }
    ...
    public com.netxforge.oss2.config.vacuumd.AutoEvent[] getAutoEvent(
        ...
        com.netxforge.oss2.config.vacuumd.AutoEvent[] array = new com.netxforge.oss2.config.vacuumd.AutoEvent[0];
        return (com.netxforge.oss2.config.vacuumd.AutoEvent[]) this._autoEventList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.vacuumd.AutoEvent> getAutoEventCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.vacuumd.AutoEvent> iterateAutoEvent(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.AutoEvent removeAutoEventAt(
            final int index) {
        java.lang.Object obj = this._autoEventList.remove(index);
        return (com.netxforge.oss2.config.vacuumd.AutoEvent) obj;
    }
     ...
     */
    public void setAutoEvent(
            final com.netxforge.oss2.config.vacuumd.AutoEvent[] vAutoEventArray) {
        //-- copy array
     ...
     */
    public void setAutoEvent(
            final java.util.List<com.netxforge.oss2.config.vacuumd.AutoEvent> vAutoEventList) {
        // copy vector
        this._autoEventList.clear();
    ...
    public void setAutoEventCollection(
            final java.util.List<com.netxforge.oss2.config.vacuumd.AutoEvent> autoEventList) {
     ...
     * com.netxforge.oss2.config.vacuumd.AutoEvents
     */
    public static com.netxforge.oss2.config.vacuumd.AutoEvents unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.vacuumd.AutoEvents) Unmarshaller.unmarshal(com.netxforge.oss2.config.vacuumd.AutoEvents.class, reader);
    }
