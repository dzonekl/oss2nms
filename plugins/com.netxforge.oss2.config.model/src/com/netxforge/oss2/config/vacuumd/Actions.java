...
@SuppressWarnings("all") public class Actions implements java.io.Serializable {
     ...
     *  trigger
     */
    private java.util.List<com.netxforge.oss2.config.vacuumd.Action> _actionList;
    ...
    public Actions() {
        super();
        this._actionList = new java.util.ArrayList<com.netxforge.oss2.config.vacuumd.Action>();
    }
    ...
    public void addAction(
            final com.netxforge.oss2.config.vacuumd.Action vAction)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.vacuumd.Action> enumerateAction(
    ) {
     ...
     * com.netxforge.oss2.config.vacuumd.Action at the given index
     */
    public com.netxforge.oss2.config.vacuumd.Action getAction(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.vacuumd.Action) _actionList.get(index);
    }
    ...
    public com.netxforge.oss2.config.vacuumd.Action[] getAction(
        ...
        com.netxforge.oss2.config.vacuumd.Action[] array = new com.netxforge.oss2.config.vacuumd.Action[0];
        return (com.netxforge.oss2.config.vacuumd.Action[]) this._actionList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.vacuumd.Action> getActionCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.vacuumd.Action> iterateAction(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.Action removeActionAt(
            final int index) {
        java.lang.Object obj = this._actionList.remove(index);
        return (com.netxforge.oss2.config.vacuumd.Action) obj;
    }
     ...
     */
    public void setAction(
            final com.netxforge.oss2.config.vacuumd.Action[] vActionArray) {
        //-- copy array
        _actionList.clear();
     ...
     */
    public void setAction(
            final java.util.List<com.netxforge.oss2.config.vacuumd.Action> vActionList) {
        // copy vector
        this._actionList.clear();
    ...
    public void setActionCollection(
            final java.util.List<com.netxforge.oss2.config.vacuumd.Action> actionList) {
     ...
     * com.netxforge.oss2.config.vacuumd.Actions
     */
    public static com.netxforge.oss2.config.vacuumd.Actions unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.vacuumd.Actions) Unmarshaller.unmarshal(com.netxforge.oss2.config.vacuumd.Actions.class, reader);
    }
