...
@SuppressWarnings("all") public class ActionEvents implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.vacuumd.ActionEvent> _actionEventList;
    ...
    public ActionEvents() {
        super();
        this._actionEventList = new java.util.ArrayList<com.netxforge.oss2.config.vacuumd.ActionEvent>();
    }
    ...
    public void addActionEvent(
            final com.netxforge.oss2.config.vacuumd.ActionEvent vActionEvent)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.vacuumd.ActionEvent> enumerateActionEvent(
    ) {
     ...
     * com.netxforge.oss2.config.vacuumd.ActionEvent at the given
     * index
     */
    public com.netxforge.oss2.config.vacuumd.ActionEvent getActionEvent(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.vacuumd.ActionEvent) _actionEventList.get(index);
    }
    ...
    public com.netxforge.oss2.config.vacuumd.ActionEvent[] getActionEvent(
        ...
        com.netxforge.oss2.config.vacuumd.ActionEvent[] array = new com.netxforge.oss2.config.vacuumd.ActionEvent[0];
        return (com.netxforge.oss2.config.vacuumd.ActionEvent[]) this._actionEventList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.vacuumd.ActionEvent> getActionEventCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.vacuumd.ActionEvent> iterateActionEvent(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.ActionEvent removeActionEventAt(
            final int index) {
        java.lang.Object obj = this._actionEventList.remove(index);
        return (com.netxforge.oss2.config.vacuumd.ActionEvent) obj;
    }
     ...
     */
    public void setActionEvent(
            final com.netxforge.oss2.config.vacuumd.ActionEvent[] vActionEventArray) {
        //-- copy array
     ...
     */
    public void setActionEvent(
            final java.util.List<com.netxforge.oss2.config.vacuumd.ActionEvent> vActionEventList) {
        // copy vector
        this._actionEventList.clear();
    ...
    public void setActionEventCollection(
            final java.util.List<com.netxforge.oss2.config.vacuumd.ActionEvent> actionEventList) {
     ...
     * com.netxforge.oss2.config.vacuumd.ActionEvents
     */
    public static com.netxforge.oss2.config.vacuumd.ActionEvents unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.vacuumd.ActionEvents) Unmarshaller.unmarshal(com.netxforge.oss2.config.vacuumd.ActionEvents.class, reader);
    }
