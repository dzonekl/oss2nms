...
@SuppressWarnings("all") public class Automations implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.vacuumd.Automation> _automationList;
    ...
    public Automations() {
        super();
        this._automationList = new java.util.ArrayList<com.netxforge.oss2.config.vacuumd.Automation>();
    }
    ...
    public void addAutomation(
            final com.netxforge.oss2.config.vacuumd.Automation vAutomation)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.vacuumd.Automation> enumerateAutomation(
    ) {
     ...
     * com.netxforge.oss2.config.vacuumd.Automation at the given
     * index
     */
    public com.netxforge.oss2.config.vacuumd.Automation getAutomation(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.vacuumd.Automation) _automationList.get(index);
    }
    ...
    public com.netxforge.oss2.config.vacuumd.Automation[] getAutomation(
        ...
        com.netxforge.oss2.config.vacuumd.Automation[] array = new com.netxforge.oss2.config.vacuumd.Automation[0];
        return (com.netxforge.oss2.config.vacuumd.Automation[]) this._automationList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.vacuumd.Automation> getAutomationCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.vacuumd.Automation> iterateAutomation(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.Automation removeAutomationAt(
            final int index) {
        java.lang.Object obj = this._automationList.remove(index);
        return (com.netxforge.oss2.config.vacuumd.Automation) obj;
    }
     ...
     */
    public void setAutomation(
            final com.netxforge.oss2.config.vacuumd.Automation[] vAutomationArray) {
        //-- copy array
     ...
     */
    public void setAutomation(
            final java.util.List<com.netxforge.oss2.config.vacuumd.Automation> vAutomationList) {
        // copy vector
        this._automationList.clear();
    ...
    public void setAutomationCollection(
            final java.util.List<com.netxforge.oss2.config.vacuumd.Automation> automationList) {
     ...
     * com.netxforge.oss2.config.vacuumd.Automations
     */
    public static com.netxforge.oss2.config.vacuumd.Automations unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.vacuumd.Automations) Unmarshaller.unmarshal(com.netxforge.oss2.config.vacuumd.Automations.class, reader);
    }
