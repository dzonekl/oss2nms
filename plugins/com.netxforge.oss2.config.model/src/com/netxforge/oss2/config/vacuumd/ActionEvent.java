...
@SuppressWarnings("all") public class ActionEvent implements java.io.Serializable {
     ...
     */
    private java.util.List<com.netxforge.oss2.config.vacuumd.Assignment> _assignmentList;
    ...
    public ActionEvent() {
        super();
        this._assignmentList = new java.util.ArrayList<com.netxforge.oss2.config.vacuumd.Assignment>();
    }
    ...
    public void addAssignment(
            final com.netxforge.oss2.config.vacuumd.Assignment vAssignment)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.vacuumd.Assignment> enumerateAssignment(
    ) {
     ...
     * com.netxforge.oss2.config.vacuumd.Assignment at the given
     * index
     */
    public com.netxforge.oss2.config.vacuumd.Assignment getAssignment(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.vacuumd.Assignment) _assignmentList.get(index);
    }
    ...
    public com.netxforge.oss2.config.vacuumd.Assignment[] getAssignment(
        ...
        com.netxforge.oss2.config.vacuumd.Assignment[] array = new com.netxforge.oss2.config.vacuumd.Assignment[0];
        return (com.netxforge.oss2.config.vacuumd.Assignment[]) this._assignmentList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.vacuumd.Assignment> getAssignmentCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.vacuumd.Assignment> iterateAssignment(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.Assignment removeAssignmentAt(
            final int index) {
        java.lang.Object obj = this._assignmentList.remove(index);
        return (com.netxforge.oss2.config.vacuumd.Assignment) obj;
    }
     ...
     */
    public void setAssignment(
            final com.netxforge.oss2.config.vacuumd.Assignment[] vAssignmentArray) {
        //-- copy array
     ...
     */
    public void setAssignment(
            final java.util.List<com.netxforge.oss2.config.vacuumd.Assignment> vAssignmentList) {
        // copy vector
        this._assignmentList.clear();
    ...
    public void setAssignmentCollection(
            final java.util.List<com.netxforge.oss2.config.vacuumd.Assignment> assignmentList) {
     ...
     * com.netxforge.oss2.config.vacuumd.ActionEvent
     */
    public static com.netxforge.oss2.config.vacuumd.ActionEvent unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.vacuumd.ActionEvent) Unmarshaller.unmarshal(com.netxforge.oss2.config.vacuumd.ActionEvent.class, reader);
    }
