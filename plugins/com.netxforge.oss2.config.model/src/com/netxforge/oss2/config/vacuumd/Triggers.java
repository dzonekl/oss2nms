...
@SuppressWarnings("all") public class Triggers implements java.io.Serializable {
     ...
     *  actions
     */
    private java.util.List<com.netxforge.oss2.config.vacuumd.Trigger> _triggerList;
    ...
    public Triggers() {
        super();
        this._triggerList = new java.util.ArrayList<com.netxforge.oss2.config.vacuumd.Trigger>();
    }
    ...
    public void addTrigger(
            final com.netxforge.oss2.config.vacuumd.Trigger vTrigger)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.vacuumd.Trigger> enumerateTrigger(
    ) {
     ...
     * com.netxforge.oss2.config.vacuumd.Trigger at the given index
     */
    public com.netxforge.oss2.config.vacuumd.Trigger getTrigger(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.vacuumd.Trigger) _triggerList.get(index);
    }
    ...
    public com.netxforge.oss2.config.vacuumd.Trigger[] getTrigger(
        ...
        com.netxforge.oss2.config.vacuumd.Trigger[] array = new com.netxforge.oss2.config.vacuumd.Trigger[0];
        return (com.netxforge.oss2.config.vacuumd.Trigger[]) this._triggerList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.vacuumd.Trigger> getTriggerCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.vacuumd.Trigger> iterateTrigger(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.Trigger removeTriggerAt(
            final int index) {
        java.lang.Object obj = this._triggerList.remove(index);
        return (com.netxforge.oss2.config.vacuumd.Trigger) obj;
    }
     ...
     */
    public void setTrigger(
            final com.netxforge.oss2.config.vacuumd.Trigger[] vTriggerArray) {
        //-- copy array
        _triggerList.clear();
     ...
     */
    public void setTrigger(
            final java.util.List<com.netxforge.oss2.config.vacuumd.Trigger> vTriggerList) {
        // copy vector
        this._triggerList.clear();
    ...
    public void setTriggerCollection(
            final java.util.List<com.netxforge.oss2.config.vacuumd.Trigger> triggerList) {
     ...
     * com.netxforge.oss2.config.vacuumd.Triggers
     */
    public static com.netxforge.oss2.config.vacuumd.Triggers unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.vacuumd.Triggers) Unmarshaller.unmarshal(com.netxforge.oss2.config.vacuumd.Triggers.class, reader);
    }
