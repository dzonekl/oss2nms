...
package com.netxforge.oss2.config.vacuumd;
...
@SuppressWarnings("all") public class VacuumdConfiguration implements java.io.Serializable {
     ...
     *  <period> seconds
     */
    private java.util.List<com.netxforge.oss2.config.vacuumd.Statement> _statementList;

    /**
     * Field _automations.
     */
    private com.netxforge.oss2.config.vacuumd.Automations _automations;

    /**
     * A collection of triggers
     */
    private com.netxforge.oss2.config.vacuumd.Triggers _triggers;

    /**
     * A collection of actions
     */
    private com.netxforge.oss2.config.vacuumd.Actions _actions;

    /**
     * Field _autoEvents.
     */
    private com.netxforge.oss2.config.vacuumd.AutoEvents _autoEvents;

    /**
     * Field _actionEvents.
     */
    private com.netxforge.oss2.config.vacuumd.ActionEvents _actionEvents;
    ...
    public VacuumdConfiguration() {
        super();
        this._statementList = new java.util.ArrayList<com.netxforge.oss2.config.vacuumd.Statement>();
    }
    ...
    public void addStatement(
            final com.netxforge.oss2.config.vacuumd.Statement vStatement)
     ...
     * collection
     */
    public java.util.Enumeration<com.netxforge.oss2.config.vacuumd.Statement> enumerateStatement(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.ActionEvents getActionEvents(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.Actions getActions(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.AutoEvents getAutoEvents(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.Automations getAutomations(
    ) {
     ...
     * com.netxforge.oss2.config.vacuumd.Statement at the given inde
     */
    public com.netxforge.oss2.config.vacuumd.Statement getStatement(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.netxforge.oss2.config.vacuumd.Statement) _statementList.get(index);
    }
    ...
    public com.netxforge.oss2.config.vacuumd.Statement[] getStatement(
        ...
        com.netxforge.oss2.config.vacuumd.Statement[] array = new com.netxforge.oss2.config.vacuumd.Statement[0];
        return (com.netxforge.oss2.config.vacuumd.Statement[]) this._statementList.toArray(array);
    }
     ...
     */
    public java.util.List<com.netxforge.oss2.config.vacuumd.Statement> getStatementCollection(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.Triggers getTriggers(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<com.netxforge.oss2.config.vacuumd.Statement> iterateStatement(
    ) {
     ...
     */
    public com.netxforge.oss2.config.vacuumd.Statement removeStatementAt(
            final int index) {
        java.lang.Object obj = this._statementList.remove(index);
        return (com.netxforge.oss2.config.vacuumd.Statement) obj;
    }
    ...
    public void setActionEvents(
            final com.netxforge.oss2.config.vacuumd.ActionEvents actionEvents) {
    ...
    public void setActions(
            final com.netxforge.oss2.config.vacuumd.Actions actions) {
    ...
    public void setAutoEvents(
            final com.netxforge.oss2.config.vacuumd.AutoEvents autoEvents) {
    ...
    public void setAutomations(
            final com.netxforge.oss2.config.vacuumd.Automations automations) {
     ...
     */
    public void setStatement(
            final com.netxforge.oss2.config.vacuumd.Statement[] vStatementArray) {
        //-- copy array
     ...
     */
    public void setStatement(
            final java.util.List<com.netxforge.oss2.config.vacuumd.Statement> vStatementList) {
        // copy vector
        this._statementList.clear();
    ...
    public void setStatementCollection(
            final java.util.List<com.netxforge.oss2.config.vacuumd.Statement> statementList) {
    ...
    public void setTriggers(
            final com.netxforge.oss2.config.vacuumd.Triggers triggers) {
     ...
     * com.netxforge.oss2.config.vacuumd.VacuumdConfiguration
     */
    public static com.netxforge.oss2.config.vacuumd.VacuumdConfiguration unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.netxforge.oss2.config.vacuumd.VacuumdConfiguration) Unmarshaller.unmarshal(com.netxforge.oss2.config.vacuumd.VacuumdConfiguration.class, reader);
    }
